...
p.prototype.stop=function(){void 0!==this.player&&(this.canvas.div.removeEventListener("wheel",this.wheelEventBound),this.player=this.canvas=void 0)};p.prototype.wheelEvent=function(k){var l;l=0>m.Util.convertToNumber(k.deltaY,-1);if(k.shiftKey)l=this.moveByStep(l);else{var h=k.altKey?k.ctrlKey?this.altCtrlSpeed:this.altSpeed:k.ctrlKey?this.ctrlSpeed:this.speed;l||(h=-h);l=this.moveByTime(h)}h=this.player.timeline.totalDuration();.01>l?l=h:l>h&&(l=.01);this.player.timeline.totalTime(l);this.player.timeline.pause(l);
this.player.pause();k.preventDefault();return!1};p.prototype.moveByStep=function(k){var l=this.player.getCurrentStep();k?l.playerStepIndex<this.player.steps.length-1&&this.player.seekStep(this.player.steps[l.playerStepIndex+1]):0<l.playerStepIndex&&this.player.seekStep(this.player.steps[l.playerStepIndex-1]);return 0};p.prototype.moveByTime=function(k){var l=this.player.timeline.totalTime()+k;return l=Math.round(l/k)*k};p.prototype.resize=function(){};p.prototype.serialize=function(){return k.serialize(this)};
return p}(m.Controllers.Controller);k.MouseWheelController=h})(h.MouseWheel||(h.MouseWheel={}))})(h.Controllers||(h.Controllers={}))})(m.Extensions||(m.Extensions={}))})(ProStyle||(ProStyle={}));
