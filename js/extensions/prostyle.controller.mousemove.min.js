...
__extends(b,c);b.prototype.start=function(a,b){this.stop();this.canvas=a;this.player=b;a.div.addEventListener("mousemove",this.mousemoveBound);a.div.addEventListener("mouseout",this.mouseoutBound)};b.prototype.stop=function(){void 0!==this.player&&(this.canvas.div.addEventListener("mousemove",this.mousemoveBound),this.canvas.div.addEventListener("mouseout",this.mouseoutBound),this.player=this.canvas=void 0)};b.prototype.mouseout=function(a){this.player&&this.player.playCurrentStep()};b.prototype.mousemove=
