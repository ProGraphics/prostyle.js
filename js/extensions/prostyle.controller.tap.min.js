...
c;this.player=b;this.backDiv=a.Util.createChildDivElement(this.canvas.div);this.playDiv=a.Util.createChildDivElement(this.canvas.div);this.nextDiv=a.Util.createChildDivElement(this.canvas.div);this.seekDiv=a.Util.createChildDivElement(this.canvas.div);this.player.stateChanged.on(this.stateChangedBound);this.resize();this.backDiv.addEventListener("click",this.backBound);this.playDiv.addEventListener("click",this.playBound);this.nextDiv.addEventListener("click",this.nextBound);this.seekDiv.addEventListener("click",
this.seekBound);this.cursors&&(this.backDiv.style.cursor=a.Cursors.back_24x24+",w-resize",this.playDiv.style.cursor=a.Cursors.play_20x28+",pointer",this.nextDiv.style.cursor=a.Cursors.next_37x24+",e-resize",this.seekDiv.style.cursor=a.Cursors.seek_36x12+",ew-resize");this.backDiv.style.position=this.playDiv.style.position=this.nextDiv.style.position=this.seekDiv.style.position="absolute"};d.prototype.stop=function(){void 0!==this.player&&(this.backDiv.removeEventListener("click",this.backBound),this.playDiv.removeEventListener("click",
this.playBound),this.nextDiv.removeEventListener("click",this.nextBound),this.seekDiv.removeEventListener("click",this.seekBound),this.player.stateChanged.off(this.stateChangedBound),this.backDiv.parentElement.removeChild(this.backDiv),this.playDiv.parentElement.removeChild(this.playDiv),this.nextDiv.parentElement.removeChild(this.nextDiv),this.seekDiv.parentElement.removeChild(this.seekDiv),this.player=this.canvas=void 0)};d.prototype.mouseout=function(a){this.player&&this.player.playCurrentStep()};
d.prototype.back=function(a){this.player.backStep(!0)};d.prototype.play=function(a){this.player.togglePlay()};d.prototype.next=function(a){this.player.playNextStep(!0)};d.prototype.seek=function(a){this.player.seek(a.clientX/a.currentTarget.offsetWidth,!0)};d.prototype.stateChanged=function(b){this.cursors&&(this.playDiv.style.cursor=b?a.Cursors.play_20x28+",pointer":a.Cursors.pause_21x24+",pointer")};d.prototype.resize=function(){var a=this.canvas.div.offsetWidth,b=this.canvas.div.offsetHeight,d=
a*this.bwr,f=a*this.pwr,g=a*this.nwr,e=b*this.phr,b=b*this.shr;this.backDiv.style.left="0px";this.backDiv.style.top="0px";this.backDiv.style.width=d+"px";this.backDiv.style.height=e+"px";this.playDiv.style.left=d+"px";this.playDiv.style.top="0px";this.playDiv.style.width=f+"px";this.playDiv.style.height=e+"px";this.nextDiv.style.left=d+f+"px";this.nextDiv.style.top="0px";this.nextDiv.style.width=g+"px";this.nextDiv.style.height=e+"px";this.seekDiv.style.left="0px";this.seekDiv.style.top=e+"px";this.seekDiv.style.width=
a+"px";this.seekDiv.style.height=b+"px"};d.prototype.serialize=function(){return b.serialize(this)};return d}(a.Controllers.Controller);b.TapController=f})(b.Tap||(b.Tap={}))})(b.Controllers||(b.Controllers={}))})(a.Extensions||(a.Extensions={}))})(ProStyle||(ProStyle={}));
