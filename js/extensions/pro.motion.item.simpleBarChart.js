        ...
        (function (Extensions) {
            ...
            (function (Items) {
                ...
                (function (simpleBarChart) {
                    var Variables = Pro.Motion.Models.Properties.Variables;
                        ...
                        BarDataVariableType.prototype.scrubValue = function (value) {
                            ...
                            if (typeof value === 'number') {
                                ...
                                parts.forEach(function (part) {
                                    d.push([0, Motion.Util.convertToNumber(part.trim())]);
                                });
                            }
                                ...
                                value.forEach(function (datum) {
                                    if (datum instanceof Array) {
                                        d.push([
                                            datum.length > 0 ? Motion.Util.convertToNumber(datum[0]) : 0,
                                            datum.length > 1 ? Motion.Util.convertToNumber(datum[1]) : 0
                                        ]);
                                    }
                                    else {
                                        d.push([0, Motion.Util.convertToNumber(datum)]);
                                    }
                                });
                            }
                            return d;
        ...
        (function (Extensions) {
            ...
            (function (Items) {
                ...
                (function (simpleBarChart) {
                    ...
                    var DEFAULT_M = 1;
                    var Models = Pro.Motion.Models;
                    var Serialization = Pro.Motion.Serialization;
                    var Util = Pro.Motion.Util;
...
//# sourceMappingURL=pro.motion.item.simpleBarChart.js.map