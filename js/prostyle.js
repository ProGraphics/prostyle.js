...
(function(window) {
 ...
 var _globals = window.GreenSockGlobals || window, _namespace = function(ns) {
  ...
  return result;
 }, _brSwap = ")eefec303079ad17405c", _brExp = /(?:<br>|<br\/>|<br \/>)/gi, _isOldIE = _doc.all && !_doc.addEventListener, _divStart = "<div style='position:relative;display:inline-block;" + (_isOldIE ? "*display:inline;*zoom:1;'" :"'"), _cssClassFunc = function(cssClass) {
  cssClass = cssClass || "";
