    ...
    (function (Types) {
        ...
        var Scale = (function () {
            ...
            Scale.fromJson = function (json) {
                ...
                if (typeof json === 'number') {
                    ...
                    if (parts.length > 0)
                        x = ProStyle.Util.convertToNumber(parts[0].trim(), 100) / 100;
                    if (parts.length > 1)
                        y = ProStyle.Util.convertToNumber(parts[1].trim(), 100) / 100;
                    return new Scale(x, y);
                }
                else if (json instanceof Array) {
                    if (json.length > 0)
                        x = ProStyle.Util.convertToNumber((json[0] || "").toString().trim(), 100) / 100;
                    if (json.length > 1)
                        y = ProStyle.Util.convertToNumber((json[1] || "").toString().trim(), 100) / 100;
                    return new Scale(x, y);
                }
                else {
        ...
        var Xyz = (function () {
            ...
            Xyz.fromJson = function (json) {
                ...
                if (typeof json === 'number') {
                    ...
                    var parts = json.split(",");
                    if (parts.length > 0)
                        x = ProStyle.Util.convertToNumber(parts[0].trim());
                    if (parts.length > 1)
                        y = ProStyle.Util.convertToNumber(parts[1].trim());
                    if (parts.length > 2)
                        z = ProStyle.Util.convertToNumber(parts[2].trim());
                    return new Xyz(x, y, z);
                }
                else if (json instanceof Array) {
                    if (json.length > 0)
                        x = ProStyle.Util.convertToNumber((json[0] || "").toString().trim());
                    if (json.length > 1)
                        y = ProStyle.Util.convertToNumber((json[1] || "").toString().trim());
                    if (json.length > 2)
                        z = ProStyle.Util.convertToNumber((json[2] || "").toString().trim());
                    return new Xyz(x, y, z);
                }
                else {
                    ...
                    if (json.hasOwnProperty(prop)) {
                        ...
                        if (propLower === "position" || propLower === "pos") {
                            ...
                            if (typeof o === 'number')
                                ...
                                opacity = ProStyle.Util.convertToNumber(o, 100) / 100;
                            else if (o instanceof Array) {
                                if (o.length > 0)
                                    opacity = ProStyle.Util.convertToNumber(o[0], 100) / 100;
                            }
                            else {
        ...
        var Shadow = (function () {
            ...
            Shadow.prototype.render = function (xScale, yScale, isBoxShadow) {
                ...
                if (x === 0 && this.x !== 0)
                    x = ProStyle.Util.getSign(this.x);
                if (y === 0 && this.y !== 0)
                    y = ProStyle.Util.getSign(this.y);
                if (blur === 0 && this.blur !== 0)
                    blur = ProStyle.Util.getSign(this.blur);
                if (spread === 0 && this.spread !== 0)
                    spread = ProStyle.Util.getSign(this.spread);
                blur = Math.abs(blur);
                var parts = [];
            ...
            Shadow.fromJson = function (json) {
                ...
                if (json.length > 0 && json[0] !== undefined)
                    x = ProStyle.Util.convertToNumber(json[0], 0);
                if (json.length > 1 && json[1] !== undefined)
                    y = ProStyle.Util.convertToNumber(json[1], 0);
                if (json.length > 2 && json[2] !== undefined)
                    blur = Math.max(0, ProStyle.Util.convertToNumber(json[2], 0));
                if (json.length > 3 && json[3] !== undefined)
                    color = json[3];
                if (json.length > 4 && json[4] !== undefined)
                    spread = ProStyle.Util.convertToNumber(json[4], 0);
...
(function (ProStyle) {
        ...
        (function (Items) {
            ...
            var Item = (function (_super) {
                ...
                function Item(item, itemSetElem, element) {
                    ...
                    _super.call(this, item, element || Util.createChildDivElement(itemSetElem.div, "prostyle prostyle-item"));
                    this.item = item;
                ...
                var OriginVariableType = (function (_super) {
                    ...
                    OriginVariableType.prototype.scrubArray = function (a) {
                        ...
                        if (this.transform && a.length > 2)
                            v.z = ProStyle.Util.convertToNumber(a[2], 0, true);
                        return v;
                    };
        ...
        var ItemReader = (function () {
            ...
            ItemReader.read = function (itemSet, json) {
                ...
                if (reader === undefined) {
                    ...
                    return ProStyle.Extensions.Items.unknown.readJson(itemSet, json);
                }
                else {
    ...
    (function (Render) {
        ...
        var Page = (function (_super) {
            ...
            function Page(page, flowElem, flowIndex, pageIndex) {
                var _this = this;
                _super.call(this, page, Util.createChildDivElement(flowElem.div, "prostyle prostyle-page"));
                this.page = page;
                ...
                if (items instanceof Array) {
                    items.forEach(function (item) {
                        ...
                        if (item.itemType === "text")
                            ...
                            itemClass = ProStyle.Serialization.ItemReader.lookupExtension(item.itemType.toLowerCase()).Renderer;
        ...
        (function (Flows) {
            ...
            var Flow = (function (_super) {
                ...
                function Flow(flow, cameraElem, flowIndex) {
                    var _this = this;
                    _super.call(this, cameraElem.model, Util.createChildDivElement(cameraElem.div, "prostyle prostyle-flow"));
                    this.flow = flow;
    ...
    (function (Extensions) {
        ...
        (function (_Items) {
            var unknown;
            (function (unknown) {
                var Items = ProStyle.Render.Items;
                var Renderer = (function (_super) {
                    __extends(Renderer, _super);
    ...
    (function (Models) {
        ...
        (function (Properties) {
            var AnchorPropertyType = (function (_super) {
                ...
                AnchorPropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = _super.prototype.createPropertyFromBoolean.call(this, false);
                    if (json.length > 0)
                        property["x"].setValue(ProStyle.Util.convertToNumber(json[0], 0, true));
                    if (json.length > 1)
                        property["y"].setValue(ProStyle.Util.convertToNumber(json[1], 0, true));
                    return property;
                };
        ...
        (function (Properties) {
            var MoveToPropertyType = (function (_super) {
                ...
                MoveToPropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = new Properties.Property(this);
                    if (json.length > 0)
                        property["item"].setValue(json[0] === null ? undefined : ProStyle.Util.convertToNumber(json[0]));
                    return property;
                };
        ...
        (function (Properties) {
            var OpacityPropertyType = (function (_super) {
                ...
                OpacityPropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = _super.prototype.createPropertyFromBoolean.call(this, false);
                    if (json.length > 0)
                        property["percent"].setValue(ProStyle.Util.convertToNumber(json[0], 100));
                    return property;
                };
        ...
        (function (Properties) {
            var PositionPropertyType = (function (_super) {
                ...
                PositionPropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = _super.prototype.createPropertyFromBoolean.call(this, false);
                    if (json.length > 0)
                        property["x"].setValue(ProStyle.Util.convertToNumber(json[0]));
                    if (json.length > 1)
                        property["y"].setValue(ProStyle.Util.convertToNumber(json[1]));
                    if (json.length > 2)
                        property["z"].setValue(ProStyle.Util.convertToNumber(json[2]));
                    return property;
                };
        ...
        (function (Properties) {
            var SizePropertyType = (function (_super) {
                ...
                SizePropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = _super.prototype.createPropertyFromBoolean.call(this, false);
                    if (json.length > 0)
                        property["width"].setValue(ProStyle.Util.convertToNumber(json[0]));
                    if (json.length > 1)
                        property["height"].setValue(ProStyle.Util.convertToNumber(json[1]));
                    return property;
                };
        ...
        (function (Properties) {
            var SkewPropertyType = (function (_super) {
                ...
                SkewPropertyType.prototype.createPropertyFromArray = function (json) {
                    var property = _super.prototype.createPropertyFromBoolean.call(this, false);
                    if (json.length > 0)
                        property["degrees"].setValue(json[0] === null ? undefined : ProStyle.Util.convertToNumber(json[0]));
                    return property;
                };
                ...
                ShadowPropertyType.prototype.parseString = function (s) {
                    ...
                    parts.forEach(function (part, index) {
                        ...
                        if (index === 3)
                            ...
                            arr.push(ProStyle.Util.convertToNumber(part));
                    });
                    return arr;
                };
        ...
        (function (Properties) {
            var TextWidthPropertyType = (function (_super) {
                ...
                TextWidthPropertyType.prototype.createPropertyFromArray = function (json) {
                    ...
                    var value = this.variableTypes[0].defaultValue;
                    if (json.length > 0)
                        value = ProStyle.Util.convertToNumber(json[0], value);
        ...
        (function (Items) {
            var LayerItem = (function (_super) {
                ...
                LayerItem.prototype.getCountOfStepsUsed = function () {
                    var stepsUsed = 1;
                    this.scriptSets.forEach(function (scriptSet) {
                        stepsUsed = Math.max(stepsUsed, scriptSet.getCountOfStepsUsed());
                    });
            ...
            FlowReader.read = function (story, json) {
                ...
                if (reader === undefined) {
                    ...
                    if (extension && extension["readJson"]) {
                        ...
                        flow = ProStyle.Extensions.Flows.unknown.readJson(story, json);
                    }
                }
                else {
    ...
    (function (Render) {
        ...
        var Camera = (function (_super) {
            ...
            function Camera(story, frameElem) {
                var _this = this;
                _super.call(this, story.frame, Util.createChildDivElement(frameElem.div, "prostyle prostyle-camera"));
                this.story = story;
                ...
                story.flows.forEach(function (flow, flowIndex) {
                    ...
                    if (flow.flowType === "simple")
                        ...
                        flowClass = ProStyle.Serialization.FlowReader.lookupExtension(flow.flowType.toLowerCase()).Renderer;
        ...
        var Frame = (function (_super) {
            ...
            function Frame(story, canvasElem) {
                _super.call(this, story.frame, Util.createChildDivElement(canvasElem.div, "prostyle prostyle-frame"));
                this.story = story;
    ...
    (function (Render) {
        ...
        var Canvas = (function (_super) {
            ...
            function Canvas(story, div, config) {
                ...
                this.player = new ProStyle.Play.Player(this.frameElem);
                this.controls = ProStyle.Play.Controls.byConfig(this, config.controls);
                this.autoPlay = new ProStyle.Play.AutoPlay(this, config.auto);
        ...
        (function (Items) {
            ...
            var ImageItem = (function (_super) {
                ...
                function ImageItem(imageItem, itemSetElem) {
                    _super.call(this, imageItem, itemSetElem, Util.createChildImageElement(itemSetElem.div, "prostyle prostyle-item", imageItem.itemSet.flow.story.canvas.adjustImageUrl(imageItem.src), imageItem.width, imageItem.height));
            ...
            var LayerItem = (function (_super) {
                ...
                function LayerItem(layerItem, itemSetElem) {
                    _super.call(this, layerItem, itemSetElem, Util.createChildDivElement(itemSetElem.div, "prostyle prostyle-layer"));
            ...
            var TextItem = (function (_super) {
                ...
                function TextItem(textItem, itemSetElem) {
                    _super.call(this, textItem, itemSetElem, Util.createChildDivElement(itemSetElem.div, "prostyle prostyle-text"));
                    ...
                    if (this.lines || this.words || this.chars) {
                        ...
                        if (this.lines)
                            config.linesClass = item.stackedLines ? "prostyle-text-line-stacked" : "prostyle-text-line";
                        if (this.words)
                            config.wordsClass = item.stackedWords ? "prostyle-text-word-stacked" : "prostyle-text-word";
                        if (this.chars)
                            config.charsClass = item.stackedChars ? "prostyle-text-char-stacked" : "prostyle-text-char";
    ...
    (function (Serialization) {
        ...
        var CanvasReader = (function () {
            ...
            CanvasReader.read = function (json) {
                ...
                return new ProStyle.Models.Canvas(init, padding, ProStyle.Util.getSetup(json, "imageRootUrl"));
            };
            return CanvasReader;
        })();
        ...
        var FlowWriter = (function () {
            ...
            FlowWriter.write = function (flow) {
                ...
                if (writer === undefined) {
                    ProStyle.Util.logError("FlowWriter.write()", "Unknown Flow Type (" + json.flowType + ")");
                }
                else {
                    writer(flow, json);
                }
        ...
        var FrameReader = (function () {
            ...
            FrameReader.read = function (json) {
                ...
                var padding = Math.max(0, Math.min(ProStyle.Util.convertToNumber(ProStyle.Util.getSetup(json, "padding"), 0), 50));
                return new ProStyle.Models.Frame(init, aspectRatio, padding);
            };
    ...
    function initCanvas(div) {
        var storyName = div.dataset["prostyle"];
        if (storyName !== undefined) {
            var container = ProStyle.Stories[storyName];
            if (container === undefined || container.story === undefined) {
                ...
                var storyConfig = div.dataset["prostyleConfig"];
                if (storyConfig !== undefined)
                    config = ProStyle.Stories.Config[storyConfig];
                config = config || container.config || ProStyle.Stories.Config[storyName] || ProStyle.Stories.Config.default;
                div.innerHTML = "";
                var story = ProStyle.Serialization.StoryReader.read(container.story);
                var canvas = new ProStyle.Render.Canvas(story, div, config);
