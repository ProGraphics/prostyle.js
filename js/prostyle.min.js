...
this.currentStep.isAtStart(b),this.currentStep.isAtEnd(b),!1)};b.prototype.seekStep=function(a,g){void 0===g&&(g=!1);this.timeline.pause();this.timeline.seek(a.startLabel);this.currentStep=a;this.alignSequencedItemsToStep(a,!0,!1,g);this.triggerProgressChanged();this.triggerStateChanged()};b.prototype.alignSequencedItemsToStep=function(a,g,b,c){var d=this;void 0===c&&(c=!1);var e=!0;this.steps.forEach(function(h){var f=h===a;f&&(e=!1);if(!f||!b){var k=0,k=h===a?g?0:1:e?-1:0;h.sequencedItems.forEach(function(a){a.moveToSubStep(k,
