...
(d.Keyboard={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.Keyboard||(d.Keyboard={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a){void 0===a&&(a=.01);b.call(this,"resize");this.throttleDelay=a;this.canvasResize=void 0}__extends(a,b);a.prototype.start=function(a,b){this.stop();this.canvasResize=a.resize.bind(a);0<this.throttleDelay?window.addEventListener("resize",f.Util.throttle(this.canvasResize,
1E3*this.throttleDelay),!1):window.addEventListener("resize",this.canvasResize,!1)};a.prototype.stop=function(){void 0!==this.canvasResize&&(window.removeEventListener("resize",this.canvasResize,!1),this.canvasResize=void 0)};a.prototype.resize=function(){};a.prototype.serialize=function(){return d.serialize(this)};return a}(f.Controllers.Controller);d.ResizeController=c})(d.Resize||(d.Resize={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.deserialize=function(c){c=f.Util.convertToNumber(c.throttleDelay);
...
e.svgRemoveClass=function(b,a){var c=b.getAttribute("class")||"",c=c.replace(new RegExp("\\s?"+a),"");b.setAttribute("class",c)};e.createChildSvgElement=function(b,a,c){void 0===c&&(c=void 0);a=document.createElementNS("http://www.w3.org/2000/svg",a);for(var d in c)a.setAttribute(d,c[d]);b.appendChild(a);return a};e.getOffset=function(b){b=b.getBoundingClientRect();var a=document.body,c=document.documentElement,d=b.left+(window.pageXOffset||c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||
0);return{top:Math.round(b.top+(window.pageYOffset||c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0)),left:Math.round(d)}}})(f.Util||(f.Util={}));(function(e){(function(c){var b=f.Util,a=f.Models.Properties,d=function(){function c(){}c.generateTimeline=function(b,d,f,g,h,l,p){void 0===p&&(p=void 0);var q=c.getMoveTo(g.properties,b.items),r=[];for(b=0;b<f.length;b++)r.push({force3D:!0,immediateRender:!1,delay:g.delay,element:f[b],elementIndex:b});var x=0,v=0,y=g.script.scriptSet.itemModelSet.flow.story;
g.properties.forEach(function(b){b.type instanceof a.AnimationPropertyType?(v=b.duration.getValue()||0,x=b.stagger.getValue()||0,0<v&&b.writeCssBuckets(y,d.model,l,r,!1)):void 0!==q&&(b.type instanceof a.MoveToPropertyType||b.type instanceof a.PositionPropertyType||b.type instanceof a.RotationPropertyType||b.type instanceof a.ScalePropertyType||b.type instanceof a.SkewPropertyType)||b.writeCssBuckets(y,d.model,l,r,!1)});e.View.postProcessCssBuckets(r,p,g.properties,l);g=h.totalDuration();for(b=0;b<
f.length;b++)0<v?h.to(f[b],v,r[b],g):h.set(f[b],r[b],g),g+=x;return q};c.getMoveTo=function(b,c){var d=void 0;b.forEach(function(b){b.type instanceof a.MoveToPropertyType&&(d=b.getVariable("item").getValue(),void 0!==d&&(0>d||d>c.length)&&(d=void 0))});return d};c.generateMoveTo=function(a,c,d){if(c){var e=b.getGSTransform(c),f=[];(e.x||e.y||e.z)&&f.push("translate3d("+-e.x+"px,"+-e.y+"px,"+-e.z+"px)");e.rotationX&&f.push("rotateX("+-e.rotationX+"deg)");e.rotationY&&f.push("rotateY("+-e.rotationY+
"deg)");e.rotation&&f.push("rotate("+-e.rotation+"deg)");var g=Math.max(0,Math.min(0===e.scaleX?1:1/e.scaleX,10)),h=Math.max(0,Math.min(0===e.scaleY?1:1/e.scaleY,10));1!==e.scaleX&&f.push("scaleX("+g+")");1!==e.scaleY&&f.push("scaleY("+h+")");e.skewX&&f.push("skewX("+-e.skewX+"deg)");console.log(f.join(" "));console.log(c._gsTransform);c={transform:f.join(" "),xPercent:-50,yPercent:-50};d.to(a,1.2,c)}};return c}();c.SetPropertiesAction=d})(e.Actions||(e.Actions={}));(function(c){var b=function(a){function b(c,
d,e){a.call(this,c,d,e);this.model=c}__extends(b,a);return b}(c.FlowView);c.PlacementFlowView=b})(e.Flows||(e.Flows={}));var d=function(){function c(b,a,c,d,e){this.step=b;this.flowIndex=a;this.pageIndex=c;this.stepIndex=d;this.sequencedItems=e;this.playerStepIndex=this.time=0;this.label=a.toString()+"-"+c.toString()+"-"+d.toString()+"-";this.startLabel=this.label+"start";this.stopLabel=this.label+"stop";b.startLabel=this.startLabel;b.stopLabel=this.stopLabel}c.prototype.isAtStart=function(b){return.02>
Math.abs(b-this.startTime)};c.prototype.isAtEnd=function(b){return.02>Math.abs(b-this.stopTime)};c.prototype.getSubStepCount=function(){var b=0;this.sequencedItems.forEach(function(a){b=Math.max(b,a.getCountOfSubSteps())});return b};return c}();e.Step=d;var h=f.Types,d=function(){function c(b,a){this.generateTimeline(b,a)}c.prototype.generateTimeline=function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=
new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,q=b.size,r=b.camera,n=r.size,l={fontFamily:"arial"};e.fullScreen||(l.height=f.height);e.initializeProperties(d,[e.div],n,this.timeline,d.canvas.init,!1,l);l={width:q.width,height:q.height};b.initializeProperties(d,[b.div],n,this.timeline,d.frame.init,!1,l);r.flows.forEach(function(a){var e=n.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,
[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var p=void 0;r.flows.forEach(function(a){p=a.generateStepsActions(c.timeline,p)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.defaultControllers=[{controllerType:"auto"},{controllerType:"resize"}];f.reload=B;f.bootstrap=r;r()})(ProStyle||(ProStyle={}));
