...
(f.toStart={}))})(f.Svg||(f.Svg={}));(function(f){f.setElementText=function(f,u){f[void 0!==document.body.textContent?"textContent":"innerText"]=u}})(f.Util||(f.Util={}));(function(f){var r=function(){return function(f){this.initPropertyLists=f;this.init=f[0]}}();f.Model=r})(f.Models||(f.Models={}));(function(f){f.rootUrl=void 0;f.Config={default:{auto:{start:!0,advance:!1,advanceDelay:0,restart:!0,resize:!0},controls:{type:"track",autoHide:!0,color:"#EEE",highlightColor:"#FFF",backColor:"#094766",
stepColor1:"#0c5f89",stepColor2:"#EEE",startHint:!0},keyboard:!1,touch:!1,mouseWheel:!1,debugBar:!1}}})(f.Stories||(f.Stories={}));(function(f){var r=function(){function f(r,t){void 0===r&&(r=f.DEFAULT_WIDTH);void 0===t&&(t=f.DEFAULT_HEIGHT);this.width=r;this.height=t;this.width=Math.max(f.MIN,Math.min(r,f.MAX));this.height=Math.max(f.MIN,Math.min(t,f.MAX))}f.prototype.aspectRatio=function(){return this.height?this.width/this.height:1};f.prototype.getContainedSize=function(r){var t=this.aspectRatio();
return r<t?new f(this.height*r,this.height):r>t?new f(this.width,this.width/r):new f(this.width,this.height)};f.DEFAULT_WIDTH=1024;f.DEFAULT_HEIGHT=768;f.MIN=1;f.MAX=4096;return f}();f.Size=r})(f.Types||(f.Types={}));(function(f){f.splitNoParens=function(f){var u=0,x=0,t=[];f=f.match(/([^()]+)|([()])/g);for(var e=f.length,d,h="",c=0;c<e;c++)d=f[c],"("===d?u++:")"===d&&x++,0!==u?(h+=d,u===x&&(t[t.length-1]+=h,u=x=0,h="")):t=t.concat(d.match(/([^,]+)/g));return t};f.isAbsoluteUrl=function(f){if(f){f=
f.toString().trim();if(0===f.indexOf("//"))return!0;f=f.toLowerCase();if(0===f.indexOf("http://")||0===f.indexOf("https://")||0===f.indexOf("ftp://"))return!0}return!1}})(f.Util||(f.Util={}))})(ProStyle||(ProStyle={}));var __extends=this&&this.__extends||function(f,x){function r(){this.constructor=f}for(var u in x)x.hasOwnProperty(u)&&(f[u]=x[u]);r.prototype=x.prototype;f.prototype=new r};
(function(f){function x(e){if(void 0!==e.dataset.prostyle){"relative"!==e.style.position&&"absolute"!==e.style.position&&(e.style.position="relative");var d=document.createElement("progress");d.value=1;d.max=2;d.style.position="absolute";d.style.left="50%";d.style.top="50%";d.style.transform="translate(-50%,-50%)";e.innerHTML="";e.appendChild(d)}}function r(){var e=document.body;if(e)if(void 0!==e.dataset.prostyle)x(e);else for(var e=document.getElementsByTagName("div"),d=0;d<e.length;d++)x(e[d])}
function u(e){var d=e.dataset.prostyle;if(void 0!==d){var h=f.Stories[d];void 0===h?e.innerHTML="<strong style='background-color: #FFF;color:#C00'>Missing story at ProStyle.Stories."+d+"</strong>":(e.innerHTML="",d=f.Serialization.StoryReader.read(h),d=new f.Views.CanvasView(d,e),d.startControllers(),e.proStyleCanvas=d)}}function B(){var e=document.body;if(e)if(void 0!==e.dataset.prostyle)u(e);else for(var e=document.getElementsByTagName("div"),d=0;d<e.length;d++)u(e[d])}function t(){r();window.addEventListener("load",
function(){void 0===f.Stories.rootUrl&&(f.Stories.rootUrl=window.Pro_Style_Stories_rootUrl);r();B()})}(function(e){var d=function(d){function c(b,a,g){d.call(this,[b]);this.padding=a;this.imageRootUrl=g;this.setAdjustedImageRootUrl(g)}__extends(c,d);c.prototype.setAdjustedImageRootUrl=function(b){if(b&&(b=b.toString().trim(),f.Util.isAbsoluteUrl(b))){this.adjustedImageRootUrl=b;return}var a=f.Stories.rootUrl;if(a){var g=a.lastIndexOf("/")===a.length-1;b&&(a=0===b.indexOf("/")?g?a+b.substr(1):a+b:
g?a+b:a+("/"+b))}else a=b;a&&a.lastIndexOf("/")!==a.length-1&&(a+="/");this.adjustedImageRootUrl=a};c.prototype.adjustBackgroundImage=function(b,a){var g=this,c=[];f.Util.splitNoParens(b).forEach(function(a){a=a.trim();0===a.toLowerCase().indexOf("url(")&&(a="url("+g.adjustImageUrl(a)+")");c.push(a)});return c.join(",")};c.prototype.adjustImageUrl=function(b){0===b.toLowerCase().indexOf("url(")&&(b=b.substr(4,b.length-5).trim());this.adjustedImageRootUrl&&(f.Util.isAbsoluteUrl(b)||(b=0===b.indexOf("/")?
this.adjustedImageRootUrl+b.substr(1):this.adjustedImageRootUrl+b));return b};return c}(e.Model);e.CanvasModel=d;d=function(d){function c(b,a,g){d.call(this,[b]);this.aspectRatio=a;this.padding=g}__extends(c,d);return c}(e.Model);e.FrameModel=d})(f.Models||(f.Models={}));(function(e){var d=function(){function d(c,b){void 0===c&&(c=1);this.x=c;this.y=b;void 0===b&&(this.y=c)}d.fromJson=function(c){if(void 0===c||null===c)return new d;var b=100,a=void 0;return"number"===typeof c?new d(c/100,c/100):
"string"===typeof c?(c=c.split(","),0<c.length&&(b=f.Util.convertToNumber(c[0].trim(),100)/100),1<c.length&&(a=f.Util.convertToNumber(c[1].trim(),100)/100),new d(b,a)):c instanceof Array?(0<c.length&&(b=f.Util.convertToNumber((c[0]||"").toString().trim(),100)/100),1<c.length&&(a=f.Util.convertToNumber((c[1]||"").toString().trim(),100)/100),new d(b,a)):new d(f.Util.convertToNumber(c.x,100)/100,void 0===c.y?void 0:f.Util.convertToNumber(c.y,100)/100)};d.prototype.equals=function(c){return void 0===
c?!1:this.x===c.x&&this.y===c.y};return d}();e.Scale=d})(f.Types||(f.Types={}));(function(e){e.convertToNumber=function(d,h,c){void 0===h&&(h=0);void 0===c&&(c=!1);"string"==typeof d&&c&&(d=parseFloat(d));return isNaN(d)?h:Number(d)};e.convertToNumber2=function(d){return""===d?void 0:isNaN(d)?void 0:Number(d)}})(f.Util||(f.Util={}));(function(e){var d=function(){function d(c,b,a){void 0===c&&(c=0);void 0===b&&(b=0);void 0===a&&(a=0);this.x=c;this.y=b;this.z=a}d.fromJson=function(c){if(void 0===c||
null===c)return new d;var b=0,a=0,g=0;return"number"===typeof c?new d(c):"string"===typeof c?(c=c.split(","),0<c.length&&(b=f.Util.convertToNumber(c[0].trim())),1<c.length&&(a=f.Util.convertToNumber(c[1].trim())),2<c.length&&(g=f.Util.convertToNumber(c[2].trim())),new d(b,a,g)):c instanceof Array?(0<c.length&&(b=f.Util.convertToNumber((c[0]||"").toString().trim())),1<c.length&&(a=f.Util.convertToNumber((c[1]||"").toString().trim())),2<c.length&&(g=f.Util.convertToNumber((c[2]||"").toString().trim())),
new d(b,a,g)):new d(f.Util.convertToNumber(c.x),f.Util.convertToNumber(c.y),f.Util.convertToNumber(c.z))};d.prototype.equals=function(c){return void 0===c?!1:this.x===c.x&&this.y===c.y&&this.z===c.z};return d}();e.Xyz=d;d=function(){function d(c,b,a,g){void 0===g&&(g=1);this.position=c;this.rotation=b;this.scale=a;this.opacity=g;Math.max(0,Math.min(g,1))}d.prototype.duplicate=function(){return new d(new e.Xyz(this.position.x,this.position.y,this.position.z),new e.Xyz(this.rotation.x,this.rotation.y,
this.rotation.z),new e.Scale(this.scale.x,this.scale.y),this.opacity)};d.prototype.adjust=function(c){this.position.x+=c.position.x;this.position.y+=c.position.y;this.position.z+=c.position.z;this.rotation.x+=c.rotation.x;this.rotation.y+=c.rotation.y;this.rotation.z+=c.rotation.z;this.scale.x=Math.max(0,this.scale.x*c.scale.x);this.scale.y=Math.max(0,this.scale.y*c.scale.y);this.opacity=Math.max(0,Math.min(this.opacity*c.opacity,1))};d.prototype.renderCss=function(c,b,a){void 0===b&&(b={});void 0===
a&&(a=!0);a&&(b.xPercent=-50,b.yPercent=-50);a=(c.width+c.height)/2;b.x=this.position.x/100*c.width;b.y=this.position.y/100*c.height;b.z=this.position.z/100*a;b.zIndex=10*this.position.z;b.rotationX=this.rotation.x;b.rotationY=this.rotation.y;b.rotationZ=this.rotation.z;b.scaleX=this.scale.x;b.scaleY=this.scale.y;b.autoAlpha=this.opacity;return b};d.fromJson=function(c){c=c||{};var b=new e.Xyz,a=new e.Xyz,g=new e.Scale,n=1,m;for(m in c)if(c.hasOwnProperty(m)){var k=m.trim().toLowerCase();"position"===
k||"pos"===k?b=e.Xyz.fromJson(c[m]):"rotation"===k||"rotate"===k||"rot"===k?a=e.Xyz.fromJson(c[m]):"scale"===k?g=e.Scale.fromJson(c[m]):"opacity"===k&&(k=c[m],"number"===typeof k?n=k/100:"string"===typeof k?n=f.Util.convertToNumber(k,100)/100:k instanceof Array?0<k.length&&(n=f.Util.convertToNumber(k[0],100)/100):n=f.Util.convertToNumber(k.percent,100)/100)}return new d(b,a,g,Math.max(0,Math.min(n,1)))};d.prototype.equals=function(c){return void 0===c||void 0===c.position||void 0===c.rotation||void 0===
c.scale||void 0===c.opacity||!1===this.position.equals(c.position)||!1===this.rotation.equals(c.rotation)||!1===this.scale.equals(c.scale)?!1:this.opacity===c.opacity};return d}();e.Placement=d})(f.Types||(f.Types={}));(function(e){(function(d){var c=function(){function b(a,g){this.propertyTypes=a;this.properties=g}b.prototype.getPropertyOfType=function(a){for(var g=0;g<this.properties.length;g++){var b=this.properties[g];if(b.type===a)return b}};b.prototype.hasAnythingSet=function(){for(var a=0;a<
this.properties.length;a++)for(var g=this.properties[a],b=0;b<g.type.variableTypes.length;b++)if(void 0!==g[g.type.variableTypes[b].jsonNames[0]].getValue())return!0;return!1};return b}();d.PropertyList=c})(e.Properties||(e.Properties={}));var d=function(d){function c(b,a){d.call(this,[b]);this.flow=a;this.steps=[];this.items=[];this.story=a.story}__extends(c,d);c.prototype.insertStep=function(b){f.Util.insertIntoArray(this.steps,b,new e.Step);this.canvasScriptSet.insertStep(b);this.frameScriptSet.insertStep(b);
this.pageScriptSet.insertStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.insertStep(b)})})};c.prototype.deleteStep=function(b){this.steps.splice(b,1);this.canvasScriptSet.deleteStep(b);this.frameScriptSet.deleteStep(b);this.pageScriptSet.deleteStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.deleteStep(b)})})};c.prototype.deleteItem=function(b){this.items.splice(b,1)};return c}(e.Model);e.PageModel=d;(function(d){var c=function(b){function a(a,c,
m,d,e){void 0===e&&(e=void 0);b.call(this,[]);this.story=a;this.flowType=c;this.placement=m;this.pageAspectRatio=d;this.defaultPageClass=e;this.pages=[]}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.defaultPageClass};a.prototype.getDefaultPageClassValue=function(){};a.prototype.serialize=function(){f.Util.logError("ProStyle.Models.Flows.Flow.serialize","Abstract base method called.")};a.prototype.createView=function(a,b){f.Util.logError("ProStyle.Models.Flows.Flow.createView",
"Abstract base method called.")};return a}(e.Model);d.FlowModel=c})(e.Flows||(e.Flows={}));d=function(){return function(d,c,b,a,g,n){this.canvas=d;this.frame=c;this.flows=b;this.classes=a;this.controllers=g;this.usingDefaultControllers=n}}();e.Story=d;(function(d){var c=function(){function b(a){var g=this;this.type=a;a.variableTypes.forEach(function(a){g[a.jsonNames[0]]=a.createVariable()})}b.prototype.getVariable=function(a){return this[a]};b.prototype.renderLabel=function(){return this.type.renderLabel(this)};
b.prototype.writeCssBuckets=function(a,g,b,c,d){var e=this;this.type.variableTypes.forEach(function(h){h=e[h.jsonNames[0]];h.type.writeCssBuckets(a,g,b,h,c,d)})};return b}();d.Property=c})(e.Properties||(e.Properties={}));(function(d){(function(c){c[c.InitEvent=0]="InitEvent";c[c.StepEvent=1]="StepEvent";c[c.SwitchEvent=2]="SwitchEvent";c[c.ActionsOrphan=3]="ActionsOrphan";c[c.PropertyOrphan=4]="PropertyOrphan"})(d.ScriptType||(d.ScriptType={}));(function(c){c.fromString=function(b){b=(b||"step").toString().toLowerCase().trim();
if("init"===b)return c.InitEvent;if(0===b.indexOf("step"))return c.StepEvent;if("switch"===b)return c.SwitchEvent;if("actionsorphan"===b)return c.ActionsOrphan;if("propertyorphan"===b)return c.PropertyOrphan;f.Util.logError("ScriptType.fromString()","Unknown script type: "+b);return c.StepEvent};c.toString=function(b){return b===c.InitEvent?"init":b===c.StepEvent?"step":b===c.SwitchEvent?"switch":b===c.ActionsOrphan?"actionsorphan":b===c.PropertyOrphan?"propertyorphan":"init"}})(d.ScriptType||(d.ScriptType=
{}))})(e.Scripts||(e.Scripts={}))})(f.Models||(f.Models={}));(function(e){var d=f.Models,h=f.Models.Scripts,c=f.Models.Properties,b=function(){function a(a,b){this.model=a;this.element=b;this.div=void 0;if(b instanceof HTMLDivElement||b instanceof HTMLBodyElement)this.div=b;b.proCache={}}a.prototype.initializeProperties=function(g,b,m,d,e,h,f,l){var q=this;void 0===f&&(f=void 0);void 0===l&&(l=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var y=[];for(f=0;f<b.length;f++){var z=
{force3D:!0,element:b[f],elementIndex:f};h&&(z.xPercent=-50,z.yPercent=-50);y.push(z)}var w=[];e.properties.forEach(function(a){w["prostyle_"+a.type.jsonNames[0]]=a});e.propertyTypes.forEach(function(a){var b=w["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));b.writeCssBuckets(g,q,m,y,!0)});a.postProcessCssBuckets(y,l,e.properties,m);for(f=0;f<b.length;f++)d.set(b[f],y[f],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,k,h,f,p){var l=this;void 0===p&&(p=void 0);var q=
new TimelineMax;k.actions.forEach(function(k){if(k.actionType===d.Actions.ActionType.SetProperties){var z=q.totalDuration(),w=e.Actions.SetPropertiesAction.generateTimeline(a,l,b,k,q,c,p);void 0!==w&&(k=q.totalDuration(),(w=0<w?a.items[w-1].div:void 0)&&h.seek(f+"+="+k),k=new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,w,k),q.add(k,z))}});h.add(q,f)};a.prototype.generateActionsForStep=function(a,b,c,d,e,f,p,l){var q=this;void 0===l&&(l=void 0);p.scripts.forEach(function(p){p.type===
h.ScriptType.StepEvent&&p.stepIndex===e&&q.generateEventTimeline(a,b,c,p,d,f,l)})};a.postProcessCssBuckets=function(a,b,c,d){for(var e=0;e<a.length;e++){var h=a[e],f=h.element.proCache;void 0!==f&&(void 0!==h.width&&(f.width=h.width),void 0!==h.height&&(f.height=h.height))}b&&b(c,a,d);a.forEach(function(a){delete a.element;delete a.elementIndex})};return a}();e.View=b})(f.Views||(f.Views={}));(function(e){var d=function(){function d(){}d.read=function(c,b){b.setup=b.setup||{};var a=(b.flowType||"simple").trim().toLowerCase(),
g,n=d.lookupExtension(a);n&&n.deserialize?g=n.deserialize(c,b):(f.Util.logError("FlowReader.read()","Unknown Flow Type ("+a+")"),g=f.Extensions.Flows.Unknown.deserialize(c,b));b.pages instanceof Array?b.pages.forEach(function(a){g.pages.push(e.PageReader.read(g,a))}):g.pages.push(e.PageReader.read(g,b.page||{}));return g};d.lookupExtension=function(c){for(var b in f.Extensions.Flows){var a=b.toLowerCase();if(c===a)return f.Extensions.Flows[b]}};return d}();e.FlowReader=d})(f.Serialization||(f.Serialization=
{}));(function(e){var d=f.Util,h=function(c){function b(a,g){var b=this;c.call(this,a.frame,d.createChildDivElement(g.div,"prostyle prostyle-camera"));this.story=a;this.frame=g;this.flows=[];this.resize();a.flows.forEach(function(a,g){b.flows.push(a.createView(b,g))})}__extends(b,c);b.prototype.resize=function(){var a=this.frame.size,g=(100-this.story.frame.padding)/100,a=new f.Types.Size(a.width*g,a.height*g);1>a.width&&(a.width=1);1>a.height&&(a.height=1);this.size=a;TweenLite.set(this.div,{width:this.size.width,
height:this.size.height,clearProps:"transform"})};b.prototype.stepStopped=function(a,g){a.pause(g.stopLabel)};return b}(e.View);e.CameraView=h;d=f.Util;h=function(c){function b(a,g){c.call(this,a.frame,d.createChildDivElement(g.div,"prostyle prostyle-frame"));this.story=a;this.canvas=g;this.resize();this.camera=new e.CameraView(a,this)}__extends(b,c);b.prototype.stepStopped=function(a,g){a.pause(g.stopLabel)};b.prototype.resize=function(){var a=this.canvas.size,g=this.story.frame.aspectRatio,b=(100-
...
b=this.canvas.player,d=this.scrubberSize,e=d.width-d.barHeight,f=d.barHeight/2;a=Math.max(f,Math.min(a.clientX-g.left-d.left,d.width-f))-d.barHeight;this.divScrubberHoverPoint.style.left=(a+f+f/2-1).toString()+"px";b=b.timeline.duration()*(a+f)/e;this.divScrubberHoverText.style.left=a.toString()+"px";c.setElementText(this.divScrubberHoverText,b.toFixed(2))};a.prototype.scrubberMouseClick=function(a){var g=this.canvas.div.getBoundingClientRect(),b=this.canvas.player,c=this.scrubberSize,d=c.width-c.barHeight,
e=c.barHeight/2;a=Math.max(e,Math.min(a.clientX-g.left-c.left,c.width-e))-c.barHeight;b.seek((a+e)/d,!0)};a.prototype.setupPlayerEvents=function(){var a=this.canvas.player;a.progressChanged.on(this.progressChanged.bind(this));a.stateChanged.on(this.stateChanged.bind(this))};a.prototype.setupMenuOnMouseMove=function(){var a=this.canvas.div,g=this.canvas.fullScreen,b=c.throttle(function(){a.classList.remove("mouseMovement");g&&(a.style.cursor="none")},1500);a.onmousemove=function(c){a.classList.add("mouseMovement");
g&&(a.style.cursor="auto");b()}};a.prototype.progressChanged=function(a){this.progress=a.progress;this.updateScrubberProgress()};a.prototype.stateChanged=function(a){this.playDiv.innerHTML=a?b.play.svg:b.pause.svg};a.prototype.resize=function(){var a=this.canvas.div.clientWidth,g=this.canvas.div.clientHeight,b=Math.min(Math.max(40,Math.min(a/12,200)),Math.max(40,Math.min(g/12,200))),c=Math.max(5,b/3);TweenMax.set(this.bgDiv,{left:0,top:g-b,width:a,height:b});var g=.9*b,d=.88*b,e=.53*b,f=.6*b,h=a-
d-e-f-3.2*c;TweenMax.set(this.logoDiv,{left:c/2,top:0,height:b,width:g});TweenMax.set(this.nextDiv,{left:a-d-c,top:0,height:b,width:d});TweenMax.set(this.playDiv,{left:a-d-e-2*c,top:0,height:b,width:e});TweenMax.set(this.backDiv,{left:h,top:0,height:b,width:f});this.scrubberSize={left:g+c,width:h-g-2*c,height:b,barHeight:b/3};this.resizeScrubber();this.updateScrubberProgress()};a.prototype.resizeScrubber=function(){var a=this,g=this.scrubberSize,b=this.canvas.player,c=b.steps.length-1,d=b.timeline.duration(),
e=g.barHeight/2,f=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";b.steps.forEach(function(b,k){var h=a.divScrubberStep[c-k];h.style.left=(f*b.startTime/d).toString()+"px";h.style.width=(f*b.time/d+g.barHeight).toString()+
"px";h.style.height=g.barHeight+"px";h.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=e+"px";this.divScrubberHoverPoint.style.top=(g.barHeight/4-1).toString()+"px";this.divScrubberHoverPoint.style.borderRadius=e+"px";this.divScrubberHoverText.style.fontSize=.9*g.barHeight+"px";this.divScrubberProgress.style.height=g.barHeight+"px";this.divScrubberProgress.style.borderRadius=e+"px";this.updateScrubberProgress()};a.prototype.updateScrubberProgress=
function(){var a=this.scrubberSize;this.divScrubberProgress.style.width=((a.width-a.barHeight+2)*this.progress+a.barHeight).toString()+"px"};a.prototype.generateStyles=function(){var a=(new Date).getTime().toString();this.bgClass="controls-bg-"+a;this.btnClass="controls-btn-"+a;this.scrubberClass="scrubber-"+a;this.scrubberBarClass="scrubber-back-"+a;this.scrubberStepClass="scrubber-step-"+a;this.scrubberProgressClass="scrubber-progress-"+a;this.scrubberHoverPointClass="scrubber-point-"+a;this.scrubberHoverTextClass=
"scrubber-text-"+a;var a=c.getStyleElement("prostyle-track-controls-"+a),g={selectors:[]};g.selectors.push("."+this.bgClass);g["."+this.bgClass]={transition:"opacity 300ms ease-in-out, transform 300ms ease-in-out",backgroundColor:this.controller.backColor||this.BACK_COLOR,position:"absolute",display:"inline-block",opacity:0,transform:"translate3d(0, 0, 20px)"};g.selectors.push(".mouseMovement ."+this.bgClass);g[".mouseMovement ."+this.bgClass]={opacity:.3,transform:"translate3d(0, 0, 0)"};g.selectors.push("."+
this.bgClass+":hover");g["."+this.bgClass+":hover"]={opacity:1};g.selectors.push(".prostyle:hover + ."+this.bgClass);g[".prostyle:hover + ."+this.bgClass]={opacity:.5};g.selectors.push("."+this.bgClass+" div");g["."+this.bgClass+" div"]={position:"absolute"};g.selectors.push("."+this.btnClass);g["."+this.btnClass]={cursor:"pointer"};g.selectors.push("."+this.btnClass+" svg");g["."+this.btnClass+" svg"]={fill:this.controller.color||this.COLOR,width:"100%",height:"100%"};g.selectors.push("."+this.btnClass+
":hover svg");g["."+this.btnClass+":hover svg"]={fill:this.controller.highlightColor||this.HIGHLIGHT_COLOR};g.selectors.push("."+this.scrubberClass);g["."+this.scrubberClass]={cursor:"none"};g.selectors.push("."+this.scrubberBarClass);g["."+this.scrubberBarClass]={};g.selectors.push("."+this.scrubberStepClass);g["."+this.scrubberStepClass]={borderRight:"solid 2px "+(this.controller.backColor||this.BACK_COLOR),backgroundColor:this.controller.stepColor1||this.STEP_COLOR_1,background:"linear-gradient(to right, "+
(this.controller.stepColor1||this.STEP_COLOR_1)+", "+(this.controller.stepColor2||this.STEP_COLOR_2)+")"};g.selectors.push("."+this.scrubberProgressClass);g["."+this.scrubberProgressClass]={backgroundColor:this.controller.color||this.COLOR};g.selectors.push("."+this.scrubberClass+":hover ."+this.scrubberProgressClass);g["."+this.scrubberClass+":hover ."+this.scrubberProgressClass]={backgroundColor:this.controller.highlightColor||this.HIGHLIGHT_COLOR};g.selectors.push("."+this.scrubberHoverPointClass);
g["."+this.scrubberHoverPointClass]={border:"solid 1px "+(this.controller.backColor||this.BACK_COLOR),backgroundColor:this.controller.highlightColor||this.HIGHLIGHT_COLOR,display:"none"};g.selectors.push("."+this.scrubberClass+":hover ."+this.scrubberHoverPointClass);g["."+this.scrubberClass+":hover ."+this.scrubberHoverPointClass]={display:"block"};g.selectors.push("."+this.scrubberHoverTextClass);g["."+this.scrubberHoverTextClass]={color:this.controller.color||this.COLOR,fontFamily:"font-family: arial, helvetica, sans-serif",
display:"none"};g.selectors.push("."+this.scrubberClass+":hover ."+this.scrubberHoverTextClass);g["."+this.scrubberClass+":hover ."+this.scrubberHoverTextClass]={display:"block"};a.innerHTML=c.encodeStyleSheet(g)};a.prototype.addButton=function(a,g,b){var d=c.createChildDivElement(this.bgDiv,this.btnClass);d.className=this.btnClass;d.innerHTML=g;d.title=a;d.addEventListener("mousedown",function(a){b();a.preventDefault();a.stopPropagation();return!1});return d};return a}();d.TrackBar=a})(d.Track||
(d.Track={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a,c,d,e,f,h){void 0===a&&(a=!0);void 0===c&&(c=void 0);void 0===d&&(d=void 0);void 0===e&&(e=void 0);void 0===f&&(f=void 0);void 0===h&&(h=void 0);b.call(this,"track");this.autoHide=a;this.color=c;this.highlightColor=d;this.backColor=e;this.stepColor1=f;this.stepColor2=h;this.trackBar=this.player=this.canvas=void 0}__extends(a,b);a.prototype.start=function(a,b){this.stop();this.canvas=a;this.player=
b;this.trackBar=new d.TrackBar(a,b,this)};a.prototype.stop=function(){void 0!==this.player&&(this.player=this.canvas=this.trackBar=void 0)};a.prototype.resize=function(){void 0!==this.trackBar&&this.trackBar.resize()};a.prototype.serialize=function(){return d.serialize(this)};return a}(f.Controllers.Controller);d.TrackController=c})(d.Track||(d.Track={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.deserialize=function(c){return new d.TrackController(c.autoHide,c.color,c.highlightColor,
c.backColor,c.stepColor1,c.stepColor2)}})(d.Track||(d.Track={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.serialize=function(c){var b={};b.autoHide=c.autoHide;c.color&&(b.color=c.color);c.highlightColor&&(b.highlightColor=c.highlightColor);c.backColor&&(b.backColor=c.backColor);c.stepColor1&&(b.stepColor1=c.stepColor1);c.stepColor2&&(b.stepColor2=c.stepColor2);return b}})(d.Track||(d.Track={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a){b.call(this,
a.controllerType);this.originalJson=a}__extends(a,b);a.prototype.start=function(a,b){};a.prototype.stop=function(){};a.prototype.resize=function(){};a.prototype.serialize=function(){return d.serialize(this)};return a}(f.Controllers.Controller);d.UnknownController=c})(d.Unknown||(d.Unknown={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.deserialize=function(c){return new d.UnknownController(c)}})(d.Unknown||(d.Unknown={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.serialize=
function(c){return c.originalJson}})(d.Unknown||(d.Unknown={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a,c,d,e){b.call(this,a,"simple",c,e,d)}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.defaultPageClass||"simpleFlowPage"};a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a,b){return new d.SimpleFlowView(this,a,b)};return a}(f.Models.Flows.FlowModel);d.SimpleFlowModel=c})(d.Simple||
(d.Simple={}))})(e.Flows||(e.Flows={}))})(f.Extensions||(f.Extensions={}));(function(e){(function(d){var h=f.Util,c=function(b){function a(a,c,d){void 0===d&&(d=void 0);b.call(this,a,d||h.createChildDivElement(c.div,"prostyle prostyle-item"));this.model=a;this.itemViewSet=c}__extends(a,b);a.prototype.initializeItem=function(a,b){var c=b.getContainedSize(this.model.itemModelSet.flow.pageAspectRatio);this.initializeProperties(this.model.itemModelSet.flow.story,[this.element],c,a,this.model.init,!1)};
a.prototype.generateStepActions=function(a,b,c,d,e){this.generateActionsForStep(a,[this.element],b,c,d,e,this.model.scriptSet)};return a}(e.View);d.ItemView=c})(e.Items||(e.Items={}))})(f.Views||(f.Views={}));(function(e){e.logWarning=function(d,e){console.log("ProStyle Warning: "+d+" - "+e)}})(f.Util||(f.Util={}));(function(e){(function(d){(function(d){var c=function(){function b(a,g,b,c,d,e){this.label=a;this.jsonNames=g;this.cssName=b;this.text=c;this.defaultValue=d;this.alwaysInitializeCss=e;
void 0===d&&f.Util.logWarning("VariableType<T>",b+" has a default value of undefined.")}b.prototype.createVariable=function(){return new d.Variable(this)};b.prototype.scrubValue=function(a){return a};b.prototype.writeCssBuckets=function(a,g,b,c,d,e){var f=this;if(void 0!==this.cssName){var h=c.getValue(e);void 0!==h&&(e&&h===this.defaultValue&&!this.alwaysInitializeCss||d.forEach(function(c){f.writeCssBucket(a,g,b,c,h)}))}};b.prototype.writeCssBucket=function(a,g,b,c,d){c[this.cssName]=d};return b}();
...
c,d,e,f,h,p,l,q){b.call(this,a,c,d,l,h,q);this._minValue=e;this._maxNumber=f;this._decimalPlaces=p}__extends(a,b);a.prototype.scrubValue=function(a){a=f.Util.convertToNumber(a,this.defaultValue);var b=Math.pow(10,this._decimalPlaces);a=Math.round(a*b)/b;return a=Math.max(this._minValue,Math.min(a,this._maxNumber))};return a}(d.VariableType);d.NumberVariableType=c;c=function(b){function a(a,c,d,e,f,h,p,l,q){b.call(this,a,c,d,e,f,h,p,l,q)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){d[this.cssName]=
e/100*((c.height+c.width)/2)+1;"z"===this.cssName&&(d.zIndex=e+1)};return a}(d.NumberVariableType);d.ContainerDepthPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,p,l,q){b.call(this,a,c,d,e,f,h,p,l,q)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){a=e/100*c.height;0<e&&1>a&&(a=1);d[this.cssName]=a};return a}(d.NumberVariableType);d.ContainerHeightPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,p,l,q){b.call(this,a,c,d,e,f,h,p,l,q)}__extends(a,b);a.prototype.writeCssBucket=
...
"ease",["ease"],"ease","",c.Eaze.DEFAULT,!1)}__extends(b,a);b.prototype.scrubValue=function(a){if("string"===typeof a)return c.Eaze.getByText(a)};b.prototype.writeCssBucket=function(a,b,g,c,d){c[this.cssName]=d.ease};return b}(d.VariableType);d.EaseVariableType=b;b=function(a){function b(g,c,d,e,f,h,l,q,y,z,w){a.call(this,g,c,d,e,f,h,l,z,w);this.inverted=y;this.offset=q}__extends(b,a);b.prototype.writeCssBucket=function(a,b,g,c,d){d+=this.offset;this.inverted&&(d=-d);c[this.cssName]=d};return b}(d.NumberVariableType);
d.NumberOffsetVariableType=b;c=f.Types;b=function(a){function b(g,d){void 0===d&&(d=!1);a.call(this,g?"transform origin":"perspective origin",g?["transformOrigin","origin"]:["perspectiveOrigin","origin"],g?"transformOrigin":"perspectiveOrigin","",new c.Xyz(0,0,0),!1);this.transform=g;this.useContainer=d}__extends(b,a);b.prototype.scrubValue=function(a){return"boolean"==typeof a?this.defaultValue:"number"==typeof a?new c.Xyz(a):"string"==typeof a?this.scrubArray(a.split(" ")):a instanceof Array?this.scrubArray(a):
this.scrubArray([a.x,a.y,a.z])};b.prototype.scrubArray=function(a){var b=new c.Xyz(this.defaultValue.x,this.defaultValue.y,this.defaultValue.z);0<a.length&&(b.x=this.scrubString(a[0]));1<a.length&&(b.y=this.scrubString(a[1]));this.transform&&2<a.length&&(b.z=f.Util.convertToNumber(a[2],0,!0));return b};b.prototype.scrubString=function(a){a=(a||"").toString().trim().toLocaleLowerCase();return"left"===a?0:"right"===a?100:"top"===a?0:"bottom"===a?100:"center"===a?50:f.Util.convertToNumber(a,0,!0)};b.prototype.writeCssBuckets=
function(a,b,g,c,d,e){var f=this;a=c.getValue(e);if(void 0!==a&&(!e||!a.equals(this.defaultValue)||this.alwaysInitializeCss)){var h;h=this.useContainer?Math.round(a.x/100*g.width)+"px "+Math.round(a.y/100*g.height)+"px":Math.round(100*a.x)/100+50+"% "+(Math.round(100*a.y)/100+50)+"%";this.transform&&(h+=" "+Math.round((g.height+g.width)/2*a.z/100)+"px");d.forEach(function(a){a[f.cssName]=h})}};return b}(d.VariableType);d.OriginVariableType=b;b=function(a){function b(g,c,d,e,f,h,l){a.call(this,g,c,
d,e,f,h,0,"%",l)}__extends(b,a);b.prototype.writeCssBucket=function(a,b,g,c,d){c[this.cssName]=d/100};return b}(d.NumberVariableType);d.PercentVariableType=b})(d.Variables||(d.Variables={}))})(e.Properties||(e.Properties={}))})(f.Models||(f.Models={}));(function(e){e.getSign=function(d){return d?0>d?-1:1:0}})(f.Util||(f.Util={}));(function(e){var d=function(){function d(c,b,a,g,e,f){void 0===c&&(c=0);void 0===b&&(b=0);void 0===a&&(a=0);void 0===g&&(g="rgba(0,0,0,0.7)");void 0===e&&(e=0);void 0===
f&&(f=!1);this.x=c;this.y=b;this.blur=a;this.color=g;this.spread=e;this.inset=f}d.prototype.render=function(c,b,a){var g=(c+b)/2;c=Math.round(this.x/10*g)/10;b=Math.round(this.y/10*g)/10;var d=Math.round(this.blur/10*g)/10,g=Math.round(this.spread/10*g)/10;0===c&&0!==this.x&&(c=f.Util.getSign(this.x));0===b&&0!==this.y&&(b=f.Util.getSign(this.y));0===d&&0!==this.blur&&(d=f.Util.getSign(this.blur));0===g&&0!==this.spread&&(g=f.Util.getSign(this.spread));var d=Math.abs(d),e=[];a&&this.inset&&e.push("inset");
e.push(c.toString()+"px");e.push(b.toString()+"px");e.push(d.toString()+"px");a&&e.push(g.toString()+"px");"number"===typeof this.color?e.push("hsl("+Math.abs(this.color%360)+", 50%, 50%)"):e.push(this.color);return e.join(" ")};d.fromJson=function(c){c=c||[];if(!(c instanceof Array))return new d;var b=void 0,a=void 0,g=void 0,e=void 0,m=void 0,k=void 0;0<c.length&&void 0!==c[0]&&(b=f.Util.convertToNumber(c[0],0));1<c.length&&void 0!==c[1]&&(a=f.Util.convertToNumber(c[1],0));2<c.length&&void 0!==
c[2]&&(g=Math.max(0,f.Util.convertToNumber(c[2],0)));3<c.length&&void 0!==c[3]&&(e=c[3]);4<c.length&&void 0!==c[4]&&(m=f.Util.convertToNumber(c[4],0));5<c.length&&void 0!==c[5]&&(k=!!c[5]);return new d(b,a,g,e,m,k)};d.prototype.toJson=function(){var c=6;!0!==this.inset&&(c--,"rgba(0,0,0,0.5)"!==this.color&&(c--,0!==this.spread&&(c--,0!==this.blur&&c--)));var b=[];b.push(this.x);b.push(this.y);3<=c&&b.push(this.blur);4<=c&&b.push(this.spread);5<=c&&b.push(this.color.toString());6<=c&&b.push(!!this.inset);
return b};d.prototype.equals=function(c){return void 0===c||c.x!==this.x||c.y!==this.y||c.blur!==this.blur||c.color!==this.color||c.spread!==this.spread||c.inset!==this.inset?!1:!0};return d}();e.Shadow=d})(f.Types||(f.Types={}));(function(e){(function(d){(function(c){var b=function(a){function b(g,c){a.call(this,"shadow",["value"],g,"",[],!1);this.isBoxShadow=c}__extends(b,a);b.prototype.scrubValue=function(a){if(void 0===a||!(a instanceof Array)||0===a.length)return[];var b=[];a[0]instanceof Array?
a.forEach(function(a){b.push(f.Types.Shadow.fromJson(a))}):b.push(f.Types.Shadow.fromJson(a));return b};b.prototype.writeCssBucket=function(a,b,g,c,d){var e=this,f=[];d.forEach(function(a){f.push(a.render(g.width,g.height,e.isBoxShadow))});c[this.cssName]=0===f.length?"none":f.join(", ")};return b}(c.VariableType);c.ShadowVariableType=b;b=function(a){function b(){a.call(this,"align",["align"],"textAlign","inherit",["left","center","right","justify"],!1)}__extends(b,a);return b}(c.EnumVariableType);
c.TextAlignVariableType=b;b=function(a){function b(){a.call(this,"width",["width"],"width",0,Number.MAX_VALUE,Number.MAX_VALUE,2,"",!1)}__extends(b,a);b.prototype.writeCssBucket=function(a,b,g,c,d){d===Number.MAX_VALUE?c.clearProps="whiteSpace,width":(c.width=d/100*g.width,c.whiteSpace="normal")};return b}(c.NumberVariableType);c.TextWidthVariableType=b})(d.Variables||(d.Variables={}));var e=function(){function c(b,a,g){this.label=b;this.jsonNames=a;this.variableTypes=g}c.prototype.createPropertyFromArray=
function(b){f.Util.logWarning("PropertyType.createPropertyFromArray()","Abstract method called");return new d.Property(this)};c.prototype.createPropertyFromNumber=function(b){f.Util.logWarning("PropertyType.createPropertyFromNumber()","Abstract method called");return new d.Property(this)};c.prototype.createPropertyFromString=function(b){f.Util.logWarning("PropertyType.createPropertyFromString()","Abstract method called");return new d.Property(this)};c.prototype.createPropertyFromBoolean=function(b){var a=
new d.Property(this);!1===b&&this.variableTypes.forEach(function(b){a[b.jsonNames[0]].setValue(b.defaultValue)});return a};c.prototype.createPropertyFromObject=function(b){var a=new d.Property(this);if(void 0===b)return a;var g=f.Util.lowercaseProperties(b);this.variableTypes.forEach(function(b){for(var c=0;c<b.jsonNames.length;c++){var d=b.jsonNames[c];if(g.hasOwnProperty(d)){a[b.jsonNames[0]].setValue(g[d]);break}}});return a};c.prototype.renderLabel=function(b){f.Util.logWarning("PropertyType.renderLabel()",
...
[];b.createItems(this,a.items);a.steps.forEach(function(a,b){var g=[];k.items.forEach(function(a){a instanceof e.Items.SequencedItemView&&a.model.sequenceOnStepIndex===b&&g.push(a)});k.steps.push(new e.Step(a,f,m,b,g))})}__extends(b,c);b.createItems=function(a,b){b instanceof Array&&b.forEach(function(b){a.items.push(b.createView(a))})};b.prototype.generateStepsActions=function(a,b){var c=this;this.steps.forEach(function(d,e){d.startTime=(void 0===b?0:b.stopTime)+.01;b=d;0<e&&a.addLabel(d.startLabel,
d.startTime);var f=c.flow.camera.size,h=c.flow.camera.frame.canvas;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.canvasScriptSet);h=c.flow.camera.frame;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.frameScriptSet);h=c;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.pageScriptSet);var p=c.flow.camera.size.getContainedSize(c.model.flow.pageAspectRatio);c.items.forEach(function(b){b.generateStepActions(c,p,a,e,d.startLabel)});d.stopTime=a.duration();d.stopTime<
d.startTime&&(d.stopTime=d.startTime);a.addLabel(d.stopLabel,d.stopTime);d.time=d.stopTime-d.startTime});return b};return b}(e.View);e.PageView=h;(function(c){var b=f.Util,a=function(a){function c(d,f,n){var h=this;a.call(this,f.model,b.createChildDivElement(f.div,"prostyle prostyle-flow"));this.model=d;this.camera=f;this.flowIndex=n;this.pages=[];d.pages.forEach(function(a,b){h.pages.push(new e.PageView(a,h,n,b))})}__extends(c,a);c.prototype.initializePlacement=function(a){this.initializePerspective();
...
0;var q=h.renderCss(e);q.width=e.width;q.height=e.height;d.applyCss(a,f.div,b,1,q,Expo.easeOut)})};a.prototype.applyCss=function(a,b,c,d,e,f){"initialize"===c?a.set(b,e,c):(e.ease=f,a.to(b,d,e,c))};return a}(f.Views.Flows.FlowView);d.SimpleFlowView=c})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var g=a.setup||{},e=f.Types.Placement.fromJson(g.placement),m=c.convertToNumber(g.pageAspectRatio,b.frame.aspectRatio);return new d.SimpleFlowModel(b,
e,g.defaultPageClass,m)}})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(e){var c=function(b){function a(a,c,d,e){b.call(this,a,c,d,e);this.flowType="unknown"}__extends(a,b);a.prototype.serialize=function(){return e.serialize(this)};return a}(d.Simple.SimpleFlowModel);e.UnknownFlowModel=c})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(e){var c=
function(b){function a(a,c,d){b.call(this,a,c,d)}__extends(a,b);return a}(d.Simple.SimpleFlowView);e.UnknownFlowView=c})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var g=a.setup||{},e=f.Types.Placement.fromJson(g.placement),m=c.convertToNumber(g.pageAspectRatio,b.frame.aspectRatio);return new d.UnknownFlowModel(b,e,g.defaultPageClass,m)}})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){d.serialize=
...
d.TextWidthPropertyType=e;e=function(c){function b(a){var b=[];b.push(new d.Variables.OriginVariableType(!0,a));c.call(this,"transformOrigin",["transformorigin","origin"],b)}__extends(b,c);b.prototype.createProperty=function(a){var b=new d.Property(this);b.transformOrigin.setValue(a);return b};b.prototype.createPropertyFromBoolean=function(a){return this.createProperty(a)};b.prototype.createPropertyFromNumber=function(a){return this.createProperty(a)};b.prototype.createPropertyFromString=function(a){return this.createProperty(a)};
b.prototype.createPropertyFromArray=function(a){return this.createProperty(a)};b.prototype.renderLabel=function(a){return this.renderVariables(a,!1,!0)};return b}(d.PropertyType);d.TransformOriginPropertyType=e;e=function(){function c(){}c.ANCHOR=new d.AnchorPropertyType;c.ANIMATION=new d.AnimationPropertyType;c.BACKGROUND=new d.BackgroundPropertyType;c.BORDER=new d.BorderPropertyType;c.BULLET=new d.BulletsPropertyType;c.CLASS=new d.ClassPropertyType;c.CORNERS=new d.CornersPropertyType;c.CROP=new d.CropPropertyType;
c.CROP_SVG=new d.CropPropertyType(!0);c.FILL_SVG=new d.SvgFillPropertyType;c.FONT=new d.FontPropertyType;c.MOVE_TO=new d.MoveToPropertyType;c.OPACITY=new d.OpacityPropertyType;c.PADDING=new d.PaddingPropertyType;c.POSITION=new d.PositionPropertyType;c.ROTATION=new d.RotationPropertyType;c.SCALE=new d.ScalePropertyType;c.SIZE=new d.SizePropertyType;c.SKEW=new d.SkewPropertyType;c.SHADOW=new d.ShadowPropertyType;c.TEXT_ALIGN=new d.TextAlignPropertyType;c.TEXT_COLOR=new d.ColorPropertyType;c.TEXT_SHADOW=
new d.TextShadowPropertyType;c.TEXT_STYLE=new d.TextStylePropertyType;c.TEXT_WIDTH=new d.TextWidthPropertyType;c.TRANSFORM_ORIGIN=new d.TransformOriginPropertyType(!1);c.TRANSFORM_ORIGIN_CONTAINER=new d.TransformOriginPropertyType(!0);return c}();d.Cache=e})(e.Properties||(e.Properties={}))})(f.Models||(f.Models={}));(function(e){(function(d){(function(d){var c=function(b){function a(a,c,d,e,f,h){b.call(this,a,"image","Image",[f],[h]);this.src=c;this.width=d;this.height=e}__extends(a,b);a.prototype.serialize=
function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.ImageItemView(this,a)};return a}(f.Models.Items.ItemModel);d.ImageItemModel=c})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util,b=function(a){function b(d,e){a.call(this,d,e,c.createChildImageElement(e.div,"prostyle prostyle-item",d.itemModelSet.flow.story.canvas.adjustImageUrl(d.src),d.width,d.height));this.model=d}__extends(b,a);b.prototype.initializeItem=function(a,b){var c=
this.model,d=b.getContainedSize(c.itemModelSet.flow.pageAspectRatio),e={};void 0!==c.width&&(e.width=c.width.toString()+"%");void 0!==c.height&&(e.height=c.height.toString()+"%");this.initializeProperties(c.itemModelSet.flow.story,[this.element],d,a,c.init,!1,e)};return b}(f.Views.Items.ItemView);d.ImageItemView=b})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Models.Properties,b=function(){function a(){}a.get=function(){if(void 0===a._propertyTypes){var b=[];
b.push(c.Cache.ANCHOR);b.push(c.Cache.ANIMATION);b.push(c.Cache.CLASS);b.push(c.Cache.CORNERS);b.push(c.Cache.OPACITY);b.push(c.Cache.POSITION);b.push(c.Cache.ROTATION);b.push(c.Cache.SCALE);b.push(c.Cache.SHADOW);b.push(c.Cache.SKEW);b.push(c.Cache.TRANSFORM_ORIGIN);a._propertyTypes=b}return a._propertyTypes};a._propertyTypes=void 0;return a}();d.ImagePropertyTypes=b})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function b(){}b.read=
function(a,b){return"boolean"===typeof b?a.createPropertyFromBoolean(b):"number"===typeof b?a.createPropertyFromNumber(b):"string"===typeof b?a.createPropertyFromString(b):b instanceof Array?a.createPropertyFromArray(b):a.createPropertyFromObject(b)};return b}();e.PropertyReader=d;var h=f.Models.Properties,d=function(){function b(){}b.read=function(a,c,d,m,k,A){void 0===m&&(m=void 0);void 0===k&&(k=void 0);void 0===A&&(A=[]);c=c||{};var v=[];d.forEach(function(a){"class"===a.jsonNames[0]&&c.hasOwnProperty("class")&&
(a=e.PropertyReader.read(a,c["class"]).getVariable("name").getValue())&&(m=a.trim(),k={})});var p=void 0;m&&-1===A.indexOf(m)&&(A.push(m),k=(a.classes||{})[m]||k,void 0!==k&&(p=b.read(a,k,d,void 0,void 0,A)));var l=f.Util.lowercaseProperties(c);d.forEach(function(a){var b=void 0,c=void 0;void 0!==p&&(c=p.getPropertyOfType(a));for(var d=0;d<a.jsonNames.length;d++){var g=a.jsonNames[d];if(l.hasOwnProperty(g)){b=e.PropertyReader.read(a,l[g]);break}}void 0!==c&&(void 0===b&&(b=new h.Property(a)),a.variableTypes.forEach(function(a){var d=
b[a.jsonNames[0]];a=c[a.jsonNames[0]];if(void 0!==a){var e=a.getValue(!1);void 0===e&&(e=a.defaultValueOverride);void 0!==e&&(d.defaultValueOverride=e)}}));void 0!==b&&v.push(b)});return new h.PropertyList(d,v)};return b}();e.PropertyListReader=d;var c=f.Models.Scripts,d=function(){function b(){}b.read=function(a,b,d,f){var k=new c.ScriptSet(a,b,f);if(!(d instanceof Array))return k;d.forEach(function(a){k.scripts.push(e.ScriptReader.read(k,a))});return k};b.readJson=function(a,d,n,m,k){n=f.Util.lowercaseProperties(n);
for(var h=new c.ScriptSet(a,d,k),v=0;v<m.length;v++){var p=m[v];if(n[p+"scripts"]instanceof Array)return b.read(a,d,n[p+"scripts"],k);if(void 0!==n[p+"script"])h.scripts.push(e.ScriptReader.read(h,n[p+"script"]));else{var l=new c.StepEvent(h,0);if(n[p+"actions"]instanceof Array)l.actions=e.ActionReader.readArray(l,n[p+"actions"]);else if(void 0!==n[p+"action"])l.actions=e.ActionReader.readArray(l,[n[p+"action"]]);else continue;h.scripts.push(l)}return h}h=new c.ScriptSet(a,d,k);if(!(n instanceof Array))return h;
n.forEach(function(a){h.scripts.push(e.ScriptReader.read(h,a))});return h};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||"").trim(),n=c.getSetup(a,"width"),m=c.getSetup(a,"height"),n=isNaN(n)?void 0:Number(n),m=isNaN(m)?void 0:Number(m),k=d.ImagePropertyTypes.get(),A=f.Serialization.PropertyListReader.read(b.story,a.init,k),k=f.Serialization.ScriptSetReader.readJson(b,
"Image",a,[""],k);return new d.ImageItemModel(b,e,n,m,A,k)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a={};b.type.variableTypes.forEach(function(c){c=c.jsonNames[c.jsonNames.length-1];var d=b[c].getValue();void 0!==d&&(a[c]=d)});return a};return c}();e.PropertyWriter=d;d=function(){function c(){}
c.write=function(b){return{}};return c}();e.PropertyListWriter=d;var h=f.Models.Scripts.ScriptType,d=function(){function c(){}c.write=function(b){var a=b.type,d=void 0,d=a===h.InitEvent?c.writeInitEvent(b):a===h.StepEvent?c.writeStepEvent(b):a===h.SwitchEvent?c.writeSwitchEvent(b):a===h.ActionsOrphan?c.writeActionsOrphan(b):a===h.PropertyOrphan?c.writePropertyOrphan(b):{};d.type=h.toString(b.type);d.editor={};d.editor.x=b.x;d.editor.y=b.y;return d};c.writeInitEvent=function(b){var a={};e.PropertyWriter.writeSet(a,
b.properties);return a};c.writeStepEvent=function(b){var a={scriptType:"step"};0<b.stepIndex&&(a.scriptType+=b.stepIndex+1);a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeSwitchEvent=function(b){var a={};a.switch=b.switchName;a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeActionsOrphan=function(b){var a={};a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writePropertyOrphan=function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};return c}();
e.ScriptWriter=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){d.serialize=function(c){var b={};b.setup=b.setup||{};b.setup.src=c.src;c.width&&(b.setup.class=c.width);c.height&&(b.setup.class=c.height);b.init=f.Serialization.PropertyListWriter.write(c.init);b.scripts=f.Serialization.ScriptSetWriter.write(c.scriptSet);return b}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=function(b){function a(a,c,d){b.call(this,a,"layer","Layer",
[c],[d]);this.items=[];this.flow=a.flow;this.story=a.flow.story}__extends(a,b);a.prototype.getCountOfStepsUsed=function(){var a=1;this.scriptSets.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});this.items.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});return a};a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.LayerItemView(this,a)};return a}(f.Models.Items.ItemModel);d.LayerItemModel=c})(d.Layer||(d.Layer={}))})(e.Items||
(e.Items={}));(function(d){(function(d){var c=f.Util,b=function(a){function b(d,e){a.call(this,d,e,c.createChildDivElement(e.div,"prostyle prostyle-layer"));this.model=d;this.items=[];f.Views.PageView.createItems(this,d.items)}__extends(b,a);b.prototype.initializeItem=function(b,c){a.prototype.initializeItem.call(this,b,c);this.items.forEach(function(a){a.initializeItem(b,c)})};b.prototype.generateStepActions=function(b,c,d,e,g){var f=this;this.items.forEach(function(a){a.generateStepActions(f,c,
d,e,g)});a.prototype.generateStepActions.call(this,this,c,d,e,g)};return b}(f.Views.Items.ItemView);d.LayerItemView=b})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Models.Properties,b=function(){function a(){}a.get=function(){if(void 0===a._propertyTypes){var b=[];b.push(c.Cache.ANCHOR);b.push(c.Cache.ANIMATION);b.push(c.Cache.BACKGROUND);b.push(c.Cache.BORDER);b.push(c.Cache.CLASS);b.push(c.Cache.CORNERS);b.push(c.Cache.CROP);b.push(c.Cache.MOVE_TO);b.push(c.Cache.OPACITY);
b.push(c.Cache.POSITION);b.push(c.Cache.ROTATION);b.push(c.Cache.SCALE);b.push(c.Cache.SHADOW);b.push(c.Cache.SIZE);b.push(c.Cache.SKEW);b.push(c.Cache.TRANSFORM_ORIGIN);a._propertyTypes=b}return a._propertyTypes};a._propertyTypes=void 0;return a}();d.LayerPropertyTypes=b})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=f.Models,h=f.Models.Items,c=function(){function b(){}b.read=function(a,c){c=c||{};c.init=c.init||{};var f=d.CanvasPropertyTypes.get(),
m=d.FramePropertyTypes.get(),k=d.PagePropertyTypes.get(),h=e.PropertyListReader.read(a.story,c.init,k,a.getDefaultPageClassName(),a.getDefaultPageClassValue()),h=new d.PageModel(h,a);h.canvasScriptSet=e.ScriptSetReader.readJson(h,"Canvas",c,["canvas"],f);h.frameScriptSet=e.ScriptSetReader.readJson(h,"Frame",c,["frame"],m);h.pageScriptSet=e.ScriptSetReader.readJson(h,"Page",c,["page"],k);h.items=b.readItems(h,c);h.steps=b.readSteps(h,c,h.items);return h};b.readSteps=function(a,b,c){b=b.steps||[];var d=
[];b instanceof Array&&b.forEach(function(b){d.push(e.StepReader.read(a,b))});var f=1;c.forEach(function(a){f=Math.max(f,a.getCountOfStepsUsed());a instanceof h.SequencedItemModel&&(f=Math.max(f,a.sequenceOnStepIndex+1))});f=Math.max(f,a.canvasScriptSet.getCountOfStepsUsed());f=Math.max(f,a.frameScriptSet.getCountOfStepsUsed());f=Math.max(f,a.pageScriptSet.getCountOfStepsUsed());if(d.length<f)for(b=f-d.length,c=0;c<b;c++)d.push(e.StepReader.read(a,{}));return d};b.readItems=function(a,b){var c=b.items;
void 0===c&&void 0!==b.item&&(c=[b.item]);var c=c||[],d=[];c instanceof Array&&c.forEach(function(b){d.push(e.ItemReader.read(a,b))});return d};return b}();e.PageReader=c})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){d.deserialize=function(c,b){var a=d.LayerPropertyTypes.get(),e=f.Serialization.PropertyListReader.read(c.story,b.init,a),a=f.Serialization.ScriptSetReader.readJson(c,"Layer",b,[""],a),e=new d.LayerItemModel(c,e,a);e.items=f.Serialization.PageReader.readItems(e,
b);return e}})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={};b.init=f.Serialization.PropertyListWriter.write(c.init);b.scripts=f.Serialization.ScriptSetWriter.write(c.scriptSet);f.Serialization.PageWriter.writeItems(c,b);return b}})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=function(b){function a(a,c,d,e,f,h,p,l,q,y,z,w,r){b.call(this,a,"text","Text",[h,l,y,w],[p,q,z,r]);this.text=c;this.stackedLines=
d;this.stackedWords=e;this.stackedChars=f;this.linesInit=l;this.linesScriptSet=q;this.wordsInit=y;this.wordsScriptSet=z;this.charsInit=w;this.charsScriptSet=r}__extends(a,b);a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.TextItemView(this,a)};return a}(f.Models.Items.ItemModel);d.TextItemModel=c})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util,b=function(a){function b(d,e){a.call(this,d,e,c.createChildDivElement(e.div,
"prostyle prostyle-text"));this.model=d;this.splitText=void 0;this.chars=this.words=this.lines=!1;this.div.innerHTML=d.text;this.lines=d.stackedLines||0<d.linesScriptSet.scripts.length||d.linesInit.hasAnythingSet();this.words=d.stackedWords||0<d.wordsScriptSet.scripts.length||d.wordsInit.hasAnythingSet();this.chars=d.stackedChars||0<d.charsScriptSet.scripts.length||d.charsInit.hasAnythingSet();if(this.lines||this.words||this.chars){var f=[];this.lines&&f.push("lines");this.words&&f.push("words");
this.chars&&f.push("chars");f={type:f.join(",")};this.lines&&(f.linesClass=d.stackedLines?"prostyle-text-line-stacked":"prostyle-text-line");this.words&&(f.wordsClass=d.stackedWords?"prostyle-text-word-stacked":"prostyle-text-word");this.chars&&(f.charsClass=d.stackedChars?"prostyle-text-char-stacked":"prostyle-text-char");this.splitText=new window.SplitText(this.div,f)}}__extends(b,a);b.prototype.initializeItem=function(a,b){var c=this.model.itemModelSet.flow.story,d=b.getContainedSize(this.model.itemModelSet.flow.pageAspectRatio),
e=this.initializeProperties.bind(this);e(c,[this.div],d,a,this.model.init,!1);void 0!==this.splitText&&(this.lines&&e(c,this.splitText.lines,d,a,this.model.linesInit,!1),this.words&&e(c,this.splitText.words,d,a,this.model.wordsInit,!1),this.chars&&e(c,this.splitText.chars,d,a,this.model.charsInit,!1))};b.prototype.generateStepActions=function(a,b,c,d,e){var f=this.generateActionsForStep.bind(this);f(a,[this.div],b,c,d,e,this.model.scriptSet);void 0!==this.splitText&&(this.lines&&f(a,this.splitText.lines,
b,c,d,e,this.model.linesScriptSet),this.words&&f(a,this.splitText.words,b,c,d,e,this.model.wordsScriptSet),this.chars&&f(a,this.splitText.chars,b,c,d,e,this.model.charsScriptSet))};return b}(f.Views.Items.ItemView);d.TextItemView=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Models.Properties,b=function(){function a(){}a.cacheProperties=function(){a._propertyTypes=[];a._linePropertyTypes=[];a._wordPropertyTypes=[];a._charPropertyTypes=[];var b=[a._propertyTypes],
d=[a._linePropertyTypes],e=[a._propertyTypes,a._linePropertyTypes,a._wordPropertyTypes,a._charPropertyTypes],f=[a._linePropertyTypes,a._wordPropertyTypes,a._charPropertyTypes];a.addPropertyType(b,c.Cache.ANCHOR);a.addPropertyType(e,c.Cache.ANIMATION);a.addPropertyType(e,c.Cache.BACKGROUND);a.addPropertyType(e,c.Cache.BORDER);a.addPropertyType(d,c.Cache.BULLET);a.addPropertyType(e,c.Cache.CLASS);a.addPropertyType(e,c.Cache.CORNERS);a.addPropertyType(b,c.Cache.CROP);a.addPropertyType(b,c.Cache.FONT);
a.addPropertyType(e,c.Cache.OPACITY);a.addPropertyType(e,c.Cache.PADDING);a.addPropertyType(e,c.Cache.POSITION);a.addPropertyType(e,c.Cache.ROTATION);a.addPropertyType(e,c.Cache.SCALE);a.addPropertyType(e,c.Cache.SHADOW);a.addPropertyType(e,c.Cache.SKEW);a.addPropertyType(b,c.Cache.TEXT_ALIGN);a.addPropertyType(e,c.Cache.TEXT_COLOR);a.addPropertyType(e,c.Cache.TEXT_SHADOW);a.addPropertyType(e,c.Cache.TEXT_STYLE);a.addPropertyType(b,c.Cache.TEXT_WIDTH);a.addPropertyType(b,c.Cache.TRANSFORM_ORIGIN);
a.addPropertyType(f,c.Cache.TRANSFORM_ORIGIN_CONTAINER)};a.addPropertyType=function(a,b){a.forEach(function(a){a.push(b)})};a.get=function(){void 0===a._propertyTypes&&a.cacheProperties();return a._propertyTypes};a.getForLines=function(){void 0===a._linePropertyTypes&&a.cacheProperties();return a._linePropertyTypes};a.getForWords=function(){void 0===a._wordPropertyTypes&&a.cacheProperties();return a._wordPropertyTypes};a.getForChars=function(){void 0===a._charPropertyTypes&&a.cacheProperties();return a._charPropertyTypes};
a._propertyTypes=void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),n="";if(e instanceof Array){var m=[];e.forEach(function(a){m.push(a.toString())});n=m.join("<br>")}else n=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),k=!!c.getSetup(a,"stackedWords"),A=!!c.getSetup(a,"stackedChars"),
v=d.TextPropertyTypes.get(),p=d.TextPropertyTypes.getForLines(),l=d.TextPropertyTypes.getForWords(),q=d.TextPropertyTypes.getForChars(),y=f.Serialization.PropertyListReader.read(b.story,a.init,v),r=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,p),w=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,l),t=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,q),v=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],v),p=f.Serialization.ScriptSetReader.readJson(b,
"Lines",a,["line","lines"],p),l=f.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],l),q=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],q);return new d.TextItemModel(b,n,e,k,A,y,v,r,p,w,l,t,q)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&
...
return d}();e.CanvasPropertyTypes=d;(function(d){var c=function(b){function a(a,c,d,e,f,h){b.call(this,a,c,d,f,e);this.defaultPageClassIfNotGiven=h}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.defaultPageClass||this.defaultPageClassIfNotGiven};a.prototype.getDefaultPageClassValue=function(){return{background:"#FFF",corners:{topLeft:2,bottomRight:2,bottomLeft:2,topRight:2},shadow:[0,0,1.5,"rgba(0,0,0,0.5)",.1]}};return a}(d.FlowModel);d.PlacementFlowModel=c})(e.Flows||
(e.Flows={}));d=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(e.Properties.Cache.ANIMATION);c.push(e.Properties.Cache.BACKGROUND);c.push(e.Properties.Cache.BORDER);c.push(e.Properties.Cache.CORNERS);c.push(e.Properties.Cache.CROP);c.push(e.Properties.Cache.OPACITY);c.push(e.Properties.Cache.SCALE);c.push(e.Properties.Cache.SHADOW);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();e.FramePropertyTypes=d})(f.Models||(f.Models={}));
(function(e){var d=function(){function d(c,b,a,e,f){this.current=c;this.future=b;this.futureOffset=a;this.past=e;this.pastOffset=f}d.fromJson=function(c){c=c||{};c.future=c.future||{};c.past=c.past||{};return new d(e.Placement.fromJson(c.current),e.Placement.fromJson(c.future),e.Placement.fromJson(c.future.offset),e.Placement.fromJson(c.past),e.Placement.fromJson(c.past.offset))};return d}();e.Stacks=d})(f.Types||(f.Types={}));(function(e){(function(d){var c=function(b){function a(a,c,d,e,f,h){b.call(this,
a,c,d,[f],[h]);this.sequenceOnStepIndex=e}__extends(a,b);return a}(d.ItemModel);d.SequencedItemModel=c})(e.Items||(e.Items={}));var d=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(e.Properties.Cache.ANIMATION);c.push(e.Properties.Cache.BACKGROUND);c.push(e.Properties.Cache.BORDER);c.push(e.Properties.Cache.CORNERS);c.push(e.Properties.Cache.CROP);c.push(e.Properties.Cache.FONT);c.push(e.Properties.Cache.OPACITY);c.push(new e.Properties.FontPropertyType(!0));
c.push(e.Properties.Cache.SHADOW);c.push(e.Properties.Cache.TEXT_COLOR);c.push(e.Properties.Cache.TEXT_SHADOW);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();e.PagePropertyTypes=d;(function(d){(function(c){var b=function(){function a(a){this.type=a}a.prototype.getValue=function(a){void 0===a&&(a=!1);return a?void 0!==this._value?this._value:void 0!==this.defaultValueOverride?this.defaultValueOverride:this.type.defaultValue:this._value};a.prototype.setValue=function(a){this._value=
void 0===a?void 0:this.type.scrubValue(a)};a.prototype.render=function(a,b){var c=this.getValue();if(void 0!==c){var d=[];a&&(d.push(this.type.label),d.push(": "));d.push(c.toString());b&&d.push(this.type.text);return d.join("")}};return a}();c.Variable=b})(d.Variables||(d.Variables={}))})(e.Properties||(e.Properties={}));(function(d){var c=function(b){function a(a){b.call(this,a,d.ScriptType.ActionsOrphan);this.scriptSet=a;this.actions=[]}__extends(a,b);return a}(d.ActionsScript);d.ActionsOrphan=
c;c=function(b){function a(a,c){b.call(this,a,c);this.properties=[]}__extends(a,b);return a}(d.Script);d.PropertiesScript=c;c=function(b){function a(a){b.call(this,a,d.ScriptType.InitEvent);this.scriptSet=a}__extends(a,b);return a}(d.PropertiesScript);d.InitEvent=c;c=function(b){function a(a){b.call(this,a,d.ScriptType.PropertyOrphan);this.scriptSet=a}__extends(a,b);return a}(d.PropertiesScript);d.PropertyOrphan=c;c=function(b){function a(a,c){b.call(this,a,d.ScriptType.StepEvent);this.stepIndex=
c}__extends(a,b);return a}(d.ActionsScript);d.StepEvent=c;c=function(b){function a(a,c){b.call(this,a,d.ScriptType.SwitchEvent);this.switchName=c}__extends(a,b);return a}(d.ActionsScript);d.SwitchEvent=c})(e.Scripts||(e.Scripts={}));d=function(){return function(d){void 0===d&&(d=void 0);this.autoAdvanceDelay=d;this.stopLabel=this.startLabel="";this.time=0}}();e.Step=d})(f.Models||(f.Models={}));(function(e){var d=f.Util,h=function(){function c(b,a){this.canvas=b;this.config=a;void 0!==a&&!1!==a&&
(this.player=b.player,"object"!==typeof a&&(a=this.getDefaultConfig()),this.listenForKeyPresses(a))}c.prototype.getDefaultConfig=function(){return{play:[13,116],pause:[19,27],togglePlay:[32],back:[8,33,37,38,188],playNext:[34,39,40,9],start:[36,190],end:[35]}};c.prototype.listenForKeyPresses=function(b){var a={},c;c=0+this.mapKeys(a,b.end,this.end.bind(this));c+=this.mapKeys(a,b.start,this.start.bind(this));c+=this.mapKeys(a,b.back,this.back.bind(this));c+=this.mapKeys(a,b.pause,this.pause.bind(this));
c+=this.mapKeys(a,b.play,this.play.bind(this));c+=this.mapKeys(a,b.togglePlay,this.togglePlay.bind(this));c+=this.mapKeys(a,b.playNext,this.playNext.bind(this));0!==c&&(document.addEventListener("keydown",function(b){if(!b.ctrlKey){var c=b.keyCode;(a[c]instanceof Function||9===c)&&b.preventDefault()}},!1),document.addEventListener("keyup",function(b){if(!b.ctrlKey){var c=b.keyCode,d=a[c];if(d instanceof Function||9===c)d instanceof Function&&d(),b.preventDefault()}},!1))};c.prototype.mapKeys=function(b,
a,c){var e=0;a instanceof Array&&a.forEach(function(a){a=d.convertToNumber(a);0<a&&(b[a]=c,e++)});return e};c.prototype.play=function(){this.player.playCurrentStep()};c.prototype.pause=function(){this.player.pause()};c.prototype.togglePlay=function(){this.player.togglePlay()};c.prototype.back=function(){this.player.backStep(!0)};c.prototype.playNext=function(){this.player.playNextStep(!0)};c.prototype.start=function(){this.player.seekStep(this.player.steps[0],!1)};c.prototype.end=function(){this.player.seekStep(this.player.steps[0],
!1);this.player.backStep(!1)};return c}();e.KeyboardPlay=h})(f.Play||(f.Play={}));(function(e){var d=f.Models.Actions,h=f.Util,c=function(){function a(){}a.readArray=function(b,c){var d=[];c instanceof Array&&c.forEach(function(c){d.push(a.read(b,c))});return d};a.read=function(b,c){c=c||{};d.ActionType.fromString(c.actionType);return a.readPropertiesAction(b,c)};a.readPropertiesAction=function(a,b){var c=e.PropertyListReader.read(a.scriptSet.itemModelSet.story,b,a.scriptSet.itemProperties).properties;
return new d.SetPropertiesAction(a,h.convertToNumber(b.delay),c)};return a}();e.ActionReader=c;d=f.Models.Actions;c=function(){function a(){}a.writeArray=function(a){var b=[];a.forEach(function(a){b.push(a.saveJson())});return b};a.write=function(b){return a.writePropertiesAction(b)};a.writePropertiesAction=function(a){var b={actionType:d.ActionType.toString(a.actionType)};e.PropertyWriter.writeSet(b,a.properties);a.delay&&(b.delay=a.delay);return b};return a}();e.ActionWriter=c;c=function(){function a(){}
a.read=function(a){a=a||{};a.init=a.init||{};a.init.crop=void 0===a.init.crop?!0:a.init.crop;var b=e.PropertyListReader.read(void 0,a.init,f.Models.CanvasPropertyTypes.get()),c=Math.max(0,Math.min(f.Util.convertToNumber(f.Util.getSetup(a,"padding"),0),50));return new f.Models.CanvasModel(b,c,f.Util.getSetup(a,"imageRootUrl"))};return a}();e.CanvasReader=c;c=function(){function a(){}a.write=function(a){var b={setup:{}};b.setup.padding=a.padding;return b};return a}();e.CanvasWriter=c;c=function(){function a(){}
a.read=function(b){var c=(b.controllerType||"auto").trim().toLowerCase(),d=a.lookupExtension(c);d&&d.deserialize?b=d.deserialize(b):(f.Util.logError("ControllerReader.read()","Unknown Controller Type ("+c+")"),b=f.Extensions.Controllers.Unknown.deserialize(b));return b};a.lookupExtension=function(a){for(var b in f.Extensions.Controllers){var c=b.toLowerCase();if(a===c)return f.Extensions.Controllers[b]}};return a}();e.ControllerReader=c;c=function(){function a(){}a.write=function(a){var b=a.serialize();
b.flowType=a.flowType;b.pages=[];a.pages.forEach(function(a){b.pages.push(e.PageWriter.write(a))});return b};return a}();e.FlowWriter=c;c=function(){function a(){}a.read=function(b){b=b||{};b.init=b.init||{};var c=e.PropertyListReader.read(void 0,b.init,f.Models.FramePropertyTypes.get()),d=f.Util.convertToNumber(f.Util.getSetup(b,"aspectRatio")||a.DEFAULT_ASPECT_RATIO,a.DEFAULT_ASPECT_RATIO);b=Math.max(0,Math.min(f.Util.convertToNumber(f.Util.getSetup(b,"padding"),0),50));return new f.Models.FrameModel(c,
d,b)};a.DEFAULT_ASPECT_RATIO=16/9;return a}();e.FrameReader=c;c=function(){function a(){}a.write=function(a){var b={setup:{}};b.setup.aspectRatio=a.aspectRatio;b.setup.padding=a.padding;return b};return a}();e.FrameWriter=c;c=function(){function a(){}a.write=function(a){var b,c=f.Extensions.Items[a.itemType];c&&c.serialize?b=c.serialize(a):(f.Util.logError("ItemWriter.write()","Unknown Item Type ("+b.itemType+")"),b={});b.itemType=a.itemType;b.scripts=e.ScriptSetWriter.write(a.scriptSet);return b};
return a}();e.ItemWriter=c;c=function(){function a(){}a.write=function(b){var c={steps:[]};b.steps.forEach(function(a){c.steps.push(e.StepWriter.write(a))});c.items=[];a.writeItems(b,c);return c};a.writeItems=function(a,b){a.items.forEach(function(a){b.items.push(e.ItemWriter.write(a))})};return a}();e.PageWriter=c;var b=f.Models.Scripts,a=f.Models.Scripts.ScriptType,h=f.Util,c=function(){function c(){}c.read=function(b,d){d=d||{};d.scriptType=d.scriptType||a.toString(a.StepEvent);var e=a.fromString(d.scriptType),
f=void 0,f=e===a.StepEvent?c.readStepEvent(b,d):e===a.SwitchEvent?c.readSwitchEvent(b,d):e===a.ActionsOrphan?c.readActionsOrphan(b,d):e===a.PropertyOrphan?c.readPropertyOrphan(b,d):c.readInitEvent(b,d);d.editor=d.editor||{};f.x=h.convertToNumber(d.editor.x);f.y=h.convertToNumber(d.editor.y);return f};c.readInitEvent=function(a,c){var d=new b.InitEvent(a);d.properties=e.PropertyListReader.read(a.itemModelSet.story,c,a.itemProperties).properties;return d};c.readStepEvent=function(a,c){var d=c.scriptType.slice(4),
d=Math.max(0,h.convertToNumber(d,1)-1),d=new b.StepEvent(a,d),f=void 0;void 0!==c.actions?f=c.actions:void 0!==c.action&&(f=[c.action]);d.actions=e.ActionReader.readArray(d,f);return d};c.readSwitchEvent=function(a,c){var d=new b.SwitchEvent(a,c.switch||"");d.actions=e.ActionReader.readArray(d,c.actions);return d};c.readActionsOrphan=function(a,c){var d=new b.ActionsOrphan(a);d.actions=e.ActionReader.readArray(d,c.actions);return d};c.readPropertyOrphan=function(a,c){var d=new b.PropertyOrphan(a);
d.properties=e.PropertyListReader.read(a.itemModelSet.story,c,a.itemProperties).properties;return d};return c}();e.ScriptReader=c;c=function(){function a(){}a.write=function(a){var b=[];a.scripts.forEach(function(a){b.push(e.ScriptWriter.write(a))});return b};return a}();e.ScriptSetWriter=c;var g=f.Models,c=function(){function a(){}a.read=function(a,b){return new g.Step(b.autoAdvanceDelay)};return a}();e.StepReader=c;c=function(){function a(){}a.write=function(a){var b={};void 0!==a.autoAdvanceDelay&&
(b.autoAdvanceDelay=a.autoAdvanceDelay);return b};return a}();e.StepWriter=c;g=f.Models;c=function(){function a(){}a.read=function(a){a=a||{};var b=e.CanvasReader.read(a.canvas||{}),c=e.FrameReader.read(a.frame||{}),d=[],h=[],n=new g.Story(b,c,d,a.classes,h,!1);a.flows instanceof Array?a.flows.forEach(function(a){d.push(e.FlowReader.read(n,a))}):void 0!==a.flow?d.push(e.FlowReader.read(n,a.flow)):a.pages instanceof Array?d.push(e.FlowReader.read(n,{pages:a.pages})):void 0!==a.page?d.push(e.FlowReader.read(n,
{pages:[a.page]})):a.items instanceof Array?d.push(e.FlowReader.read(n,{pages:[{items:a.items}]})):void 0!==a.item&&d.push(e.FlowReader.read(n,{pages:[{items:[a.item]}]}));0===d.length&&d.push(e.FlowReader.read(n,{}));a.controllers instanceof Array?a.controllers.forEach(function(a){h.push(e.ControllerReader.read(a))}):void 0!==a.controller?h.push(e.ControllerReader.read(a.controller)):f.defaultControllers instanceof Array&&(n.usingDefaultControllers=!0,f.defaultControllers.forEach(function(a){h.push(e.ControllerReader.read(a))}));
return n};return a}();e.StoryReader=c;c=function(){function a(){}a.write=function(a){var b={};b.canvas=e.CanvasWriter.write(a.canvas);b.frame=e.FrameWriter.write(a.frame);b.flows=[];a.flows.forEach(function(a){b.flows.push(e.FlowWriter.write(a))});return b};a.stringify=function(b){return JSON.stringify(a.write(b))};return a}();e.StoryWriter=c})(f.Serialization||(f.Serialization={}));(function(e){e.autoButton=function(b,a,c,d){void 0===c&&(c=1E3);void 0===d&&(d=2);var e,f=c,h=function(){a(!1);e=setTimeout(h,
f);f/=d},v=function(){void 0!==e&&(clearTimeout(e),e=void 0,a(!0))};b.onmousedown=function(){f=c;h()};b.onmouseup=function(){v()};b.onmouseout=function(){v()}};e.checkBrowserSupport=function(){var b=document.body;return b.classList&&b.dataset&&null!==e.prefixCssStyleIfNeeded("perspective")};e.configureMetaViewport=function(){var b=e.querySelector("meta[name='viewport']")||document.createElement("meta");b.content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no";b.parentNode!==
document.head&&(b.name="viewport",document.head.appendChild(b))};e.contentLoaded=function(b,a){var c=!1,d=!0,e=b.document,f=e.documentElement,h=e.addEventListener,v=h?"addEventListener":"attachEvent",p=h?"removeEventListener":"detachEvent",l=h?"":"on",q=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==d.type?b:e)[p](l+d.type,q,!1),!c&&(c=!0)&&a.call(b,d.type||d)},r=function(){try{f.doScroll("left")}catch(a){setTimeout(r,50);return}q("poll")};if("complete"==e.readyState)a.call(b,
"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(t){}d&&r()}e[v](l+"DOMContentLoaded",q,!1);e[v](l+"readystatechange",q,!1);b[v](l+"load",q,!1)}};e.createChildImageElement=function(b,a,c,d,e){void 0===d&&(d=void 0);void 0===e&&(e=void 0);var f=document.createElement("img");f.setAttribute("class",a);f.setAttribute("src",c);void 0===d&&void 0===e&&(e=100);void 0!==d&&f.setAttribute("width",d.toString()+"%");void 0!==e&&f.setAttribute("height",e.toString()+"%");b.appendChild(f);return f};
e.createStyleElement=function(b){var a=document.createElement("style");a.type="text/css";a.id=b;e.querySelector("head").appendChild(a);return a};e.createSvgElement=function(b,a,c){b=document.createElementNS("http://www.w3.org/2000/svg",b);for(var d in a)b.setAttribute(d,a[d]);c&&c.appendChild(b);return b};var d=document.createElement("dummy").style,f=["Webkit","Moz","O","ms","Khtml"],c={};e.prefixCssStyleIfNeeded=function(b){if("undefined"===typeof c[b]){var a=b.charAt(0).toUpperCase()+b.substr(1),
a=(b+" "+f.join(a+" ")+a).split(" ");c[b]=null;for(var e in a)if(void 0!==d[a[e]]){c[b]=a[e];break}}return c[b]};d=document.createElement("dummy").style;e.encodeStyle=function(b,a){d.cssText="";b=e.prefixCssStyleIfNeeded(b);d[b]=a;return d.cssText};d=document.createElement("dummy").style;e.encodeStyles=function(b){d.cssText="";var a,c;for(a in b)b.hasOwnProperty(a)&&(c=e.prefixCssStyleIfNeeded(a),null!==c&&(d[c]=b[a]));return d.cssText};d=document.createElement("dummy").style;e.encodeStyleSheet=function(b){var a=
[];b.selectors.forEach(function(c){b.hasOwnProperty(c)&&("string"===typeof b[c]?a.push(c+" { "+b[c]+" }\n"):a.push(c+" { "+e.encodeStyles(b[c])+" }\n"))});return a.join("")};e.getElementText=function(b){return b[document.body.textContent?"textContent":"innerText"]};e.lowercaseProperties=function(b){var a={},c;for(c in b)b.hasOwnProperty(c)&&(a[c.toString().trim().toLowerCase()]=b[c]);return a};e.getSetup=function(b,a){if(void 0!==b){a=a.toLowerCase();b=e.lowercaseProperties(b);var c=b.setup;return void 0!==
c&&(c=e.lowercaseProperties(c),void 0!==c[a])?c[a]:b[a]}};e.getGSTransform=function(b){var a={x:0,y:0,z:0,xPercent:0,yPercent:0,rotationX:0,rotationY:0,rotation:0,scaleX:1,scaleY:1,skewX:0};b&&(b=b._gsTransform)&&(void 0!==b.x&&(a.x=b.x),void 0!==b.y&&(a.y=b.y),void 0!==b.z&&(a.z=b.z),void 0!==b.xPercent&&(a.xPercent=b.xPercent),void 0!==b.yPercent&&(a.yPercent=b.yPercent),void 0!==b.rotationX&&(a.rotationX=b.rotationX),void 0!==b.rotationY&&(a.rotationY=b.rotationY),void 0!==b.rotation&&(a.rotation=
b.rotation),void 0!==b.scaleX&&(a.scaleX=b.scaleX),void 0!==b.scaleY&&(a.scaleY=b.scaleY),void 0!==b.skewX&&(a.skewX=b.skewX));return a};e.getStyleElement=function(b){return e.querySelector("#"+b)||e.createStyleElement(b)};e.insertIntoArray=function(b,a,c){b.splice(a,0,c)};e.logStepValues=function(b,a,c,d,e){var f=[];f.push("f");f.push(b.toString());f.push("p");f.push(a.toString());f.push("i");f.push(c.toString());f.push("s");f.push(d.toString());f.push(" ");f.push(JSON.stringify(e));console.log(f.join(""))};
e.makeArray=function(b){return[].slice.call(b)};e.querySelectorAll=function(b,a){void 0===a&&(a=document);try{return e.makeArray(a.querySelectorAll(b))}catch(c){e.logError("Util.querySelector",c.message)}};e.svgAddClass=function(b,a){e.svgRemoveClass(b,a);var c=b.getAttribute("class")||"",c=c+(0===c.length?"":" ")+a;b.setAttribute("class",c)};e.svgGetBounds=function(b){try{var a=b.getBBox()}catch(c){console.error(c)}0===a.width&&e.logWarning("svgGetBounds","getBBox returned an empty rect");return a};
e.svgRemoveClass=function(b,a){var c=b.getAttribute("class")||"",c=c.replace(new RegExp("\\s?"+a),"");b.setAttribute("class",c)};e.createChildSvgElement=function(b,a,c){void 0===c&&(c=void 0);a=document.createElementNS("http://www.w3.org/2000/svg",a);for(var d in c)a.setAttribute(d,c[d]);b.appendChild(a);return a}})(f.Util||(f.Util={}));(function(e){(function(c){var b=f.Util,a=f.Models.Properties,d=function(){function c(){}c.generateTimeline=function(b,d,f,g,h,l,q){void 0===q&&(q=void 0);var r=c.getMoveTo(g.properties,
b.items),t=[];for(b=0;b<f.length;b++)t.push({force3D:!0,immediateRender:!1,delay:g.delay,element:f[b],elementIndex:b});var w=0,u=0,x=g.script.scriptSet.itemModelSet.flow.story;g.properties.forEach(function(b){b.type instanceof a.AnimationPropertyType?(u=b.duration.getValue()||0,w=b.stagger.getValue()||0,0<u&&b.writeCssBuckets(x,d.model,l,t,!1)):void 0!==r&&(b.type instanceof a.MoveToPropertyType||b.type instanceof a.PositionPropertyType||b.type instanceof a.RotationPropertyType||b.type instanceof
a.ScalePropertyType||b.type instanceof a.SkewPropertyType)||b.writeCssBuckets(x,d.model,l,t,!1)});e.View.postProcessCssBuckets(t,q,g.properties,l);g=h.totalDuration();for(b=0;b<f.length;b++)0<u?h.to(f[b],u,t[b],g):h.set(f[b],t[b],g),g+=w;return r};c.getMoveTo=function(b,c){var d=void 0;b.forEach(function(b){b.type instanceof a.MoveToPropertyType&&(d=b.getVariable("item").getValue(),void 0!==d&&(0>d||d>c.length)&&(d=void 0))});return d};c.generateMoveTo=function(a,c,d){if(c){var e=b.getGSTransform(c),
f=[];(e.x||e.y||e.z)&&f.push("translate3d("+-e.x+"px,"+-e.y+"px,"+-e.z+"px)");e.rotationX&&f.push("rotateX("+-e.rotationX+"deg)");e.rotationY&&f.push("rotateY("+-e.rotationY+"deg)");e.rotation&&f.push("rotate("+-e.rotation+"deg)");var g=Math.max(0,Math.min(0===e.scaleX?1:1/e.scaleX,10)),h=Math.max(0,Math.min(0===e.scaleY?1:1/e.scaleY,10));1!==e.scaleX&&f.push("scaleX("+g+")");1!==e.scaleY&&f.push("scaleY("+h+")");e.skewX&&f.push("skewX("+-e.skewX+"deg)");console.log(f.join(" "));console.log(c._gsTransform);
c={transform:f.join(" "),xPercent:-50,yPercent:-50};d.to(a,1.2,c)}};return c}();c.SetPropertiesAction=d})(e.Actions||(e.Actions={}));(function(c){var b=function(a){function b(c,d,e){a.call(this,c,d,e);this.model=c}__extends(b,a);return b}(c.FlowView);c.PlacementFlowView=b})(e.Flows||(e.Flows={}));var d=function(){function c(b,a,c,d,e){this.step=b;this.flowIndex=a;this.pageIndex=c;this.stepIndex=d;this.sequencedItems=e;this.playerStepIndex=this.time=0;this.label=a.toString()+"-"+c.toString()+"-"+d.toString()+
...
function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,r=b.size,t=b.camera,p=t.size,l={fontFamily:"arial"};e.fullScreen||(l.height=f.height);e.initializeProperties(d,[e.div],p,this.timeline,d.canvas.init,!1,l);l={width:r.width,height:r.height};b.initializeProperties(d,[b.div],
p,this.timeline,d.frame.init,!1,l);t.flows.forEach(function(a){var e=p.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var q=void 0;t.flows.forEach(function(a){q=a.generateStepsActions(c.timeline,q)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.defaultControllers=[{controllerType:"auto"},
{controllerType:"resize"}];f.reload=B;f.bootstrap=t;t()})(ProStyle||(ProStyle={}));
