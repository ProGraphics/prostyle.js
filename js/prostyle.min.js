...
this.element=b;this.div=void 0;if(b instanceof HTMLDivElement||b instanceof HTMLBodyElement)this.div=b;b.proCache={}}a.prototype.initializeProperties=function(g,b,p,d,e,h,f,l){var n=this;void 0===f&&(f=void 0);void 0===l&&(l=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var z=[];for(f=0;f<b.length;f++){var A={force3D:!0,element:b[f],elementIndex:f};h&&(A.xPercent=-50,A.yPercent=-50);z.push(A)}var x=[];e.properties.forEach(function(a){x["prostyle_"+a.type.jsonNames[0]]=a});
e.propertyTypes.forEach(function(a){var b=x["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));b.writeCssBuckets(g,n,p,z,!0)});a.postProcessCssBuckets(z,l,e.properties,p);for(f=0;f<b.length;f++)d.set(b[f],z[f],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,k,h,f,m){var l=this;void 0===m&&(m=void 0);var n=new TimelineMax;k.actions.forEach(function(k){if(k.actionType===d.Actions.ActionType.SetProperties){var A=n.totalDuration(),x=e.Actions.SetPropertiesAction.generateTimeline(a,
l,b,k,n,c,m);void 0!==x&&(k=n.totalDuration(),(x=0<x?a.items[x-1].div:void 0)&&h.seek(f+"+="+k),k=new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,x,k),n.add(k,A))}});h.add(n,f)};a.prototype.generateActionsForStep=function(a,b,c,d,e,f,m,l){var n=this;void 0===l&&(l=void 0);m.scripts.forEach(function(m){m.type===h.ScriptType.StepEvent&&m.stepIndex===e&&n.generateEventTimeline(a,b,c,m,d,f,l)})};a.postProcessCssBuckets=function(a,b,c,d){for(var e=0;e<a.length;e++){var h=a[e],f=h.element.proCache;
...
g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";b.steps.forEach(function(b,k){var h=a.divScrubberStep[c-k];h.style.left=(f*b.startTime/d).toString()+"px";h.style.width=(f*b.time/d+g.barHeight).toString()+"px";h.style.height=g.barHeight+"px";h.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=
...
c,d,e,f,h,m,l,n){b.call(this,a,c,d,l,h,n);this._minValue=e;this._maxNumber=f;this._decimalPlaces=m}__extends(a,b);a.prototype.scrubValue=function(a){a=f.Util.convertToNumber(a,this.defaultValue);var b=Math.pow(10,this._decimalPlaces);a=Math.round(a*b)/b;return a=Math.max(this._minValue,Math.min(a,this._maxNumber))};return a}(d.VariableType);d.NumberVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,l,n){b.call(this,a,c,d,e,f,h,m,l,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){d[this.cssName]=
e/100*((c.height+c.width)/2)+1;"z"===this.cssName&&(d.zIndex=e+1)};return a}(d.NumberVariableType);d.ContainerDepthPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,l,n){b.call(this,a,c,d,e,f,h,m,l,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){a=e/100*c.height;0<e&&1>a&&(a=1);d[this.cssName]=a};return a}(d.NumberVariableType);d.ContainerHeightPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,l,n){b.call(this,a,c,d,e,f,h,m,l,n)}__extends(a,b);a.prototype.writeCssBucket=
...
p&&(p=void 0);void 0===k&&(k=void 0);void 0===u&&(u=[]);c=c||{};var w=[];d.forEach(function(a){"class"===a.jsonNames[0]&&c.hasOwnProperty("class")&&(a=e.PropertyReader.read(a,c["class"]).getVariable("name").getValue())&&(p=a.trim(),k={})});var m=void 0;p&&-1===u.indexOf(p)&&(u.push(p),k=(a.classes||{})[p]||k,void 0!==k&&(m=b.read(a,k,d,void 0,void 0,u)));var l=f.Util.lowercaseProperties(c);d.forEach(function(a){var b=void 0,c=void 0;void 0!==m&&(c=m.getPropertyOfType(a));for(var d=0;d<a.jsonNames.length;d++){var g=
a.jsonNames[d];if(l.hasOwnProperty(g)){b=e.PropertyReader.read(a,l[g]);break}}void 0!==c&&(void 0===b&&(b=new h.Property(a)),a.variableTypes.forEach(function(a){var d=b[a.jsonNames[0]];a=c[a.jsonNames[0]];if(void 0!==a){var e=a.getValue(!1);void 0===e&&(e=a.defaultValueOverride);void 0!==e&&(d.defaultValueOverride=e)}}));void 0!==b&&w.push(b)});return new h.PropertyList(d,w)};return b}();e.PropertyListReader=d;var c=f.Models.Scripts,d=function(){function b(){}b.read=function(a,b,d,f){var k=new c.ScriptSet(a,
b,f);if(!(d instanceof Array))return k;d.forEach(function(a){k.scripts.push(e.ScriptReader.read(k,a))});return k};b.readJson=function(a,d,h,p,k){h=f.Util.lowercaseProperties(h);for(var u=new c.ScriptSet(a,d,k),w=0;w<p.length;w++){var m=p[w];if(h[m+"scripts"]instanceof Array)return b.read(a,d,h[m+"scripts"],k);if(void 0!==h[m+"script"])u.scripts.push(e.ScriptReader.read(u,h[m+"script"]));else{var l=new c.StepEvent(u,0);if(h[m+"actions"]instanceof Array)l.actions=e.ActionReader.readArray(l,h[m+"actions"]);
else if(void 0!==h[m+"action"])l.actions=e.ActionReader.readArray(l,[h[m+"action"]]);else continue;u.scripts.push(l)}return u}u=new c.ScriptSet(a,d,k);if(!(h instanceof Array))return u;h.forEach(function(a){u.scripts.push(e.ScriptReader.read(u,a))});return u};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||"").trim(),t=c.getSetup(a,"width"),p=c.getSetup(a,"height"),
t=isNaN(t)?void 0:Number(t),p=isNaN(p)?void 0:Number(p),k=d.ImagePropertyTypes.get(),u=f.Serialization.PropertyListReader.read(b.story,a.init,k),k=f.Serialization.ScriptSetReader.readJson(b,"Image",a,[""],k);return new d.ImageItemModel(b,e,t,p,u,k)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a=
{};b.type.variableTypes.forEach(function(c){c=c.jsonNames[c.jsonNames.length-1];var d=b[c].getValue();void 0!==d&&(a[c]=d)});return a};return c}();e.PropertyWriter=d;d=function(){function c(){}c.write=function(b){return{}};return c}();e.PropertyListWriter=d;var h=f.Models.Scripts.ScriptType,d=function(){function c(){}c.write=function(b){var a=b.type,d=void 0,d=a===h.InitEvent?c.writeInitEvent(b):a===h.StepEvent?c.writeStepEvent(b):a===h.SwitchEvent?c.writeSwitchEvent(b):a===h.ActionsOrphan?c.writeActionsOrphan(b):
a===h.PropertyOrphan?c.writePropertyOrphan(b):{};d.type=h.toString(b.type);d.editor={};d.editor.x=b.x;d.editor.y=b.y;return d};c.writeInitEvent=function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};c.writeStepEvent=function(b){var a={scriptType:"step"};0<b.stepIndex&&(a.scriptType+=b.stepIndex+1);a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeSwitchEvent=function(b){var a={};a.switch=b.switchName;a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeActionsOrphan=
function(b){var a={};a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writePropertyOrphan=function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};return c}();e.ScriptWriter=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){d.serialize=function(c){var b={};b.setup=b.setup||{};b.setup.src=c.src;c.width&&(b.setup.class=c.width);c.height&&(b.setup.class=c.height);b.init=f.Serialization.PropertyListWriter.write(c.init);b.scripts=f.Serialization.ScriptSetWriter.write(c.scriptSet);
return b}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=function(b){function a(a,c,d){b.call(this,a,"layer","Layer",[c],[d]);this.items=[];this.flow=a.flow;this.story=a.flow.story}__extends(a,b);a.prototype.getCountOfStepsUsed=function(){var a=1;this.scriptSets.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});this.items.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});return a};a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=
function(a){return new d.LayerItemView(this,a)};return a}(f.Models.Items.ItemModel);d.LayerItemModel=c})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util,b=function(a){function b(d,e){a.call(this,d,e,c.createChildDivElement(e.div,"prostyle prostyle-layer"));this.model=d;this.items=[];f.Views.PageView.createItems(this,d.items)}__extends(b,a);b.prototype.initializeItem=function(b,c){a.prototype.initializeItem.call(this,b,c);this.items.forEach(function(a){a.initializeItem(b,
c)})};b.prototype.generateStepActions=function(b,c,d,e,g){var f=this;this.items.forEach(function(a){a.generateStepActions(f,c,d,e,g)});a.prototype.generateStepActions.call(this,this,c,d,e,g)};return b}(f.Views.Items.ItemView);d.LayerItemView=b})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Models.Properties,b=function(){function a(){}a.get=function(){if(void 0===a._propertyTypes){var b=[];b.push(c.Cache.ANCHOR);b.push(c.Cache.ANIMATION);b.push(c.Cache.BACKGROUND);
b.push(c.Cache.BORDER);b.push(c.Cache.CLASS);b.push(c.Cache.CORNERS);b.push(c.Cache.CROP);b.push(c.Cache.MOVE_TO);b.push(c.Cache.OPACITY);b.push(c.Cache.POSITION);b.push(c.Cache.ROTATION);b.push(c.Cache.SCALE);b.push(c.Cache.SHADOW);b.push(c.Cache.SIZE);b.push(c.Cache.SKEW);b.push(c.Cache.TRANSFORM_ORIGIN);a._propertyTypes=b}return a._propertyTypes};a._propertyTypes=void 0;return a}();d.LayerPropertyTypes=b})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=
f.Models,h=f.Models.Items,c=function(){function b(){}b.read=function(a,c){c=c||{};c.init=c.init||{};var f=d.CanvasPropertyTypes.get(),p=d.FramePropertyTypes.get(),k=d.PagePropertyTypes.get(),h=e.PropertyListReader.read(a.story,c.init,k,a.getDefaultPageClassName(),a.getDefaultPageClassValue()),h=new d.PageModel(h,a);h.canvasScriptSet=e.ScriptSetReader.readJson(h,"Canvas",c,["canvas"],f);h.frameScriptSet=e.ScriptSetReader.readJson(h,"Frame",c,["frame"],p);h.pageScriptSet=e.ScriptSetReader.readJson(h,
"Page",c,["page"],k);h.items=b.readItems(h,c);h.steps=b.readSteps(h,c,h.items);return h};b.readSteps=function(a,b,c){b=b.steps||[];var d=[];b instanceof Array&&b.forEach(function(b){d.push(e.StepReader.read(a,b))});var f=1;c.forEach(function(a){f=Math.max(f,a.getCountOfStepsUsed());a instanceof h.SequencedItemModel&&(f=Math.max(f,a.sequenceOnStepIndex+1))});f=Math.max(f,a.canvasScriptSet.getCountOfStepsUsed());f=Math.max(f,a.frameScriptSet.getCountOfStepsUsed());f=Math.max(f,a.pageScriptSet.getCountOfStepsUsed());
if(d.length<f)for(b=f-d.length,c=0;c<b;c++)d.push(e.StepReader.read(a,{}));return d};b.readItems=function(a,b){var c=b.items;void 0===c&&void 0!==b.item&&(c=[b.item]);var c=c||[],d=[];c instanceof Array&&c.forEach(function(b){d.push(e.ItemReader.read(a,b))});return d};return b}();e.PageReader=c})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){d.deserialize=function(c,b){var a=d.LayerPropertyTypes.get(),e=f.Serialization.PropertyListReader.read(c.story,b.init,a),a=f.Serialization.ScriptSetReader.readJson(c,
...
h,m,l,n,z,A,x,q){b.call(this,a,"text","Text",[h,l,z,x],[m,n,A,q]);this.text=c;this.stackedLines=d;this.stackedWords=e;this.stackedChars=f;this.linesInit=l;this.linesScriptSet=n;this.wordsInit=z;this.wordsScriptSet=A;this.charsInit=x;this.charsScriptSet=q}__extends(a,b);a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.TextItemView(this,a)};return a}(f.Models.Items.ItemModel);d.TextItemModel=c})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));
...
void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),t="";if(e instanceof Array){var p=[];e.forEach(function(a){p.push(a.toString())});t=p.join("<br>")}else t=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),k=!!c.getSetup(a,"stackedWords"),u=!!c.getSetup(a,"stackedChars"),w=d.TextPropertyTypes.get(),
m=d.TextPropertyTypes.getForLines(),l=d.TextPropertyTypes.getForWords(),n=d.TextPropertyTypes.getForChars(),z=f.Serialization.PropertyListReader.read(b.story,a.init,w),q=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,m),x=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,l),r=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,n),w=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],w),m=f.Serialization.ScriptSetReader.readJson(b,
"Lines",a,["line","lines"],m),l=f.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],l),n=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],n);return new d.TextItemModel(b,t,e,k,u,z,w,q,m,x,l,r,n)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&
...
h=e.addEventListener,w=h?"addEventListener":"attachEvent",m=h?"removeEventListener":"detachEvent",l=h?"":"on",n=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==d.type?b:e)[m](l+d.type,n,!1),!c&&(c=!0)&&a.call(b,d.type||d)},q=function(){try{f.doScroll("left")}catch(a){setTimeout(q,50);return}n("poll")};if("complete"==e.readyState)a.call(b,"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(r){}d&&q()}e[w](l+"DOMContentLoaded",n,!1);e[w](l+"readystatechange",n,!1);
b[w](l+"load",n,!1)}};e.createChildImageElement=function(b,a,c,d,e){void 0===d&&(d=void 0);void 0===e&&(e=void 0);var f=document.createElement("img");f.setAttribute("class",a);f.setAttribute("src",c);void 0===d&&void 0===e&&(e=100);void 0!==d&&f.setAttribute("width",d.toString()+"%");void 0!==e&&f.setAttribute("height",e.toString()+"%");b.appendChild(f);return f};e.createStyleElement=function(b){var a=document.createElement("style");a.type="text/css";a.id=b;e.querySelector("head").appendChild(a);
...
a.getCountOfSubSteps())});return b};return c}();e.Step=d;var h=f.Types,d=function(){function c(b,a){this.generateTimeline(b,a)}c.prototype.generateTimeline=function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,q=b.size,r=b.camera,m=r.size,l={fontFamily:"arial"};e.fullScreen||
(l.height=f.height);e.initializeProperties(d,[e.div],m,this.timeline,d.canvas.init,!1,l);l={width:q.width,height:q.height};b.initializeProperties(d,[b.div],m,this.timeline,d.frame.init,!1,l);r.flows.forEach(function(a){var e=m.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var n=void 0;r.flows.forEach(function(a){n=
a.generateStepsActions(c.timeline,n)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.reload=B;f.bootstrap=r;r()})(ProStyle||(ProStyle={}));
