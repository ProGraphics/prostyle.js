...
function w(e){var d=e.dataset.prostyle;if(void 0!==d){var h=f.Stories[d];void 0===h?e.innerHTML="<strong style='background-color: #FFF;color:#C00'>Missing story at ProStyle.Stories."+d+"</strong>":(f.Util.setElementText(e,""),d=e.proStyleCanvas,e.proStyleCanvas=void 0,d&&d.stopControllers(),h=f.Serialization.StoryReader.read(h),d=new f.Views.CanvasView(h,e),d.startControllers(),e.proStyleCanvas=d)}}function B(){var e=document.body;if(e)if(void 0!==e.dataset.prostyle)w(e);else for(var e=document.getElementsByTagName("div"),
...
g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";0<d&&b.steps.forEach(function(b,f){var t=a.divScrubberStep[c-f];t.style.left=(h*b.startTime/d).toString()+"px";t.style.width=(h*b.time/d+g.barHeight).toString()+"px";t.style.height=g.barHeight+"px";t.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=e+"px";this.divScrubberHoverPoint.style.top=(g.barHeight/4-1).toString()+"px";this.divScrubberHoverPoint.style.borderRadius=
