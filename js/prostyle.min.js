...
(f.toStart={}))})(f.Svg||(f.Svg={}));(function(f){f.setElementText=function(f,v){f[void 0!==document.body.textContent?"textContent":"innerText"]=v}})(f.Util||(f.Util={}));(function(f){var q=function(){return function(f){this.initPropertyLists=f;this.init=f[0]}}();f.Model=q})(f.Models||(f.Models={}));(function(f){f.rootUrl=void 0;f.Config={default:{auto:{start:!0,advance:!1,advanceDelay:0,restart:!0,resize:!0},controls:{type:"track",autoHide:!0,color:"#EEE",highlightColor:"#FFF",backColor:"#094766",
stepColor1:"#0c5f89",stepColor2:"#EEE",startHint:!0},keyboard:!1,touch:!1,mouseWheel:!1,debugBar:!1}}})(f.Stories||(f.Stories={}));(function(f){var q=function(){function f(q,r){void 0===q&&(q=f.DEFAULT_WIDTH);void 0===r&&(r=f.DEFAULT_HEIGHT);this.width=q;this.height=r;this.width=Math.max(f.MIN,Math.min(q,f.MAX));this.height=Math.max(f.MIN,Math.min(r,f.MAX))}f.prototype.aspectRatio=function(){return this.height?this.width/this.height:1};f.prototype.getContainedSize=function(q){var r=this.aspectRatio();
return q<r?new f(this.height*q,this.height):q>r?new f(this.width,this.width/q):new f(this.width,this.height)};f.DEFAULT_WIDTH=1024;f.DEFAULT_HEIGHT=768;f.MIN=1;f.MAX=4096;return f}();f.Size=q})(f.Types||(f.Types={}));(function(f){f.splitNoParens=function(f){var v=0,y=0,r=[];f=f.match(/([^()]+)|([()])/g);for(var e=f.length,d,h="",c=0;c<e;c++)d=f[c],"("===d?v++:")"===d&&y++,0!==v?(h+=d,v===y&&(r[r.length-1]+=h,v=y=0,h="")):r=r.concat(d.match(/([^,]+)/g));return r};f.isAbsoluteUrl=function(f){if(f){f=
f.toString().trim();if(0===f.indexOf("//"))return!0;f=f.toLowerCase();if(0===f.indexOf("http://")||0===f.indexOf("https://")||0===f.indexOf("ftp://"))return!0}return!1}})(f.Util||(f.Util={}))})(ProStyle||(ProStyle={}));var __extends=this&&this.__extends||function(f,y){function q(){this.constructor=f}for(var v in y)y.hasOwnProperty(v)&&(f[v]=y[v]);q.prototype=y.prototype;f.prototype=new q};
...
{}))})(e.Scripts||(e.Scripts={}))})(f.Models||(f.Models={}));(function(e){var d=f.Models,h=f.Models.Scripts,c=f.Models.Properties,b=function(){function a(a,b){this.model=a;this.element=b;this.div=void 0;if(b instanceof HTMLDivElement||b instanceof HTMLBodyElement)this.div=b;b.proCache={}}a.prototype.initializeProperties=function(g,b,m,d,e,h,f,l){var p=this;void 0===f&&(f=void 0);void 0===l&&(l=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var z=[];for(f=0;f<b.length;f++){var A=
{force3D:!0,element:b[f],elementIndex:f};h&&(A.xPercent=-50,A.yPercent=-50);z.push(A)}var x=[];e.properties.forEach(function(a){x["prostyle_"+a.type.jsonNames[0]]=a});e.propertyTypes.forEach(function(a){var b=x["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));b.writeCssBuckets(g,p,m,z,!0)});a.postProcessCssBuckets(z,l,e.properties,m);for(f=0;f<b.length;f++)d.set(b[f],z[f],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,k,h,f,n){var l=this;void 0===n&&(n=void 0);var p=
new TimelineMax;k.actions.forEach(function(k){if(k.actionType===d.Actions.ActionType.SetProperties){var A=p.totalDuration(),x=e.Actions.SetPropertiesAction.generateTimeline(a,l,b,k,p,c,n);void 0!==x&&(k=p.totalDuration(),(x=0<x?a.items[x-1].div:void 0)&&h.seek(f+"+="+k),k=new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,x,k),p.add(k,A))}});h.add(p,f)};a.prototype.generateActionsForStep=function(a,b,c,d,e,f,n,l){var p=this;void 0===l&&(l=void 0);n.scripts.forEach(function(n){n.type===
h.ScriptType.StepEvent&&n.stepIndex===e&&p.generateEventTimeline(a,b,c,n,d,f,l)})};a.postProcessCssBuckets=function(a,b,c,d){for(var e=0;e<a.length;e++){var h=a[e],f=h.element.proCache;void 0!==f&&(void 0!==h.width&&(f.width=h.width),void 0!==h.height&&(f.height=h.height))}b&&b(c,a,d);a.forEach(function(a){delete a.element;delete a.elementIndex})};return a}();e.View=b})(f.Views||(f.Views={}));(function(e){var d=function(){function d(){}d.read=function(c,b){b.setup=b.setup||{};var a=(b.flowType||"simple").trim().toLowerCase(),
...
return a}(f.Controllers.Controller);d.KeyboardController=c})(d.Keyboard||(d.Keyboard={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.deserialize=function(c){return new d.KeyboardController(c.keys)}})(d.Keyboard||(d.Keyboard={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.Keyboard||(d.Keyboard={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a,c,d,e){void 0===a&&(a=.01);void 0===
c&&(c=.001);void 0===d&&(d=1);void 0===e&&(e=.1);b.call(this,"mousewheel");this.speed=a;this.ctrlSpeed=c;this.altSpeed=d;this.altCtrlSpeed=e;this.player=this.canvas=this.wheelEventBound=void 0;this.wheelEventBound=this.wheelEvent.bind(this)}__extends(a,b);a.prototype.start=function(a,b){this.stop();this.canvas=a;this.player=b;a.div.addEventListener("wheel",this.wheelEventBound)};a.prototype.stop=function(){void 0!==this.player&&(this.canvas.div.removeEventListener("wheel",this.wheelEventBound),this.player=
this.canvas=void 0)};a.prototype.wheelEvent=function(a){var b;b=0>f.Util.convertToNumber(a.deltaY,-1);if(a.shiftKey)b=this.moveByStep(b);else{var c=a.altKey?a.ctrlKey?this.altCtrlSpeed:this.altSpeed:a.ctrlKey?this.ctrlSpeed:this.speed;b||(c=-c);b=this.moveByTime(c)}c=this.player.timeline.totalDuration();.01>b?b=c:b>c&&(b=.01);this.player.timeline.totalTime(b);this.player.timeline.pause(b);this.player.pause();a.preventDefault();return!1};a.prototype.moveByStep=function(a){this.player.steps.length;
var b=this.player.getCurrentStep();a?b.playerStepIndex<this.player.steps.length-1&&this.player.seekStep(this.player.steps[b.playerStepIndex+1]):0<b.playerStepIndex&&this.player.seekStep(this.player.steps[b.playerStepIndex-1]);return 0};a.prototype.moveByTime=function(a){var b=this.player.timeline.totalTime()+a;return b=Math.round(b/a)*a};a.prototype.resize=function(){};a.prototype.serialize=function(){return d.serialize(this)};return a}(f.Controllers.Controller);d.MouseWheelController=c})(d.MouseWheel||
(d.MouseWheel={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.deserialize=function(c){return new d.MouseWheelController}})(d.MouseWheel||(d.MouseWheel={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.MouseWheel||(d.MouseWheel={}))})(e.Controllers||(e.Controllers={}));(function(d){(function(d){var c=function(b){function a(a){void 0===a&&(a=.01);b.call(this,"resize");this.throttleDelay=a;this.canvasResize=void 0}__extends(a,
...
e=g.barHeight/2,f=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";b.steps.forEach(function(b,h){var k=a.divScrubberStep[c-h];k.style.left=(f*b.startTime/d).toString()+"px";k.style.width=(f*b.time/d+g.barHeight).toString()+
"px";k.style.height=g.barHeight+"px";k.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=e+"px";this.divScrubberHoverPoint.style.top=(g.barHeight/4-1).toString()+"px";this.divScrubberHoverPoint.style.borderRadius=e+"px";this.divScrubberHoverText.style.fontSize=.9*g.barHeight+"px";this.divScrubberProgress.style.height=g.barHeight+"px";this.divScrubberProgress.style.borderRadius=e+"px";this.updateScrubberProgress()};a.prototype.updateScrubberProgress=
...
c,d,e,f,h,n,l,p){b.call(this,a,c,d,l,h,p);this._minValue=e;this._maxNumber=f;this._decimalPlaces=n}__extends(a,b);a.prototype.scrubValue=function(a){a=f.Util.convertToNumber(a,this.defaultValue);var b=Math.pow(10,this._decimalPlaces);a=Math.round(a*b)/b;return a=Math.max(this._minValue,Math.min(a,this._maxNumber))};return a}(d.VariableType);d.NumberVariableType=c;c=function(b){function a(a,c,d,e,f,h,n,l,p){b.call(this,a,c,d,e,f,h,n,l,p)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){d[this.cssName]=
e/100*((c.height+c.width)/2)+1;"z"===this.cssName&&(d.zIndex=e+1)};return a}(d.NumberVariableType);d.ContainerDepthPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,n,l,p){b.call(this,a,c,d,e,f,h,n,l,p)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){a=e/100*c.height;0<e&&1>a&&(a=1);d[this.cssName]=a};return a}(d.NumberVariableType);d.ContainerHeightPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,n,l,p){b.call(this,a,c,d,e,f,h,n,l,p)}__extends(a,b);a.prototype.writeCssBucket=
...
a._propertyTypes=void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),t="";if(e instanceof Array){var m=[];e.forEach(function(a){m.push(a.toString())});t=m.join("<br>")}else t=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),k=!!c.getSetup(a,"stackedWords"),u=!!c.getSetup(a,"stackedChars"),
w=d.TextPropertyTypes.get(),n=d.TextPropertyTypes.getForLines(),l=d.TextPropertyTypes.getForWords(),p=d.TextPropertyTypes.getForChars(),z=f.Serialization.PropertyListReader.read(b.story,a.init,w),q=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,n),x=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,l),r=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,p),w=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],w),n=f.Serialization.ScriptSetReader.readJson(b,
"Lines",a,["line","lines"],n),l=f.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],l),p=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],p);return new d.TextItemModel(b,t,e,k,u,z,w,q,n,x,l,r,p)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&
...
(b.autoAdvanceDelay=a.autoAdvanceDelay);return b};return a}();e.StepWriter=c;g=f.Models;c=function(){function a(){}a.read=function(a){a=a||{};var b=e.CanvasReader.read(a.canvas||{}),c=e.FrameReader.read(a.frame||{}),d=[],h=[],l=new g.Story(b,c,d,a.classes,h,!1);a.flows instanceof Array?a.flows.forEach(function(a){d.push(e.FlowReader.read(l,a))}):void 0!==a.flow?d.push(e.FlowReader.read(l,a.flow)):a.pages instanceof Array?d.push(e.FlowReader.read(l,{pages:a.pages})):void 0!==a.page?d.push(e.FlowReader.read(l,
{pages:[a.page]})):a.items instanceof Array?d.push(e.FlowReader.read(l,{pages:[{items:a.items}]})):void 0!==a.item&&d.push(e.FlowReader.read(l,{pages:[{items:[a.item]}]}));0===d.length&&d.push(e.FlowReader.read(l,{}));a.controllers instanceof Array?a.controllers.forEach(function(a){h.push(e.ControllerReader.read(a))}):void 0!==a.controller?h.push(e.ControllerReader.read(a.controller)):f.defaultControllers instanceof Array&&(l.usingDefaultControllers=!0,f.defaultControllers.forEach(function(a){h.push(e.ControllerReader.read(a))}));
...
f);f/=d},w=function(){void 0!==e&&(clearTimeout(e),e=void 0,a(!0))};b.onmousedown=function(){f=c;h()};b.onmouseup=function(){w()};b.onmouseout=function(){w()}};e.checkBrowserSupport=function(){var b=document.body;return b.classList&&b.dataset&&null!==e.prefixCssStyleIfNeeded("perspective")};e.configureMetaViewport=function(){var b=e.querySelector("meta[name='viewport']")||document.createElement("meta");b.content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no";b.parentNode!==
document.head&&(b.name="viewport",document.head.appendChild(b))};e.contentLoaded=function(b,a){var c=!1,d=!0,e=b.document,f=e.documentElement,h=e.addEventListener,w=h?"addEventListener":"attachEvent",n=h?"removeEventListener":"detachEvent",l=h?"":"on",p=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==d.type?b:e)[n](l+d.type,p,!1),!c&&(c=!0)&&a.call(b,d.type||d)},q=function(){try{f.doScroll("left")}catch(a){setTimeout(q,50);return}p("poll")};if("complete"==e.readyState)a.call(b,
"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(r){}d&&q()}e[w](l+"DOMContentLoaded",p,!1);e[w](l+"readystatechange",p,!1);b[w](l+"load",p,!1)}};e.createChildImageElement=function(b,a,c,d,e){void 0===d&&(d=void 0);void 0===e&&(e=void 0);var f=document.createElement("img");f.setAttribute("class",a);f.setAttribute("src",c);void 0===d&&void 0===e&&(e=100);void 0!==d&&f.setAttribute("width",d.toString()+"%");void 0!==e&&f.setAttribute("height",e.toString()+"%");b.appendChild(f);return f};
...
function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,q=b.size,r=b.camera,n=r.size,l={fontFamily:"arial"};e.fullScreen||(l.height=f.height);e.initializeProperties(d,[e.div],n,this.timeline,d.canvas.init,!1,l);l={width:q.width,height:q.height};b.initializeProperties(d,[b.div],
n,this.timeline,d.frame.init,!1,l);r.flows.forEach(function(a){var e=n.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var p=void 0;r.flows.forEach(function(a){p=a.generateStepsActions(c.timeline,p)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.defaultControllers=[{controllerType:"auto"},
{controllerType:"resize"}];f.reload=B;f.bootstrap=r;r()})(ProStyle||(ProStyle={}));
