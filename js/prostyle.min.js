...
h.forEach(function(a){u.scripts.push(e.ScriptReader.read(u,a))});return u};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||"").trim(),t=c.getSetup(a,"width"),p=c.getSetup(a,"height"),t=isNaN(t)?void 0:Number(t),p=isNaN(p)?void 0:Number(p),l=d.ImagePropertyTypes.get(),u=f.Serialization.PropertyListReader.read(b.story,a.init,l,"image"),l=f.Serialization.ScriptSetReader.readJson(b,
"Image",a,[""],l);return new d.ImageItemModel(b,e,t,p,u,l)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a={};b.type.variableTypes.forEach(function(c){c=c.jsonNames[c.jsonNames.length-1];var d=b[c].getValue();void 0!==d&&(a[c]=d)});return a};return c}();e.PropertyWriter=d;d=function(){function c(){}
