...
1);this.canvasScriptSet.deleteStep(b);this.frameScriptSet.deleteStep(b);this.pageScriptSet.deleteStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.deleteStep(b)})})};c.prototype.deleteItem=function(b){this.items.splice(b,1)};return c}(e.Model);e.PageModel=d;(function(d){var c=function(b){function a(a,c,m,d,e){void 0===e&&(e=void 0);b.call(this,[]);this.story=a;this.flowType=c;this.placement=m;this.pageAspectRatio=d;this.defaultPageClass=e;this.pages=[]}__extends(a,b);a.prototype.getDefaultPageClassName=
...
this.element=b;this.div=void 0;if(b instanceof HTMLDivElement||b instanceof HTMLBodyElement)this.div=b;b.proCache={}}a.prototype.initializeProperties=function(g,b,m,d,e,h,f,l){var p=this;void 0===f&&(f=void 0);void 0===l&&(l=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var z=[];for(f=0;f<b.length;f++){var A={force3D:!0,element:b[f],elementIndex:f};h&&(A.xPercent=-50,A.yPercent=-50);z.push(A)}var x=[];e.properties.forEach(function(a){x["prostyle_"+a.type.jsonNames[0]]=a});
e.propertyTypes.forEach(function(a){var b=x["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));b.writeCssBuckets(g,p,m,z,!0)});a.postProcessCssBuckets(z,l,e.properties,m);for(f=0;f<b.length;f++)d.set(b[f],z[f],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,k,h,f,n){var l=this;void 0===n&&(n=void 0);var p=new TimelineMax;k.actions.forEach(function(k){if(k.actionType===d.Actions.ActionType.SetProperties){var A=p.totalDuration(),x=e.Actions.SetPropertiesAction.generateTimeline(a,
l,b,k,p,c,n);void 0!==x&&(k=p.totalDuration(),(x=0<x?a.items[x-1].div:void 0)&&h.seek(f+"+="+k),k=new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,x,k),p.add(k,A))}});h.add(p,f)};a.prototype.generateActionsForStep=function(a,b,c,d,e,f,n,l){var p=this;void 0===l&&(l=void 0);n.scripts.forEach(function(n){n.type===h.ScriptType.StepEvent&&n.stepIndex===e&&p.generateEventTimeline(a,b,c,n,d,f,l)})};a.postProcessCssBuckets=function(a,b,c,d){for(var e=0;e<a.length;e++){var h=a[e],f=h.element.proCache;
...
c}__extends(a,b);return a}(d.ActionsScript);d.StepEvent=c;c=function(b){function a(a,c){b.call(this,a,d.ScriptType.SwitchEvent);this.switchName=c}__extends(a,b);return a}(d.ActionsScript);d.SwitchEvent=c})(e.Scripts||(e.Scripts={}));d=function(){return function(d){void 0===d&&(d=void 0);this.autoAdvanceDelay=d;this.stopLabel=this.startLabel="";this.time=0}}();e.Step=d})(f.Models||(f.Models={}));(function(e){var d=f.Models.Actions,h=f.Util,c=function(){function a(){}a.readArray=function(b,c){var d=
[];c instanceof Array&&c.forEach(function(c){d.push(a.read(b,c))});return d};a.read=function(b,c){c=c||{};d.ActionType.fromString(c.actionType);return a.readPropertiesAction(b,c)};a.readPropertiesAction=function(a,b){var c=e.PropertyListReader.read(a.scriptSet.itemModelSet.story,b,a.scriptSet.itemProperties).properties;return new d.SetPropertiesAction(a,h.convertToNumber(b.delay),c)};return a}();e.ActionReader=c;d=f.Models.Actions;c=function(){function a(){}a.writeArray=function(a){var b=[];a.forEach(function(a){b.push(a.saveJson())});
return b};a.write=function(b){return a.writePropertiesAction(b)};a.writePropertiesAction=function(a){var b={actionType:d.ActionType.toString(a.actionType)};e.PropertyWriter.writeSet(b,a.properties);a.delay&&(b.delay=a.delay);return b};return a}();e.ActionWriter=c;c=function(){function a(){}a.read=function(a){a=a||{};a.init=a.init||{};a.init.crop=void 0===a.init.crop?!0:a.init.crop;var b=e.PropertyListReader.read(void 0,a.init,f.Models.CanvasPropertyTypes.get()),c=Math.max(0,Math.min(f.Util.convertToNumber(f.Util.getSetup(a,
"padding"),0),50));return new f.Models.CanvasModel(b,c,f.Util.getSetup(a,"mediaUrl"))};return a}();e.CanvasReader=c;c=function(){function a(){}a.write=function(a){var b={setup:{}};a.padding&&(b.setup.padding=a.padding);a.canvasMediaUrl&&(b.setup.mediaUrl=a.canvasMediaUrl);return b};return a}();e.CanvasWriter=c;c=function(){function a(){}a.read=function(b){var c=(b.controllerType||"auto").trim().toLowerCase(),d=a.lookupExtension(c);d&&d.deserialize?b=d.deserialize(b):(f.Util.logError("ControllerReader.read()",
"Unknown Controller Type ("+c+")"),b=f.Extensions.Controllers.Unknown.deserialize(b));return b};a.lookupExtension=function(a){for(var b in f.Extensions.Controllers){var c=b.toLowerCase();if(a===c)return f.Extensions.Controllers[b]}};return a}();e.ControllerReader=c;c=function(){function a(){}a.write=function(a){var b=a.serialize();b.flowType=a.flowType;b.pages=[];a.pages.forEach(function(a){b.pages.push(e.PageWriter.write(a))});return b};return a}();e.FlowWriter=c;c=function(){function a(){}a.read=
function(b){b=b||{};b.init=b.init||{};var c=e.PropertyListReader.read(void 0,b.init,f.Models.FramePropertyTypes.get()),d=f.Util.convertToNumber(f.Util.getSetup(b,"aspectRatio")||a.DEFAULT_ASPECT_RATIO,a.DEFAULT_ASPECT_RATIO);b=Math.max(0,Math.min(f.Util.convertToNumber(f.Util.getSetup(b,"padding"),0),50));return new f.Models.FrameModel(c,d,b)};a.DEFAULT_ASPECT_RATIO=16/9;return a}();e.FrameReader=c;c=function(){function a(){}a.write=function(a){var b={setup:{}};b.setup.aspectRatio=a.aspectRatio;b.setup.padding=
a.padding;return b};return a}();e.FrameWriter=c;c=function(){function a(){}a.write=function(a){var b,c=f.Extensions.Items[a.itemType];c&&c.serialize?b=c.serialize(a):(f.Util.logError("ItemWriter.write()","Unknown Item Type ("+b.itemType+")"),b={});b.itemType=a.itemType;b.scripts=e.ScriptSetWriter.write(a.scriptSet);return b};return a}();e.ItemWriter=c;c=function(){function a(){}a.write=function(b){var c={steps:[]};b.steps.forEach(function(a){c.steps.push(e.StepWriter.write(a))});c.items=[];a.writeItems(b,
c);return c};a.writeItems=function(a,b){a.items.forEach(function(a){b.items.push(e.ItemWriter.write(a))})};return a}();e.PageWriter=c;var b=f.Models.Scripts,a=f.Models.Scripts.ScriptType,h=f.Util,c=function(){function c(){}c.read=function(b,d){d=d||{};d.scriptType=d.scriptType||a.toString(a.StepEvent);var e=a.fromString(d.scriptType),f=void 0,f=e===a.StepEvent?c.readStepEvent(b,d):e===a.SwitchEvent?c.readSwitchEvent(b,d):e===a.ActionsOrphan?c.readActionsOrphan(b,d):e===a.PropertyOrphan?c.readPropertyOrphan(b,
d):c.readInitEvent(b,d);d.editor=d.editor||{};f.x=h.convertToNumber(d.editor.x);f.y=h.convertToNumber(d.editor.y);return f};c.readInitEvent=function(a,c){var d=new b.InitEvent(a);d.properties=e.PropertyListReader.read(a.itemModelSet.story,c,a.itemProperties).properties;return d};c.readStepEvent=function(a,c){var d=c.scriptType.slice(4),d=Math.max(0,h.convertToNumber(d,1)-1),d=new b.StepEvent(a,d),f=void 0;void 0!==c.actions?f=c.actions:void 0!==c.action&&(f=[c.action]);d.actions=e.ActionReader.readArray(d,
f);return d};c.readSwitchEvent=function(a,c){var d=new b.SwitchEvent(a,c.switch||"");d.actions=e.ActionReader.readArray(d,c.actions);return d};c.readActionsOrphan=function(a,c){var d=new b.ActionsOrphan(a);d.actions=e.ActionReader.readArray(d,c.actions);return d};c.readPropertyOrphan=function(a,c){var d=new b.PropertyOrphan(a);d.properties=e.PropertyListReader.read(a.itemModelSet.story,c,a.itemProperties).properties;return d};return c}();e.ScriptReader=c;c=function(){function a(){}a.write=function(a){var b=
[];a.scripts.forEach(function(a){b.push(e.ScriptWriter.write(a))});return b};return a}();e.ScriptSetWriter=c;var g=f.Models,c=function(){function a(){}a.read=function(a,b){return new g.Step(b.autoAdvanceDelay)};return a}();e.StepReader=c;c=function(){function a(){}a.write=function(a){var b={};void 0!==a.autoAdvanceDelay&&(b.autoAdvanceDelay=a.autoAdvanceDelay);return b};return a}();e.StepWriter=c;g=f.Models;c=function(){function a(){}a.read=function(a){a=a||{};var b=e.CanvasReader.read(a.canvas||
{}),c=e.FrameReader.read(a.frame||{}),d=[],h=[],l=new g.Story(b,c,d,a.classes,h,!1);a.flows instanceof Array?a.flows.forEach(function(a){d.push(e.FlowReader.read(l,a))}):void 0!==a.flow?d.push(e.FlowReader.read(l,a.flow)):a.pages instanceof Array?d.push(e.FlowReader.read(l,{pages:a.pages})):void 0!==a.page?d.push(e.FlowReader.read(l,{pages:[a.page]})):a.items instanceof Array?d.push(e.FlowReader.read(l,{pages:[{items:a.items}]})):void 0!==a.item&&d.push(e.FlowReader.read(l,{pages:[{items:[a.item]}]}));
0===d.length&&d.push(e.FlowReader.read(l,{}));a.controllers instanceof Array?a.controllers.forEach(function(a){h.push(e.ControllerReader.read(a))}):void 0!==a.controller?h.push(e.ControllerReader.read(a.controller)):f.defaultControllers instanceof Array&&(l.usingDefaultControllers=!0,f.defaultControllers.forEach(function(a){h.push(e.ControllerReader.read(a))}));return l};return a}();e.StoryReader=c;c=function(){function a(){}a.write=function(a){var b={};b.canvas=e.CanvasWriter.write(a.canvas);b.frame=
e.FrameWriter.write(a.frame);b.flows=[];a.flows.forEach(function(a){b.flows.push(e.FlowWriter.write(a))});return b};a.stringify=function(b){return JSON.stringify(a.write(b))};return a}();e.StoryWriter=c})(f.Serialization||(f.Serialization={}));(function(e){e.autoButton=function(b,a,c,d){void 0===c&&(c=1E3);void 0===d&&(d=2);var e,f=c,h=function(){a(!1);e=setTimeout(h,f);f/=d},w=function(){void 0!==e&&(clearTimeout(e),e=void 0,a(!0))};b.onmousedown=function(){f=c;h()};b.onmouseup=function(){w()};b.onmouseout=
function(){w()}};e.checkBrowserSupport=function(){var b=document.body;return b.classList&&b.dataset&&null!==e.prefixCssStyleIfNeeded("perspective")};e.configureMetaViewport=function(){var b=e.querySelector("meta[name='viewport']")||document.createElement("meta");b.content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no";b.parentNode!==document.head&&(b.name="viewport",document.head.appendChild(b))};e.contentLoaded=function(b,a){var c=!1,d=!0,e=b.document,f=e.documentElement,
h=e.addEventListener,w=h?"addEventListener":"attachEvent",n=h?"removeEventListener":"detachEvent",l=h?"":"on",p=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==d.type?b:e)[n](l+d.type,p,!1),!c&&(c=!0)&&a.call(b,d.type||d)},q=function(){try{f.doScroll("left")}catch(a){setTimeout(q,50);return}p("poll")};if("complete"==e.readyState)a.call(b,"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(r){}d&&q()}e[w](l+"DOMContentLoaded",p,!1);e[w](l+"readystatechange",p,!1);
...
a=f.Models.Properties,d=function(){function c(){}c.generateTimeline=function(b,d,f,g,h,l,p){void 0===p&&(p=void 0);var q=c.getMoveTo(g.properties,b.items),r=[];for(b=0;b<f.length;b++)r.push({force3D:!0,immediateRender:!1,delay:g.delay,element:f[b],elementIndex:b});var x=0,v=0,y=g.script.scriptSet.itemModelSet.flow.story;g.properties.forEach(function(b){b.type instanceof a.AnimationPropertyType?(v=b.duration.getValue()||0,x=b.stagger.getValue()||0,0<v&&b.writeCssBuckets(y,d.model,l,r,!1)):void 0!==
q&&(b.type instanceof a.MoveToPropertyType||b.type instanceof a.PositionPropertyType||b.type instanceof a.RotationPropertyType||b.type instanceof a.ScalePropertyType||b.type instanceof a.SkewPropertyType)||b.writeCssBuckets(y,d.model,l,r,!1)});e.View.postProcessCssBuckets(r,p,g.properties,l);g=h.totalDuration();for(b=0;b<f.length;b++)0<v?h.to(f[b],v,r[b],g):h.set(f[b],r[b],g),g+=x;return q};c.getMoveTo=function(b,c){var d=void 0;b.forEach(function(b){b.type instanceof a.MoveToPropertyType&&(d=b.getVariable("item").getValue(),
...
a.getCountOfSubSteps())});return b};return c}();e.Step=d;var h=f.Types,d=function(){function c(b,a){this.generateTimeline(b,a)}c.prototype.generateTimeline=function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,q=b.size,r=b.camera,n=r.size,l={fontFamily:"arial"};e.fullScreen||
(l.height=f.height);e.initializeProperties(d,[e.div],n,this.timeline,d.canvas.init,!1,l);l={width:q.width,height:q.height};b.initializeProperties(d,[b.div],n,this.timeline,d.frame.init,!1,l);r.flows.forEach(function(a){var e=n.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var p=void 0;r.flows.forEach(function(a){p=
a.generateStepsActions(c.timeline,p)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.reload=B;f.bootstrap=r;r()})(ProStyle||(ProStyle={}));
