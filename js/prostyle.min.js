...
(a.Items={}))})(e.Extensions||(e.Extensions={}));(function(a){(function(a){(function(b){b.readJson=function(a,e){console.log(e);return new b.Extension(a,e.item)}})(a.unknown||(a.unknown={}))})(a.Items||(a.Items={}))})(e.Extensions||(e.Extensions={}));(function(a){var f=e.Util,b=function(){function b(){}b.read=function(h,d){d=d||{};var c=(d.itemType||"text").trim().toLowerCase(),m=a.Items["read_"+c];if(void 0===m){if((c=b.lookupExtension(c))&&c.readJson)return c.readJson(h,d);f.logError("ItemReader.read()",
...
c[".prostyle.prostyle-item"]={userSelect:"none",whiteSpace:"nowrap"};c.selectors.push(".prostyle.prostyle-item.unknown");c[".prostyle.prostyle-item.unknown"]={fontSize:"16px",fontWeight:"bold",color:"#FFF",padding:"1% 1%",backgroundColor:"#C00",border:"solid 3px #FFF"};c.selectors.push(".prostyle.prostyle-layer");c[".prostyle.prostyle-layer"]={transformStyle:"preserve-3d"};c.selectors.push(".prostyle.prostyle-text");c[".prostyle.prostyle-text"]={userSelect:"none",whiteSpace:"nowrap",transformStyle:"preserve-3d"};
