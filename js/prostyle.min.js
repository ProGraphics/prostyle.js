...
b=Math.min(Math.max(40,Math.min(a/12,200)),Math.max(40,Math.min(g/12,200))),c=Math.max(5,b/3);TweenMax.set(this.bgDiv,{left:0,top:g-b,width:a,height:b});var g=.9*b,d=.88*b,e=.53*b,f=.6*b,h=a-d-e-f-3.2*c;TweenMax.set(this.logoDiv,{left:c/2,top:0,height:b,width:g});TweenMax.set(this.nextDiv,{left:a-d-c,top:0,height:b,width:d});TweenMax.set(this.playDiv,{left:a-d-e-2*c,top:0,height:b,width:e});TweenMax.set(this.backDiv,{left:h,top:0,height:b,width:f});this.scrubberSize={left:g+c,width:h-g-2*c,height:b,
barHeight:b/3};this.resizeScrubber();this.updateScrubberProgress()};a.prototype.resizeScrubber=function(){var a=this,g=this.scrubberSize,b=this.canvas.player,c=b.steps.length-1,d=Math.max(0,b.getDuration()-.01),e=g.barHeight/2,f=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=
g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";0<d&&b.steps.forEach(function(b,k){var h=a.divScrubberStep[c-k];h.style.left=(f*b.startTime/d).toString()+"px";h.style.width=(f*b.time/d+g.barHeight).toString()+"px";h.style.height=g.barHeight+"px";h.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=e+"px";this.divScrubberHoverPoint.style.top=(g.barHeight/4-1).toString()+"px";this.divScrubberHoverPoint.style.borderRadius=
