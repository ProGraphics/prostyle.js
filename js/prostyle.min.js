...
(f.toStart={}))})(f.Svg||(f.Svg={}));(function(f){f.setElementText=function(f,E){f[void 0!==document.body.textContent?"textContent":"innerText"]=E}})(f.Util||(f.Util={}));(function(f){var q=function(){return function(f){this.initPropertyLists=f;this.init=f[0]}}();f.Model=q})(f.Models||(f.Models={}));(function(f){var q=function(){function f(q,z){void 0===q&&(q=f.DEFAULT_WIDTH);void 0===z&&(z=f.DEFAULT_HEIGHT);this.width=q;this.height=z;this.width=Math.max(f.MIN,Math.min(q,f.MAX));this.height=Math.max(f.MIN,
Math.min(z,f.MAX))}f.prototype.aspectRatio=function(){return this.height?this.width/this.height:1};f.prototype.getContainedSize=function(q){var z=this.aspectRatio();return q<z?new f(this.height*q,this.height):q>z?new f(this.width,this.width/q):new f(this.width,this.height)};f.DEFAULT_WIDTH=1024;f.DEFAULT_HEIGHT=768;f.MIN=1;f.MAX=4096;return f}();f.Size=q})(f.Types||(f.Types={}));(function(f){f.splitNoParens=function(f){var E=0,G=0,z=[];f=f.match(/([^()]+)|([()])/g);for(var e=f.length,d,h="",c=0;c<
e;c++)d=f[c],"("===d?E++:")"===d&&G++,0!==E?(h+=d,E===G&&(z[z.length-1]+=h,E=G=0,h="")):z=z.concat(d.match(/([^,]+)/g));return z};f.isAbsoluteUrl=function(f){if(f){f=f.toString().trim();if(0===f.indexOf("//"))return!0;f=f.toLowerCase();if(0===f.indexOf("http://")||0===f.indexOf("https://")||0===f.indexOf("ftp://"))return!0}return!1}})(f.Util||(f.Util={}))})(ProStyle||(ProStyle={}));
var __extends=this&&this.__extends||function(f,B){function q(){this.constructor=f}for(var E in B)B.hasOwnProperty(E)&&(f[E]=B[E]);q.prototype=B.prototype;f.prototype=new q};
(function(f){function B(e){if(void 0!==e.dataset.prostyle){"relative"!==e.style.position&&"absolute"!==e.style.position&&(e.style.position="relative");var d=document.createElement("progress");d.value=1;d.max=2;d.style.position="absolute";d.style.left="50%";d.style.top="50%";d.style.transform="translate(-50%,-50%)";e.innerHTML="";e.appendChild(d)}}function q(){var e=document.body;if(e)if(void 0!==e.dataset.prostyle)B(e);else for(var e=document.getElementsByTagName("div"),d=0;d<e.length;d++)B(e[d])}
...
g}__extends(c,d);return c}(e.Model);e.FrameModel=d})(f.Models||(f.Models={}));(function(e){var d=function(){function d(c,b){void 0===c&&(c=1);this.x=c;this.y=b;void 0===b&&(this.y=c)}d.fromJson=function(c){if(void 0===c||null===c)return new d;var b=100,a=void 0;return"number"===typeof c?new d(c/100,c/100):"string"===typeof c?(c=c.split(","),0<c.length&&(b=f.Util.convertToNumber(c[0].trim(),100)/100),1<c.length&&(a=f.Util.convertToNumber(c[1].trim(),100)/100),new d(b,a)):c instanceof Array?(0<c.length&&
...
b.rotationY=this.rotation.y;b.rotationZ=this.rotation.z;b.scaleX=this.scale.x;b.scaleY=this.scale.y;b.autoAlpha=this.opacity;return b};d.fromJson=function(c){c=c||{};var b=new e.Xyz,a=new e.Xyz,g=new e.Scale,x=1,m;for(m in c)if(c.hasOwnProperty(m)){var k=m.trim().toLowerCase();"position"===k||"pos"===k?b=e.Xyz.fromJson(c[m]):"rotation"===k||"rotate"===k||"rot"===k?a=e.Xyz.fromJson(c[m]):"scale"===k?g=e.Scale.fromJson(c[m]):"opacity"===k&&(k=c[m],"number"===typeof k?x=k/100:"string"===typeof k?x=f.Util.convertToNumber(k,
100)/100:k instanceof Array?0<k.length&&(x=f.Util.convertToNumber(k[0],100)/100):x=f.Util.convertToNumber(k.percent,100)/100)}return new d(b,a,g,Math.max(0,Math.min(x,1)))};d.prototype.equals=function(c){return void 0===c||void 0===c.position||void 0===c.rotation||void 0===c.scale||void 0===c.opacity||!1===this.position.equals(c.position)||!1===this.rotation.equals(c.rotation)||!1===this.scale.equals(c.scale)?!1:this.opacity===c.opacity};return d}();e.Placement=d})(f.Types||(f.Types={}));(function(e){(function(d){var c=
...
this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.deleteStep(b)})})};c.prototype.deleteItem=function(b){this.items.splice(b,1)};return c}(e.Model);e.PageModel=d;(function(d){var c=function(b){function a(a,c,m,k,d){void 0===d&&(d=void 0);b.call(this,[]);this.story=a;this.flowType=c;this.placement=m;this.pageAspectRatio=k;this.pageClass=d;this.pages=[]}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.pageClass};a.prototype.getDefaultPageClassValue=function(){};
a.prototype.serialize=function(){f.Util.logError("ProStyle.Models.Flows.Flow.serialize","Abstract base method called.")};a.prototype.createView=function(a,b){f.Util.logError("ProStyle.Models.Flows.Flow.createView","Abstract base method called.")};return a}(e.Model);d.FlowModel=c})(e.Flows||(e.Flows={}));d=function(){return function(d,c,b,a,g,x){this.canvas=d;this.frame=c;this.flows=b;this.classes=a;this.controllers=g;this.usingDefaultControllers=x}}();e.Story=d;(function(d){var c=function(){function b(a){var g=
this;this.type=a;a.variableTypes.forEach(function(a){g[a.jsonNames[0]]=a.createVariable()})}b.prototype.getVariable=function(a){return this[a]};b.prototype.renderLabel=function(){return this.type.renderLabel(this)};b.prototype.writeCssBuckets=function(a,g,b,c,k){var d=this;this.type.variableTypes.forEach(function(e){e=d[e.jsonNames[0]];e.type.writeCssBuckets(a,g,b,e,c,k)})};return b}();d.Property=c})(e.Properties||(e.Properties={}));(function(d){(function(c){c[c.InitEvent=0]="InitEvent";c[c.StepEvent=
...
b;b.proCache={}}a.prototype.initializeProperties=function(g,b,m,k,d,e,h,f){var n=this;void 0===h&&(h=void 0);void 0===f&&(f=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==h&&TweenMax.set(b,h);var F=[];for(h=0;h<b.length;h++){var u={force3D:!0,element:b[h],elementIndex:h};e&&(u.xPercent=-50,u.yPercent=-50);F.push(u)}var v=[];d.properties.forEach(function(a){v["prostyle_"+a.type.jsonNames[0]]=a});d.propertyTypes.forEach(function(a){var b=v["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));
b.writeCssBuckets(g,n,m,F,!0)});a.postProcessCssBuckets(F,f,d.properties,m);for(h=0;h<b.length;h++)k.set(b[h],F[h],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,k,h,f,r){var l=this;void 0===r&&(r=void 0);var n=new TimelineMax;k.actions.forEach(function(k){if(k.actionType===d.Actions.ActionType.SetProperties){var u=n.totalDuration(),v=e.Actions.SetPropertiesAction.generateTimeline(a,l,b,k,n,c,r);void 0!==v&&(k=n.totalDuration(),(v=0<v?a.items[v-1].div:void 0)&&h.seek(f+"+="+k),k=
new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,v,k),n.add(k,u))}});h.add(n,f)};a.prototype.generateActionsForStep=function(a,b,c,k,d,e,f,l){var n=this;void 0===l&&(l=void 0);f.scripts.forEach(function(f){f.type===h.ScriptType.StepEvent&&f.stepIndex===d&&n.generateEventTimeline(a,b,c,f,k,e,l)})};a.postProcessCssBuckets=function(a,b,c,k){for(var d=0;d<a.length;d++){var e=a[d],h=e.element.proCache;void 0!==h&&(void 0!==e.width&&(h.width=e.width),void 0!==e.height&&(h.height=e.height))}b&&
b(c,a,k);a.forEach(function(a){delete a.element;delete a.elementIndex})};return a}();e.View=b})(f.Views||(f.Views={}));(function(e){var d=function(){function d(){}d.read=function(c,b){b.setup=b.setup||{};var a=(b.flowType||"simple").trim().toLowerCase(),g,x=d.lookupExtension(a);x&&x.deserialize?g=x.deserialize(c,b):(f.Util.logError("FlowReader.read()","Unknown Flow Type ("+a+")"),g=f.Extensions.Flows.Unknown.deserialize(c,b));b.pages instanceof Array?b.pages.forEach(function(a){g.pages.push(e.PageReader.read(g,
...
d.LiteEvent=e})(e.Events||(e.Events={}))})(f.Util||(f.Util={}));(function(e){var d=f.Util.Events,h=f.Views,c=function(){function b(a){this.frame=a;this.steps=[];this.animating=!1;this.currentSubStep=0;this.state={progress:0,time:0,step:void 0,subStep:0};this.progressChanged=new d.LiteEvent;this.stateChanged=new d.LiteEvent;this.stepComplete=new d.LiteEvent;this.refreshTimeline(a);this.currentStep=this.getStepAtTime(0)}b.prototype.getDuration=function(a){void 0===a&&(a=!1);return a?this.timeline.totalDuration():
...
"Abstract base method called")};d.prototype.resize=function(){};d.prototype.serialize=function(){f.Util.logError("ProStyle.Controllers.Controller.serialize","Abstract base method called")};return d}();e.Controller=d})(f.Controllers||(f.Controllers={}));(function(e){(function(d){(function(d){var c=function(b){function a(a,c,m){void 0===a&&(a=!0);void 0===c&&(c=!1);void 0===m&&(m=!1);b.call(this,"auto");this._start=a;this._stepAdvance=c;this._restart=m;this.autoStart=!0;this.autoStartDelay=0;this.autoStepAdvance=
...
function(a){var g=this.canvas.div.getBoundingClientRect(),b=this.canvas.player,c=this.scrubberSize,d=c.width-c.barHeight,e=c.barHeight/2;a=Math.max(e,Math.min(a.clientX-g.left-c.left,c.width-e))-c.barHeight;b.seek((a+e)/d,!0)};a.prototype.setupPlayerEvents=function(){var a=this.canvas.player;this.progressChangedBound=this.progressChanged.bind(this);this.stateChangedBound=this.stateChanged.bind(this);a.progressChanged.on(this.progressChangedBound);a.stateChanged.on(this.stateChangedBound)};a.prototype.setupMenuOnMouseMove=
...
b=Math.min(Math.max(40,Math.min(a/12,200)),Math.max(40,Math.min(g/12,200))),c=Math.max(5,b/3);TweenMax.set(this.bgDiv,{left:0,top:g-b,width:a,height:b});var g=.9*b,d=.88*b,e=.53*b,h=.6*b,f=a-d-e-h-3.2*c;TweenMax.set(this.logoDiv,{left:c/2,top:0,height:b,width:g});TweenMax.set(this.nextDiv,{left:a-d-c,top:0,height:b,width:d});TweenMax.set(this.playDiv,{left:a-d-e-2*c,top:0,height:b,width:e});TweenMax.set(this.backDiv,{left:f,top:0,height:b,width:h});this.scrubberSize={left:g+c,width:f-g-2*c,height:b,
barHeight:b/3};this.resizeScrubber();this.updateScrubberProgress()};a.prototype.resizeScrubber=function(){var a=this,g=this.scrubberSize,b=this.canvas.player,c=b.steps.length-1,d=Math.max(0,b.getDuration()-.01),e=g.barHeight/2,h=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=
g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";0<d&&b.steps.forEach(function(b,k){var f=a.divScrubberStep[c-k];f.style.left=(h*b.startTime/d).toString()+"px";f.style.width=(h*b.time/d+g.barHeight).toString()+"px";f.style.height=g.barHeight+"px";f.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=e+"px";this.divScrubberHoverPoint.style.top=(g.barHeight/4-1).toString()+"px";this.divScrubberHoverPoint.style.borderRadius=
e+"px";this.divScrubberHoverText.style.fontSize=.9*g.barHeight+"px";this.divScrubberProgress.style.height=g.barHeight+"px";this.divScrubberProgress.style.borderRadius=e+"px";this.updateScrubberProgress()};a.prototype.updateScrubberProgress=function(){var a=this.scrubberSize;this.divScrubberProgress.style.width=((a.width-a.barHeight+2)*this.progress+a.barHeight).toString()+"px"};a.prototype.generateStyles=function(){var a=(new Date).getTime().toString();this.bgClass="controls-bg-"+a;this.btnClass=
...
c,d,e,f,h,r,l,n){b.call(this,a,c,d,l,h,n);this._minValue=e;this._maxNumber=f;this._decimalPlaces=r}__extends(a,b);a.prototype.scrubValue=function(a){a=f.Util.convertToNumber(a,this.defaultValue);var b=Math.pow(10,this._decimalPlaces);a=Math.round(a*b)/b;return a=Math.max(this._minValue,Math.min(a,this._maxNumber))};return a}(d.VariableType);d.NumberVariableType=c;c=function(b){function a(a,c,d,e,f,h,r,l,n){b.call(this,a,c,d,e,f,h,r,l,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){d[this.cssName]=
e/100*((c.height+c.width)/2)+1;"z"===this.cssName&&(d.zIndex=e+1)};return a}(d.NumberVariableType);d.ContainerDepthPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,r,l,n){b.call(this,a,c,d,e,f,h,r,l,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){a=e/100*c.height;0<e&&1>a&&(a=1);d[this.cssName]=a};return a}(d.NumberVariableType);d.ContainerHeightPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,r,l,n){b.call(this,a,c,d,e,f,h,r,l,n)}__extends(a,b);a.prototype.writeCssBucket=
...
e=[];a&&this.inset&&e.push("inset");e.push(c.toString()+"px");e.push(b.toString()+"px");e.push(d.toString()+"px");a&&e.push(g.toString()+"px");"number"===typeof this.color?e.push("hsl("+Math.abs(this.color%360)+", 50%, 50%)"):e.push(this.color);return e.join(" ")};d.fromJson=function(c){c=c||[];if(!(c instanceof Array))return new d;var b=void 0,a=void 0,g=void 0,e=void 0,m=void 0,k=void 0;0<c.length&&void 0!==c[0]&&(b=f.Util.convertToNumber(c[0],0));1<c.length&&void 0!==c[1]&&(a=f.Util.convertToNumber(c[1],
0));2<c.length&&void 0!==c[2]&&(g=Math.max(0,f.Util.convertToNumber(c[2],0)));3<c.length&&void 0!==c[3]&&(e=c[3]);4<c.length&&void 0!==c[4]&&(m=f.Util.convertToNumber(c[4],0));5<c.length&&void 0!==c[5]&&(k=!!c[5]);return new d(b,a,g,e,m,k)};d.prototype.toJson=function(){var c=6;!0!==this.inset&&(c--,"rgba(0,0,0,0.5)"!==this.color&&(c--,0!==this.spread&&(c--,0!==this.blur&&c--)));var b=[];b.push(this.x);b.push(this.y);3<=c&&b.push(this.blur);4<=c&&b.push(this.spread);5<=c&&b.push(this.color.toString());
...
"Unknown Item Type ("+a.itemType+")");return f.Extensions.Items.Unknown.deserialize(b,a)};c.lookupExtension=function(b){for(var a in f.Extensions.Items){var c=a.toLowerCase();if(b===c)return f.Extensions.Items[a]}};return c}();e.ItemReader=h})(f.Serialization||(f.Serialization={}));(function(e){var d=f.Util,h=function(c){function b(a,g,f,m){var k=this;c.call(this,a,d.createChildDivElement(g.div,"prostyle prostyle-page"));this.model=a;this.flow=g;this.flowIndex=f;this.pageIndex=m;this.steps=[];this.items=
[];b.createItems(this,a.items);a.steps.forEach(function(a,b){var c=[];k.items.forEach(function(a){a instanceof e.Items.SequencedItemView&&a.model.sequenceOnStepIndex===b&&c.push(a)});k.steps.push(new e.Step(a,f,m,b,c))})}__extends(b,c);b.createItems=function(a,b){b instanceof Array&&b.forEach(function(b){a.items.push(b.createView(a))})};b.prototype.generateStepsActions=function(a,b){var c=this;this.steps.forEach(function(d,e){d.startTime=(void 0===b?0:b.stopTime)+.01;b=d;0<e&&a.addLabel(d.startLabel,
d.startTime);var f=c.flow.camera.size,h=c.flow.camera.frame.canvas;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.canvasScriptSet);h=c.flow.camera.frame;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.frameScriptSet);h=c;h.generateActionsForStep(c,[h.div],f,a,e,d.startLabel,c.model.pageScriptSet);var r=c.flow.camera.size.getContainedSize(c.model.flow.pageAspectRatio);c.items.forEach(function(b){b.generateStepActions(c,r,a,e,d.startLabel)});d.stopTime=a.duration();d.stopTime<
d.startTime&&(d.stopTime=d.startTime);a.addLabel(d.stopLabel,d.stopTime);d.time=d.stopTime-d.startTime});return b};return b}(e.View);e.PageView=h;(function(c){var b=f.Util,a=function(a){function c(d,f,x){var h=this;a.call(this,f.model,b.createChildDivElement(f.div,"prostyle prostyle-flow"));this.model=d;this.camera=f;this.flowIndex=x;this.pages=[];d.pages.forEach(function(a,b){h.pages.push(new e.PageView(a,h,x,b))})}__extends(c,a);c.prototype.initializePlacement=function(a){this.initializePerspective();
...
0;var n=h.renderCss(e);n.width=e.width;n.height=e.height;d.applyCss(a,f.div,b,1,n,Expo.easeOut)})};a.prototype.applyCss=function(a,b,c,d,e,f){"initialize"===c?a.set(b,e,c):(e.ease=f,a.to(b,d,e,c))};return a}(f.Views.Flows.FlowView);d.SimpleFlowView=c})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var g=a.setup||{},e=f.Types.Placement.fromJson(g.placement),m=c.convertToNumber(g.pageAspectRatio,b.frame.aspectRatio);return new d.SimpleFlowModel(b,
e,g.pageClass,m)}})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.Simple||(d.Simple={}))})(e.Flows||(e.Flows={}));(function(d){(function(e){var c=function(b){function a(a,c,d,e){b.call(this,a,c,d,e);this.flowType="unknown"}__extends(a,b);a.prototype.serialize=function(){return e.serialize(this)};return a}(d.Simple.SimpleFlowModel);e.UnknownFlowModel=c})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(e){var c=
function(b){function a(a,c,d){b.call(this,a,c,d)}__extends(a,b);return a}(d.Simple.SimpleFlowView);e.UnknownFlowView=c})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var g=a.setup||{},e=f.Types.Placement.fromJson(g.placement),m=c.convertToNumber(g.pageAspectRatio,b.frame.aspectRatio);return new d.UnknownFlowModel(b,e,g.pageClass,m)}})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){d.serialize=
...
var k=new d.Property(this);k.topleft.setValue(b);k.topright.setValue(c);k.bottomright.setValue(e);k.bottomleft.setValue(a);return k};b.prototype.renderLabel=function(a){return this.renderVariables(a,!1,!0)};return b}(d.PropertyType);d.CornersPropertyType=e;e=function(c){function b(a){void 0===a&&(a=!1);var b=[];b.push(new d.Variables.BooleanVariableType("crop",["crop"],"overflow","visible","hidden",a));c.call(this,"crop",["crop"],b)}__extends(b,c);b.prototype.createPropertyFromBoolean=function(a){var b=
...
["width","w"],"width",0,Number.POSITIVE_INFINITY,100,2,"",!0));a.push(new d.Variables.ContainerHeightPctVariableType("Height",["height","h"],"height",0,Number.POSITIVE_INFINITY,100,2,"",!0));c.call(this,"size",["size"],a)}__extends(b,c);b.prototype.createPropertyFromBoolean=function(a){return!1===a?c.prototype.createPropertyFromBoolean.call(this,!1):this.createPropertyFromNumber(100)};b.prototype.createPropertyFromNumber=function(a){var b=new d.Property(this);b.width.setValue(a);b.height.setValue(a);
...
e.PropertyReader=d;var h=f.Models.Properties,d=function(){function b(){}b.read=function(a,c,d,m,k,D){void 0===m&&(m=void 0);void 0===k&&(k=void 0);void 0===D&&(D=[]);c=c||{};var C=f.Util.lowercaseProperties(c),r=[];m&&(r=m.split(","));void 0!==c["class"]&&r.push.apply(r,c["class"].split(","));var l=void 0;void 0!==k&&(l=b.read(a,k||{},d));r.forEach(function(c){if((c=c.trim().toLowerCase())&&-1===D.indexOf(c)){var e=D.slice();e.push(c);if(c=(a.classes||{})[c]||void 0)e=b.read(a,c,d,void 0,void 0,e),
void 0===l?l=e:e.properties.forEach(function(a){var b=l.getPropertyOfType(a.type);void 0==b?l.properties.push(a):a.type.variableTypes.forEach(function(c){var d=a[c.jsonNames[0]];c=b[c.jsonNames[0]];void 0!==d&&void 0!==c&&(d=d.getValue(!1),void 0!==d&&c.setValue(d))})})}});var n=[];d.forEach(function(a){for(var b=void 0,c=void 0,d=0;d<a.jsonNames.length;d++){var g=a.jsonNames[d];if(C.hasOwnProperty(g)){b=e.PropertyReader.read(a,C[g]);break}}void 0!==l&&(c=l.getPropertyOfType(a));void 0!==c&&(void 0===
b&&(b=new h.Property(a)),a.variableTypes.forEach(function(a){var d=b[a.jsonNames[0]];a=c[a.jsonNames[0]];if(void 0!==a){var e=a.getValue(!1);void 0===e&&(e=a.defaultValueOverride);void 0!==e&&(d.defaultValueOverride=e)}}));void 0!==b&&n.push(b)});return new h.PropertyList(d,n)};return b}();e.PropertyListReader=d;var c=f.Models.Scripts,d=function(){function b(){}b.read=function(a,b,d,f){var k=new c.ScriptSet(a,b,f);if(!(d instanceof Array))return k;d.forEach(function(a){k.scripts.push(e.ScriptReader.read(k,
a))});return k};b.readJson=function(a,d,h,m,k){h=f.Util.lowercaseProperties(h);for(var D=new c.ScriptSet(a,d,k),C=0;C<m.length;C++){var r=m[C];if(h[r+"scripts"]instanceof Array)return b.read(a,d,h[r+"scripts"],k);if(void 0!==h[r+"script"])D.scripts.push(e.ScriptReader.read(D,h[r+"script"]));else{var l=new c.StepEvent(D,0);if(h[r+"actions"]instanceof Array)l.actions=e.ActionReader.readArray(l,h[r+"actions"]);else if(void 0!==h[r+"action"])l.actions=e.ActionReader.readArray(l,[h[r+"action"]]);else continue;
D.scripts.push(l)}return D}h instanceof Array&&h.forEach(function(a){D.scripts.push(e.ScriptReader.read(D,a))});return D};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||c.getSetup(a,"img")||c.getSetup(a,"url")||"https://prostyle.io/pro.svg").trim(),x=c.getSetup(a,"width"),m=c.getSetup(a,"height"),x=isNaN(x)?void 0:Number(x),m=isNaN(m)?void 0:Number(m),k=d.ImagePropertyTypes.get(),
D=f.Serialization.PropertyListReader.read(b.story,a.init,k,"image"),k=f.Serialization.ScriptSetReader.readJson(b,"Image",a,[""],k);return new d.ImageItemModel(b,e,x,m,D,k)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a={};b.type.variableTypes.forEach(function(c){c=c.jsonNames[c.jsonNames.length-
1];var d=b[c].getValue();void 0!==d&&(a[c]=d)});return a};return c}();e.PropertyWriter=d;d=function(){function c(){}c.write=function(b){return{}};return c}();e.PropertyListWriter=d;var h=f.Models.Scripts.ScriptType,d=function(){function c(){}c.write=function(b){var a=b.type,d=void 0,d=a===h.InitEvent?c.writeInitEvent(b):a===h.StepEvent?c.writeStepEvent(b):a===h.SwitchEvent?c.writeSwitchEvent(b):a===h.ActionsOrphan?c.writeActionsOrphan(b):a===h.PropertyOrphan?c.writePropertyOrphan(b):{};d.type=h.toString(b.type);
d.editor={};d.editor.x=b.x;d.editor.y=b.y;return d};c.writeInitEvent=function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};c.writeStepEvent=function(b){var a={scriptType:"step"};0<b.stepIndex&&(a.scriptType+=b.stepIndex+1);a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeSwitchEvent=function(b){var a={};a.switch=b.switchName;a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeActionsOrphan=function(b){var a={};a.actions=e.ActionWriter.writeArray(b.actions);
...
h,r,l,n,F,u,v,q){b.call(this,a,"text","Text",[h,l,F,v],[r,n,u,q]);this.text=c;this.stackedLines=d;this.stackedWords=e;this.stackedChars=f;this.linesInit=l;this.linesScriptSet=n;this.wordsInit=F;this.wordsScriptSet=u;this.charsInit=v;this.charsScriptSet=q}__extends(a,b);a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.TextItemView(this,a)};return a}(f.Models.Items.ItemModel);d.TextItemModel=c})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));
...
void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),x="";if(e instanceof Array){var m=[];e.forEach(function(a){m.push(a.toString())});x=m.join("<br>")}else x=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),k=!!c.getSetup(a,"stackedWords"),D=!!c.getSetup(a,"stackedChars"),C=d.TextPropertyTypes.get(),
r=d.TextPropertyTypes.getForLines(),l=d.TextPropertyTypes.getForWords(),n=d.TextPropertyTypes.getForChars(),F=f.Serialization.PropertyListReader.read(b.story,a.init,C,"text"),u=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,r),v=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,l),q=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,n),C=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],C),r=f.Serialization.ScriptSetReader.readJson(b,
"Lines",a,["line","lines"],r),l=f.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],l),n=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],n);return new d.TextItemModel(b,x,e,k,D,F,C,u,r,v,l,q,n)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&
...
f.Models,c=function(){function a(){}a.read=function(a,b){return new g.Step(b.autoAdvanceDelay)};return a}();e.StepReader=c;c=function(){function a(){}a.write=function(a){var b={};void 0!==a.autoAdvanceDelay&&(b.autoAdvanceDelay=a.autoAdvanceDelay);return b};return a}();e.StepWriter=c;g=f.Models;c=function(){function a(){}a.read=function(b){b=b||{};var c=e.CanvasReader.read(b.canvas||{}),d=e.FrameReader.read(b.frame||{}),h=[],r=[],l=new g.Story(c,d,h,f.Util.lowercaseProperties(b.classes),r,!1);b.flows instanceof
Array?b.flows.forEach(function(a){h.push(e.FlowReader.read(l,a))}):void 0!==b.flow?h.push(e.FlowReader.read(l,b.flow)):b.pages instanceof Array?h.push(e.FlowReader.read(l,{pages:b.pages})):void 0!==b.page?h.push(e.FlowReader.read(l,{pages:[b.page]})):b.items instanceof Array?h.push(e.FlowReader.read(l,{pages:[{items:b.items}]})):void 0!==b.item&&h.push(e.FlowReader.read(l,{pages:[{items:[b.item]}]}));0===h.length&&h.push(e.FlowReader.read(l,{}));b.controllers instanceof Array?b.controllers.forEach(function(a){r.push(e.ControllerReader.read(a))}):
void 0!==b.controller?r.push(e.ControllerReader.read(b.controller)):f.defaultControllers instanceof Array&&(l.usingDefaultControllers=!0,f.defaultControllers.forEach(function(a){r.push(e.ControllerReader.read(a))}));a.checkPL(l);return l};a.checkPL=function(a){var b=f.pl||0;if(!(2>b)){var c=f.hn;0===c.indexOf("www.")&&(c=c.substring(4));c="This story uses ProStyle Plus premium extensions. Please purchase a license at https://prostyle.io/plus/ for the "+c+" domain.";3===b&&console.log("Attempting to use ProStyle Plus license for "+
...
return a}();e.StoryWriter=c})(f.Serialization||(f.Serialization={}));(function(e){e.autoButton=function(b,a,c,d){void 0===c&&(c=1E3);void 0===d&&(d=2);var e,f=c,h=function(){a(!1);e=setTimeout(h,f);f/=d},C=function(){void 0!==e&&(clearTimeout(e),e=void 0,a(!0))};b.onmousedown=function(){f=c;h()};b.onmouseup=function(){C()};b.onmouseout=function(){C()}};e.checkBrowserSupport=function(){var b=document.body;return b.classList&&b.dataset&&null!==e.prefixCssStyleIfNeeded("perspective")};e.configureMetaViewport=
function(){var b=e.querySelector("meta[name='viewport']")||document.createElement("meta");b.content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no";b.parentNode!==document.head&&(b.name="viewport",document.head.appendChild(b))};e.contentLoaded=function(b,a){var c=!1,d=!0,e=b.document,f=e.documentElement,h=e.addEventListener,C=h?"addEventListener":"attachEvent",r=h?"removeEventListener":"detachEvent",l=h?"":"on",n=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==
d.type?b:e)[r](l+d.type,n,!1),!c&&(c=!0)&&a.call(b,d.type||d)},F=function(){try{f.doScroll("left")}catch(a){setTimeout(F,50);return}n("poll")};if("complete"==e.readyState)a.call(b,"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(u){}d&&F()}e[C](l+"DOMContentLoaded",n,!1);e[C](l+"readystatechange",n,!1);b[C](l+"load",n,!1)}};e.createChildImageElement=function(b,a,c,d,e){void 0===d&&(d=void 0);void 0===e&&(e=void 0);var f=document.createElement("img");f.setAttribute("class",a);f.setAttribute("src",
...
c=document.documentElement,d=b.left+(window.pageXOffset||c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0);return{top:Math.round(b.top+(window.pageYOffset||c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0)),left:Math.round(d)}}})(f.Util||(f.Util={}));(function(e){(function(c){var b=f.Util,a=f.Models.Properties,d=function(){function c(){}c.generateTimeline=function(b,d,f,g,h,l,n){void 0===n&&(n=void 0);var F=c.getMoveTo(g.properties,b.items),u=[];for(b=0;b<f.length;b++)u.push({force3D:!0,
immediateRender:!1,delay:g.delay,element:f[b],elementIndex:b});var v=0,q=0,z=g.script.scriptSet.itemModelSet.flow.story;g.properties.forEach(function(b){b.type instanceof a.AnimationPropertyType?(q=b.duration.getValue()||0,v=b.stagger.getValue()||0,0<q&&b.writeCssBuckets(z,d.model,l,u,!1)):void 0!==F&&(b.type instanceof a.MoveToPropertyType||b.type instanceof a.PositionPropertyType||b.type instanceof a.RotationPropertyType||b.type instanceof a.ScalePropertyType||b.type instanceof a.SkewPropertyType)||
b.writeCssBuckets(z,d.model,l,u,!1)});e.View.postProcessCssBuckets(u,n,g.properties,l);g=h.totalDuration();for(b=0;b<f.length;b++)0<q?h.to(f[b],q,u[b],g):h.set(f[b],u[b],g),g+=v;return F};c.getMoveTo=function(b,c){var d=void 0;b.forEach(function(b){b.type instanceof a.MoveToPropertyType&&(d=b.getVariable("item").getValue(),void 0!==d&&(0>d||d>c.length)&&(d=void 0))});return d};c.generateMoveTo=function(a,c,d){if(c){var e=b.getGSTransform(c),f=[];(e.x||e.y||e.z)&&f.push("translate3d("+-e.x+"px,"+-e.y+
...
"none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,D=b.size,C=b.camera,r=C.size,l={fontFamily:"arial"};e.fullScreen||(l.height=f.height);e.initializeProperties(d,[e.div],r,this.timeline,d.canvas.init,!1,l);l={width:D.width,height:D.height};b.initializeProperties(d,[b.div],r,this.timeline,d.frame.init,!1,l);C.flows.forEach(function(a){var e=
r.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var n=void 0;C.flows.forEach(function(a){n=a.generateStepsActions(c.timeline,n)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.reload=G;f.bootstrap=z;z()})(ProStyle||(ProStyle={}));
var _gsScope="undefined"!==typeof module&&module.exports&&"undefined"!==typeof global?global:this||window;
(function(f){var B=f.GreenSockGlobals||f,q=function(a){a=a.split(".");var b=B,c;for(c=0;c<a.length;c++)b[a[c]]=b=b[a[c]]||{};return b}("com.greensock.utils"),E=function(a){var b=a.nodeType,c="";if(1===b||9===b||11===b){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=E(a)}else if(3===b||4===b)return a.nodeValue;return c},G=document,z=G.defaultView?G.defaultView.getComputedStyle:function(){},e=/([A-Z])/g,d=function(a,b,c,d){var f;(c=c||z(a,null))?f=(a=
...
(a?" class='"+a+(c?d++:"")+"'>":">")}},g=q.SplitText=B.SplitText=function(a,b){"string"===typeof a&&(a=g.selector(a));if(!a)throw"cannot split a null element.";var c;if(h(a)){c=a;var d=[],e=c.length,f,m,u;for(f=0;f<e;f++)if(m=c[f],h(m))for(u=0;u<m.length;u++)d.push(m[u]);else d.push(m);c=d}else c=[a];this.elements=c;this.chars=[];this.words=[];this.lines=[];this._originals=[];this.vars=b||{};this.split(b)},x=function(a,b,c){var d=a.nodeType;if(1===d||9===d||11===d)for(a=a.firstChild;a;a=a.nextSibling)x(a,
...
")eefec303079ad17405c"));var q=E(e),u=f.type||f.split||"chars,words,lines",v=-1!==u.indexOf("lines")?[]:null,B=-1!==u.indexOf("words"),u=-1!==u.indexOf("chars"),H="absolute"===f.position||!0===f.absolute,R=H?"&#173; ":" ",S=-999,J=z(e),T=d(e,"paddingLeft",J),aa=d(e,"borderBottomWidth",J)+d(e,"borderTopWidth",J),ba=d(e,"borderLeftWidth",J)+d(e,"borderRightWidth",J),ca=d(e,"paddingTop",J)+d(e,"paddingBottom",J),da=d(e,"paddingLeft",J)+d(e,"paddingRight",J),J=d(e,"textAlign",J,!0),N=e.clientHeight,O=
e.clientWidth,P=a(f.wordsClass),ea=a(f.charsClass),U=-1!==(f.linesClass||"").indexOf("++"),f=f.linesClass,V=-1!==q.indexOf("<"),L=!0,Q=[],W=[],X=[],I=void 0,M=void 0,y=void 0,A=void 0,t=void 0,w=y=y=void 0,p=void 0,K=void 0,Y=A=w=void 0,Z=void 0;U&&(f=f.split("++").join(""));V&&(q=q.split("<").join("{{LT}}"));I=q.length;A=P();for(t=0;t<I;t++)if(y=q.charAt(t),")"===y&&")eefec303079ad17405c"===q.substr(t,20))A+=(L?"</div>":"")+"<BR/>",L=!1,t!==I-20&&")eefec303079ad17405c"!==q.substr(t+20,20)&&(A+=" "+
P(),L=!0),t+=19;else if(" "===y&&" "!==q.charAt(t-1)&&t!==I-1&&")eefec303079ad17405c"!==q.substr(t-20,20)){A+=L?"</div>":"";for(L=!1;" "===q.charAt(t+1);)A+=R,t++;if(")"!==q.charAt(t+1)||")eefec303079ad17405c"!==q.substr(t+1,20))A+=R+P(),L=!0}else A+=u&&" "!==y?ea()+y+"</div>":y;e.innerHTML=A+(L?"</div>":"");V&&x(e,"{{LT}}","<");y=e.getElementsByTagName("*");I=y.length;w=[];for(t=0;t<I;t++)w[t]=y[t];if(v||H)for(t=0;t<I;t++)if(p=w[t],(y=p.parentNode===e)||H||u&&!B)K=p.offsetTop,v&&y&&K!==S&&"BR"!==
p.nodeName&&(M=[],v.push(M),S=K),H&&(p._x=p.offsetLeft,p._y=K,p._w=p.offsetWidth,p._h=p.offsetHeight),v&&(B!==y&&u||(M.push(p),p._x-=T),y&&t&&(w[t-1]._wordEnd=!0),"BR"===p.nodeName&&p.nextSibling&&"BR"===p.nextSibling.nodeName&&v.push([]));for(t=0;t<I;t++)p=w[t],y=p.parentNode===e,"BR"===p.nodeName?v||H?(e.removeChild(p),w.splice(t--,1),I--):B||e.appendChild(p):(H&&(A=p.style,B||y||(p._x+=p.parentNode._x,p._y+=p.parentNode._y),A.left=p._x+"px",A.top=p._y+"px",A.position="absolute",A.display="block",
A.width=p._w+1+"px",A.height=p._h+"px"),B?y&&""!==p.innerHTML?W.push(p):u&&Q.push(p):y?(e.removeChild(p),w.splice(t--,1),I--):!y&&u&&(K=!v&&!H&&p.nextSibling,e.appendChild(p),K||e.appendChild(G.createTextNode(" ")),Q.push(p)));if(v){H&&(w=G.createElement("div"),e.appendChild(w),Y=w.offsetWidth+"px",K=w.offsetParent===e?0:e.offsetLeft,e.removeChild(w));A=e.style.cssText;for(e.style.cssText="display:none;";e.firstChild;)e.removeChild(e.firstChild);Z=!H||!B&&!u;for(t=0;t<v.length;t++){M=v[t];w=G.createElement("div");
w.style.cssText="display:block;text-align:"+J+";position:"+(H?"absolute;":"relative;");f&&(w.className=f+(U?t+1:""));X.push(w);I=M.length;for(y=0;y<I;y++)"BR"!==M[y].nodeName&&(p=M[y],w.appendChild(p),Z&&(p._wordEnd||B)&&w.appendChild(G.createTextNode(" ")),H&&(0===y&&(w.style.top=p._y+"px",w.style.left=T+K+"px"),p.style.top="0px",K&&(p.style.left=p._x-K+"px")));0===I&&(w.innerHTML="&nbsp;");B||u||(w.innerHTML=E(w).split(String.fromCharCode(160)).join(" "));H&&(w.style.width=Y,w.style.height=p._h+
"px");e.appendChild(w)}e.style.cssText=A}H&&(N>e.clientHeight&&(e.style.height=N-ca+"px",e.clientHeight<N&&(e.style.height=N+aa+"px")),O>e.clientWidth&&(e.style.width=O-da+"px",e.clientWidth<O&&(e.style.width=O+ba+"px")));m(g,Q);m(h,W);m(n,X)}this.chars.reverse();this.words.reverse();this.lines.reverse();this.isSplit=!0;return this};q.revert=function(){if(!this._originals)throw"revert() call wasn't scoped properly.";for(var a=this._originals.length;-1<--a;)this.elements[a].innerHTML=this._originals[a];
...
(function(f){var B=function(){return(_gsScope.GreenSockGlobals||_gsScope)[f]};"function"===typeof define&&define.amd?define(["TweenLite"],B):"undefined"!==typeof module&&module.exports&&(module.exports=B())})("SplitText");
