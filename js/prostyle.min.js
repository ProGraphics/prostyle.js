...
1);this.canvasScriptSet.deleteStep(b);this.frameScriptSet.deleteStep(b);this.pageScriptSet.deleteStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.deleteStep(b)})})};c.prototype.deleteItem=function(b){this.items.splice(b,1)};return c}(e.Model);e.PageModel=d;(function(d){var c=function(b){function a(a,c,p,d,e){void 0===e&&(e=void 0);b.call(this,[]);this.story=a;this.flowType=c;this.placement=p;this.pageAspectRatio=d;this.pageClass=e;this.pages=[]}__extends(a,b);a.prototype.getDefaultPageClassName=
function(){return this.pageClass};a.prototype.getDefaultPageClassValue=function(){};a.prototype.serialize=function(){f.Util.logError("ProStyle.Models.Flows.Flow.serialize","Abstract base method called.")};a.prototype.createView=function(a,b){f.Util.logError("ProStyle.Models.Flows.Flow.createView","Abstract base method called.")};return a}(e.Model);d.FlowModel=c})(e.Flows||(e.Flows={}));d=function(){return function(d,c,b,a,g,t){this.canvas=d;this.frame=c;this.flows=b;this.classes=a;this.controllers=
...
this.element=b;this.div=void 0;if(b instanceof HTMLDivElement||b instanceof HTMLBodyElement)this.div=b;b.proCache={}}a.prototype.initializeProperties=function(g,b,p,d,e,h,f,k){var n=this;void 0===f&&(f=void 0);void 0===k&&(k=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var z=[];for(f=0;f<b.length;f++){var A={force3D:!0,element:b[f],elementIndex:f};h&&(A.xPercent=-50,A.yPercent=-50);z.push(A)}var x=[];e.properties.forEach(function(a){x["prostyle_"+a.type.jsonNames[0]]=a});
e.propertyTypes.forEach(function(a){var b=x["prostyle_"+a.jsonNames[0]];void 0===b&&(b=new c.Property(a));b.writeCssBuckets(g,n,p,z,!0)});a.postProcessCssBuckets(z,k,e.properties,p);for(f=0;f<b.length;f++)d.set(b[f],z[f],"initialize")};a.prototype.generateEventTimeline=function(a,b,c,l,h,f,m){var k=this;void 0===m&&(m=void 0);var n=new TimelineMax;l.actions.forEach(function(l){if(l.actionType===d.Actions.ActionType.SetProperties){var A=n.totalDuration(),x=e.Actions.SetPropertiesAction.generateTimeline(a,
k,b,l,n,c,m);void 0!==x&&(l=n.totalDuration(),(x=0<x?a.items[x-1].div:void 0)&&h.seek(f+"+="+l),l=new TimelineMax,e.Actions.SetPropertiesAction.generateMoveTo(a.div,x,l),n.add(l,A))}});h.add(n,f)};a.prototype.generateActionsForStep=function(a,b,c,d,e,f,m,k){var n=this;void 0===k&&(k=void 0);m.scripts.forEach(function(m){m.type===h.ScriptType.StepEvent&&m.stepIndex===e&&n.generateEventTimeline(a,b,c,m,d,f,k)})};a.postProcessCssBuckets=function(a,b,c,d){for(var e=0;e<a.length;e++){var h=a[e],f=h.element.proCache;
...
d.width-f))-d.barHeight;this.divScrubberHoverPoint.style.left=(a+f+f/2-1).toString()+"px";b=Math.max(0,b.getDuration()-.01)*(a+f)/e;this.divScrubberHoverText.style.left=a.toString()+"px";c.setElementText(this.divScrubberHoverText,b.toFixed(2))};a.prototype.scrubberMouseClick=function(a){var g=this.canvas.div.getBoundingClientRect(),b=this.canvas.player,c=this.scrubberSize,d=c.width-c.barHeight,e=c.barHeight/2;a=Math.max(e,Math.min(a.clientX-g.left-c.left,c.width-e))-c.barHeight;b.seek((a+e)/d,!0)};
a.prototype.setupPlayerEvents=function(){var a=this.canvas.player;a.progressChanged.on(this.progressChanged.bind(this));a.stateChanged.on(this.stateChanged.bind(this))};a.prototype.setupMenuOnMouseMove=function(){var a=this.canvas.div,g=this.canvas.fullScreen,b=c.throttle(function(){a.classList.remove("mouseMovement");g&&(a.style.cursor="none")},1500);a.onmousemove=function(c){a.classList.add("mouseMovement");g&&(a.style.cursor="auto");b()}};a.prototype.progressChanged=function(a){this.progress=a.progress;
this.updateScrubberProgress()};a.prototype.stateChanged=function(a){this.playDiv.innerHTML=a?b.play.svg:b.pause.svg};a.prototype.resize=function(){var a=this.canvas.div.clientWidth,g=this.canvas.div.clientHeight,b=Math.min(Math.max(40,Math.min(a/12,200)),Math.max(40,Math.min(g/12,200))),c=Math.max(5,b/3);TweenMax.set(this.bgDiv,{left:0,top:g-b,width:a,height:b});var g=.9*b,d=.88*b,e=.53*b,f=.6*b,h=a-d-e-f-3.2*c;TweenMax.set(this.logoDiv,{left:c/2,top:0,height:b,width:g});TweenMax.set(this.nextDiv,
{left:a-d-c,top:0,height:b,width:d});TweenMax.set(this.playDiv,{left:a-d-e-2*c,top:0,height:b,width:e});TweenMax.set(this.backDiv,{left:h,top:0,height:b,width:f});this.scrubberSize={left:g+c,width:h-g-2*c,height:b,barHeight:b/3};this.resizeScrubber();this.updateScrubberProgress()};a.prototype.resizeScrubber=function(){var a=this,g=this.scrubberSize,b=this.canvas.player,c=b.steps.length-1,d=Math.max(0,b.getDuration()-.01),e=g.barHeight/2,f=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";
this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";0<d&&b.steps.forEach(function(b,l){var h=a.divScrubberStep[c-l];h.style.left=(f*b.startTime/d).toString()+"px";h.style.width=(f*b.time/d+g.barHeight).toString()+"px";h.style.height=g.barHeight+"px";h.style.borderRadius=
...
c,d,e,f,h,m,k,n){b.call(this,a,c,d,k,h,n);this._minValue=e;this._maxNumber=f;this._decimalPlaces=m}__extends(a,b);a.prototype.scrubValue=function(a){a=f.Util.convertToNumber(a,this.defaultValue);var b=Math.pow(10,this._decimalPlaces);a=Math.round(a*b)/b;return a=Math.max(this._minValue,Math.min(a,this._maxNumber))};return a}(d.VariableType);d.NumberVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,k,n){b.call(this,a,c,d,e,f,h,m,k,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){d[this.cssName]=
e/100*((c.height+c.width)/2)+1;"z"===this.cssName&&(d.zIndex=e+1)};return a}(d.NumberVariableType);d.ContainerDepthPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,k,n){b.call(this,a,c,d,e,f,h,m,k,n)}__extends(a,b);a.prototype.writeCssBucket=function(a,b,c,d,e){a=e/100*c.height;0<e&&1>a&&(a=1);d[this.cssName]=a};return a}(d.NumberVariableType);d.ContainerHeightPctVariableType=c;c=function(b){function a(a,c,d,e,f,h,m,k,n){b.call(this,a,c,d,e,f,h,m,k,n)}__extends(a,b);a.prototype.writeCssBucket=
...
e=[];a&&this.inset&&e.push("inset");e.push(c.toString()+"px");e.push(b.toString()+"px");e.push(d.toString()+"px");a&&e.push(g.toString()+"px");"number"===typeof this.color?e.push("hsl("+Math.abs(this.color%360)+", 50%, 50%)"):e.push(this.color);return e.join(" ")};d.fromJson=function(c){c=c||[];if(!(c instanceof Array))return new d;var b=void 0,a=void 0,g=void 0,e=void 0,p=void 0,l=void 0;0<c.length&&void 0!==c[0]&&(b=f.Util.convertToNumber(c[0],0));1<c.length&&void 0!==c[1]&&(a=f.Util.convertToNumber(c[1],
0));2<c.length&&void 0!==c[2]&&(g=Math.max(0,f.Util.convertToNumber(c[2],0)));3<c.length&&void 0!==c[3]&&(e=c[3]);4<c.length&&void 0!==c[4]&&(p=f.Util.convertToNumber(c[4],0));5<c.length&&void 0!==c[5]&&(l=!!c[5]);return new d(b,a,g,e,p,l)};d.prototype.toJson=function(){var c=6;!0!==this.inset&&(c--,"rgba(0,0,0,0.5)"!==this.color&&(c--,0!==this.spread&&(c--,0!==this.blur&&c--)));var b=[];b.push(this.x);b.push(this.y);3<=c&&b.push(this.blur);4<=c&&b.push(this.spread);5<=c&&b.push(this.color.toString());
...
var l=new d.Property(this);l.topleft.setValue(b);l.topright.setValue(c);l.bottomright.setValue(e);l.bottomleft.setValue(a);return l};b.prototype.renderLabel=function(a){return this.renderVariables(a,!1,!0)};return b}(d.PropertyType);d.CornersPropertyType=e;e=function(c){function b(a){void 0===a&&(a=!1);var b=[];b.push(new d.Variables.BooleanVariableType("crop",["crop"],"overflow","visible","hidden",a));c.call(this,"crop",["crop"],b)}__extends(b,c);b.prototype.createPropertyFromBoolean=function(a){var b=
...
b;a=3<a.length&&void 0!==a[3]?f.Util.convertToNumber(a[3]):c;var l=new d.Property(this);l.left.setValue(a);l.top.setValue(b);l.right.setValue(c);l.bottom.setValue(e);return l};b.prototype.renderLabel=function(a){var b=a.all.getValue(),c=a.left.getValue()||b,d=a.top.getValue()||b,e=a.right.getValue()||b;a=a.bottom.getValue()||b;return void 0===c&&void 0===d&&void 0===e&&void 0===a?this.label:c===d&&d===e&&e===a&&a===c?this.label+": "+c.toString()+"%":void 0===c||void 0===d||void 0===e||void 0===a?
...
d,e,c.createChildImageElement(e.div,"prostyle prostyle-item",d.itemModelSet.flow.story.canvas.adjustImageUrl(d.src),d.width,d.height));this.model=d}__extends(b,a);b.prototype.initializeItem=function(a,b){var c=this.model,d=b.getContainedSize(c.itemModelSet.flow.pageAspectRatio),e={};void 0!==c.width&&(e.width=c.width.toString()+"%");void 0!==c.height&&(e.height=c.height.toString()+"%");this.initializeProperties(c.itemModelSet.flow.story,[this.element],d,a,c.init,!1,e)};return b}(f.Views.Items.ItemView);
d.ImageItemView=b})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Models.Properties,b=function(){function a(){}a.get=function(){if(void 0===a._propertyTypes){var b=[];b.push(c.Cache.ANCHOR);b.push(c.Cache.ANIMATION);b.push(c.Cache.CLASS);b.push(c.Cache.CORNERS);b.push(c.Cache.OPACITY);b.push(c.Cache.POSITION);b.push(c.Cache.ROTATION);b.push(c.Cache.SCALE);b.push(c.Cache.SHADOW);b.push(c.Cache.SKEW);b.push(c.Cache.TRANSFORM_ORIGIN);a._propertyTypes=b}return a._propertyTypes};
a._propertyTypes=void 0;return a}();d.ImagePropertyTypes=b})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function b(){}b.read=function(a,b){return"boolean"===typeof b?a.createPropertyFromBoolean(b):"number"===typeof b?a.createPropertyFromNumber(b):"string"===typeof b?a.createPropertyFromString(b):b instanceof Array?a.createPropertyFromArray(b):a.createPropertyFromObject(b)};return b}();e.PropertyReader=d;var h=f.Models.Properties,
d=function(){function b(){}b.read=function(a,c,d,p,l,u){void 0===p&&(p=void 0);void 0===l&&(l=void 0);void 0===u&&(u=[]);c=c||{};var w=f.Util.lowercaseProperties(c),m=[];p&&(m=p.split(","));void 0!==c["class"]&&m.push.apply(m,c["class"].split(","));var k=void 0;void 0!==l&&(k=b.read(a,l||{},d));m.forEach(function(c){if((c=c.trim().toLowerCase())&&-1===u.indexOf(c)){var e=u.slice();e.push(c);if(c=(a.classes||{})[c]||void 0)e=b.read(a,c,d,void 0,void 0,e),void 0===k?k=e:e.properties.forEach(function(a){var b=
k.getPropertyOfType(a.type);void 0==b?k.properties.push(a):a.type.variableTypes.forEach(function(c){var d=a[c.jsonNames[0]];c=b[c.jsonNames[0]];void 0!==d&&void 0!==c&&(d=d.getValue(!1),void 0!==d&&c.setValue(d))})})}});var n=[];d.forEach(function(a){for(var b=void 0,c=void 0,d=0;d<a.jsonNames.length;d++){var g=a.jsonNames[d];if(w.hasOwnProperty(g)){b=e.PropertyReader.read(a,w[g]);break}}void 0!==k&&(c=k.getPropertyOfType(a));void 0!==c&&(void 0===b&&(b=new h.Property(a)),a.variableTypes.forEach(function(a){var d=
b[a.jsonNames[0]];a=c[a.jsonNames[0]];if(void 0!==a){var e=a.getValue(!1);void 0===e&&(e=a.defaultValueOverride);void 0!==e&&(d.defaultValueOverride=e)}}));void 0!==b&&n.push(b)});return new h.PropertyList(d,n)};return b}();e.PropertyListReader=d;var c=f.Models.Scripts,d=function(){function b(){}b.read=function(a,b,d,f){var l=new c.ScriptSet(a,b,f);if(!(d instanceof Array))return l;d.forEach(function(a){l.scripts.push(e.ScriptReader.read(l,a))});return l};b.readJson=function(a,d,h,p,l){h=f.Util.lowercaseProperties(h);
for(var u=new c.ScriptSet(a,d,l),w=0;w<p.length;w++){var m=p[w];if(h[m+"scripts"]instanceof Array)return b.read(a,d,h[m+"scripts"],l);if(void 0!==h[m+"script"])u.scripts.push(e.ScriptReader.read(u,h[m+"script"]));else{var k=new c.StepEvent(u,0);if(h[m+"actions"]instanceof Array)k.actions=e.ActionReader.readArray(k,h[m+"actions"]);else if(void 0!==h[m+"action"])k.actions=e.ActionReader.readArray(k,[h[m+"action"]]);else continue;u.scripts.push(k)}return u}u=new c.ScriptSet(a,d,l);if(!(h instanceof Array))return u;
h.forEach(function(a){u.scripts.push(e.ScriptReader.read(u,a))});return u};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||c.getSetup(a,"img")||c.getSetup(a,"url")||"https://prostyle.io/pro.svg").trim(),t=c.getSetup(a,"width"),p=c.getSetup(a,"height"),t=isNaN(t)?void 0:Number(t),p=isNaN(p)?void 0:Number(p),l=d.ImagePropertyTypes.get(),u=f.Serialization.PropertyListReader.read(b.story,
a.init,l,"image"),l=f.Serialization.ScriptSetReader.readJson(b,"Image",a,[""],l);return new d.ImageItemModel(b,e,t,p,u,l)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a={};b.type.variableTypes.forEach(function(c){c=c.jsonNames[c.jsonNames.length-1];var d=b[c].getValue();void 0!==d&&(a[c]=
d)});return a};return c}();e.PropertyWriter=d;d=function(){function c(){}c.write=function(b){return{}};return c}();e.PropertyListWriter=d;var h=f.Models.Scripts.ScriptType,d=function(){function c(){}c.write=function(b){var a=b.type,d=void 0,d=a===h.InitEvent?c.writeInitEvent(b):a===h.StepEvent?c.writeStepEvent(b):a===h.SwitchEvent?c.writeSwitchEvent(b):a===h.ActionsOrphan?c.writeActionsOrphan(b):a===h.PropertyOrphan?c.writePropertyOrphan(b):{};d.type=h.toString(b.type);d.editor={};d.editor.x=b.x;
d.editor.y=b.y;return d};c.writeInitEvent=function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};c.writeStepEvent=function(b){var a={scriptType:"step"};0<b.stepIndex&&(a.scriptType+=b.stepIndex+1);a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeSwitchEvent=function(b){var a={};a.switch=b.switchName;a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writeActionsOrphan=function(b){var a={};a.actions=e.ActionWriter.writeArray(b.actions);return a};c.writePropertyOrphan=
function(b){var a={};e.PropertyWriter.writeSet(a,b.properties);return a};return c}();e.ScriptWriter=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){d.serialize=function(c){var b={};b.setup=b.setup||{};b.setup.src=c.src;c.width&&(b.setup.class=c.width);c.height&&(b.setup.class=c.height);b.init=f.Serialization.PropertyListWriter.write(c.init);b.scripts=f.Serialization.ScriptSetWriter.write(c.scriptSet);return b}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=
function(b){function a(a,c,d){b.call(this,a,"layer","Layer",[c],[d]);this.items=[];this.flow=a.flow;this.story=a.flow.story}__extends(a,b);a.prototype.getCountOfStepsUsed=function(){var a=1;this.scriptSets.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});this.items.forEach(function(b){a=Math.max(a,b.getCountOfStepsUsed())});return a};a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.LayerItemView(this,a)};return a}(f.Models.Items.ItemModel);
d.LayerItemModel=c})(d.Layer||(d.Layer={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util,b=function(a){function b(d,e){a.call(this,d,e,c.createChildDivElement(e.div,"prostyle prostyle-layer"));this.model=d;this.items=[];f.Views.PageView.createItems(this,d.items)}__extends(b,a);b.prototype.initializeItem=function(b,c){a.prototype.initializeItem.call(this,b,c);this.items.forEach(function(a){a.initializeItem(b,c)})};b.prototype.generateStepActions=function(b,c,d,e,g){var f=this;this.items.forEach(function(a){a.generateStepActions(f,
...
p=d.FramePropertyTypes.get(),l=d.PagePropertyTypes.get(),h=e.PropertyListReader.read(a.story,c.init,l,a.getDefaultPageClassName(),a.getDefaultPageClassValue()),h=new d.PageModel(h,a);h.canvasScriptSet=e.ScriptSetReader.readJson(h,"Canvas",c,["canvas"],f);h.frameScriptSet=e.ScriptSetReader.readJson(h,"Frame",c,["frame"],p);h.pageScriptSet=e.ScriptSetReader.readJson(h,"Page",c,["page"],l);h.items=b.readItems(h,c);h.steps=b.readSteps(h,c,h.items);return h};b.readSteps=function(a,b,c){b=b.steps||[];var d=
...
d=[a._linePropertyTypes],e=[a._propertyTypes,a._linePropertyTypes,a._wordPropertyTypes,a._charPropertyTypes];a.addPropertyType(b,c.Cache.ANCHOR);a.addPropertyType(e,c.Cache.ANIMATION);a.addPropertyType(e,c.Cache.BACKGROUND);a.addPropertyType(e,c.Cache.BORDER);a.addPropertyType(d,c.Cache.BULLET);a.addPropertyType(e,c.Cache.CLASS);a.addPropertyType(e,c.Cache.CORNERS);a.addPropertyType(b,c.Cache.CROP);a.addPropertyType(b,c.Cache.FONT);a.addPropertyType(e,c.Cache.OPACITY);a.addPropertyType(e,c.Cache.PADDING);
a.addPropertyType(e,c.Cache.POSITION);a.addPropertyType(e,c.Cache.ROTATION);a.addPropertyType(e,c.Cache.SCALE);a.addPropertyType(e,c.Cache.SHADOW);a.addPropertyType(e,c.Cache.SKEW);a.addPropertyType(b,c.Cache.TEXT_ALIGN);a.addPropertyType(e,c.Cache.TEXT_COLOR);a.addPropertyType(e,c.Cache.TEXT_SHADOW);a.addPropertyType(e,c.Cache.TEXT_STYLE);a.addPropertyType(b,c.Cache.TEXT_WIDTH);a.addPropertyType(e,c.Cache.TRANSFORM_ORIGIN)};a.addPropertyType=function(a,b){a.forEach(function(a){a.push(b)})};a.get=
function(){void 0===a._propertyTypes&&a.cacheProperties();return a._propertyTypes};a.getForLines=function(){void 0===a._linePropertyTypes&&a.cacheProperties();return a._linePropertyTypes};a.getForWords=function(){void 0===a._wordPropertyTypes&&a.cacheProperties();return a._wordPropertyTypes};a.getForChars=function(){void 0===a._charPropertyTypes&&a.cacheProperties();return a._charPropertyTypes};a._propertyTypes=void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;
return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),t="";if(e instanceof Array){var p=[];e.forEach(function(a){p.push(a.toString())});t=p.join("<br>")}else t=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),l=!!c.getSetup(a,"stackedWords"),u=!!c.getSetup(a,"stackedChars"),w=d.TextPropertyTypes.get(),m=d.TextPropertyTypes.getForLines(),k=d.TextPropertyTypes.getForWords(),
n=d.TextPropertyTypes.getForChars(),z=f.Serialization.PropertyListReader.read(b.story,a.init,w,"text"),q=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,m),x=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,k),r=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,n),w=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],w),m=f.Serialization.ScriptSetReader.readJson(b,"Lines",a,["line","lines"],m),k=f.Serialization.ScriptSetReader.readJson(b,
"Words",a,["word","words"],k),n=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],n);return new d.TextItemModel(b,t,e,l,u,z,w,q,m,x,k,r,n)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&(b.setup.stackedChars=!0);b.init=f.Serialization.PropertyListWriter.write(c.init);
b.scripts=f.Serialization.ScriptSetWriter.write(c.scriptSet);b.lineInit=f.Serialization.PropertyListWriter.write(c.linesInit);b.lineScripts=f.Serialization.ScriptSetWriter.write(c.linesScriptSet);b.wordInit=f.Serialization.PropertyListWriter.write(c.wordsInit);b.wordScripts=f.Serialization.ScriptSetWriter.write(c.wordsScriptSet);b.charInit=f.Serialization.PropertyListWriter.write(c.charsInit);b.charScripts=f.Serialization.ScriptSetWriter.write(c.charsScriptSet);return b}})(d.Text||(d.Text={}))})(e.Items||
(e.Items={}));(function(d){(function(d){var c=function(b){function a(a,c){b.call(this,a,c);this.model=a;this.divs=[];this.div.innerText=a.unknownType+"?";this.div.classList.add("unknown")}__extends(a,b);return a}(f.Views.Items.ItemView);d.UnknownItemView=c})(d.Unknown||(d.Unknown={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){return{}}})(d.Unknown||(d.Unknown={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){(function(d){var c=function(b){function a(a,
c){b.call(this,a,c);this.actions=[]}__extends(a,b);a.prototype.removeAction=function(a){a=this.actions.indexOf(a);this.actions.splice(a,1)};return a}(d.Script);d.ActionsScript=c})(e.Scripts||(e.Scripts={}));(function(d){(function(b){b[b.SetProperties=0]="SetProperties"})(d.ActionType||(d.ActionType={}));(function(b){b.fromString=function(a){a=(a||"properties").toString().trim();if("properties"===a)return b.SetProperties;f.Util.logError("ActionType.fromString()","Unknown action type: "+a);return b.SetProperties};
b.toString=function(a){return"properties"}})(d.ActionType||(d.ActionType={}));var c=function(){function b(a,b,c){this.script=a;this.actionType=b;this.delay=c;Math.max(0,c)}b.prototype.saveJson=function(){f.Util.logWarning("Action.saveJson()","Abstract method called");return{}};return b}();d.Action=c;c=function(b){function a(a,c,e){b.call(this,a,d.ActionType.SetProperties,c);this.properties=e}__extends(a,b);return a}(d.Action);d.SetPropertiesAction=c})(e.Actions||(e.Actions={}));var d=function(){function d(){}
d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(e.Properties.Cache.ANIMATION);c.push(e.Properties.Cache.BACKGROUND);c.push(e.Properties.Cache.BORDER);c.push(e.Properties.Cache.CORNERS);c.push(e.Properties.Cache.CROP);c.push(e.Properties.Cache.FONT);c.push(e.Properties.Cache.OPACITY);c.push(e.Properties.Cache.SHADOW);c.push(e.Properties.Cache.TEXT_COLOR);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();e.CanvasPropertyTypes=d;(function(d){var c=function(b){function a(a,
...
c.push(e.Properties.Cache.BACKGROUND);c.push(e.Properties.Cache.BORDER);c.push(e.Properties.Cache.CORNERS);c.push(e.Properties.Cache.CROP);c.push(e.Properties.Cache.OPACITY);c.push(e.Properties.Cache.SCALE);c.push(e.Properties.Cache.SHADOW);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();e.FramePropertyTypes=d})(f.Models||(f.Models={}));(function(e){var d=function(){function d(c,b,a,e,f){this.current=c;this.future=b;this.futureOffset=a;this.past=e;this.pastOffset=f}
...
{}));var d=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(e.Properties.Cache.ANIMATION);c.push(e.Properties.Cache.BACKGROUND);c.push(e.Properties.Cache.BORDER);c.push(e.Properties.Cache.CORNERS);c.push(e.Properties.Cache.CROP);c.push(e.Properties.Cache.FONT);c.push(e.Properties.Cache.OPACITY);c.push(new e.Properties.FontPropertyType(!0));c.push(e.Properties.Cache.SHADOW);c.push(e.Properties.Cache.TEXT_COLOR);c.push(e.Properties.Cache.TEXT_SHADOW);d._propertyTypes=
c}return d._propertyTypes};d._propertyTypes=void 0;return d}();e.PagePropertyTypes=d;(function(d){(function(c){var b=function(){function a(a){this.type=a}a.prototype.getValue=function(a){void 0===a&&(a=!1);if(void 0!==this._value)return this._value;if(void 0!==this.defaultValueOverride)return this.defaultValueOverride;if(a)return this.type.defaultValue};a.prototype.setValue=function(a){this._value=void 0===a?void 0:this.type.scrubValue(a)};a.prototype.render=function(a,b){var c=this.getValue();if(void 0!==
c){var d=[];a&&(d.push(this.type.label),d.push(": "));d.push(c.toString());b&&d.push(this.type.text);return d.join("")}};return a}();c.Variable=b})(d.Variables||(d.Variables={}))})(e.Properties||(e.Properties={}));(function(d){var c=function(b){function a(a){b.call(this,a,d.ScriptType.ActionsOrphan);this.scriptSet=a;this.actions=[]}__extends(a,b);return a}(d.ActionsScript);d.ActionsOrphan=c;c=function(b){function a(a,c){b.call(this,a,c);this.properties=[]}__extends(a,b);return a}(d.Script);d.PropertiesScript=
c;c=function(b){function a(a){b.call(this,a,d.ScriptType.InitEvent);this.scriptSet=a}__extends(a,b);return a}(d.PropertiesScript);d.InitEvent=c;c=function(b){function a(a){b.call(this,a,d.ScriptType.PropertyOrphan);this.scriptSet=a}__extends(a,b);return a}(d.PropertiesScript);d.PropertyOrphan=c;c=function(b){function a(a,c){b.call(this,a,d.ScriptType.StepEvent);this.stepIndex=c}__extends(a,b);return a}(d.ActionsScript);d.StepEvent=c;c=function(b){function a(a,c){b.call(this,a,d.ScriptType.SwitchEvent);
this.switchName=c}__extends(a,b);return a}(d.ActionsScript);d.SwitchEvent=c})(e.Scripts||(e.Scripts={}));d=function(){return function(d){void 0===d&&(d=void 0);this.autoAdvanceDelay=d;this.stopLabel=this.startLabel="";this.time=0}}();e.Step=d})(f.Models||(f.Models={}));(function(e){var d=f.Models.Actions,h=f.Util,c=function(){function a(){}a.readArray=function(b,c){var d=[];c instanceof Array&&c.forEach(function(c){d.push(a.read(b,c))});return d};a.read=function(b,c){c=c||{};d.ActionType.fromString(c.actionType);
...
f.Models,c=function(){function a(){}a.read=function(a,b){return new g.Step(b.autoAdvanceDelay)};return a}();e.StepReader=c;c=function(){function a(){}a.write=function(a){var b={};void 0!==a.autoAdvanceDelay&&(b.autoAdvanceDelay=a.autoAdvanceDelay);return b};return a}();e.StepWriter=c;g=f.Models;c=function(){function a(){}a.read=function(b){b=b||{};var c=e.CanvasReader.read(b.canvas||{}),d=e.FrameReader.read(b.frame||{}),h=[],m=[],k=new g.Story(c,d,h,f.Util.lowercaseProperties(b.classes),m,!1);b.flows instanceof
Array?b.flows.forEach(function(a){h.push(e.FlowReader.read(k,a))}):void 0!==b.flow?h.push(e.FlowReader.read(k,b.flow)):b.pages instanceof Array?h.push(e.FlowReader.read(k,{pages:b.pages})):void 0!==b.page?h.push(e.FlowReader.read(k,{pages:[b.page]})):b.items instanceof Array?h.push(e.FlowReader.read(k,{pages:[{items:b.items}]})):void 0!==b.item&&h.push(e.FlowReader.read(k,{pages:[{items:[b.item]}]}));0===h.length&&h.push(e.FlowReader.read(k,{}));b.controllers instanceof Array?b.controllers.forEach(function(a){m.push(e.ControllerReader.read(a))}):
void 0!==b.controller?m.push(e.ControllerReader.read(b.controller)):f.defaultControllers instanceof Array&&(k.usingDefaultControllers=!0,f.defaultControllers.forEach(function(a){m.push(e.ControllerReader.read(a))}));a.checkPL(k);return k};a.checkPL=function(a){var b=f.pl||0;if(!(2>b)){var c=f.hn;0===c.indexOf("www.")&&(c=c.substring(4));c="This story uses ProStyle Plus premium extensions. Please purchase a license at https://prostyle.io/plus/ for the "+c+" domain.";3===b&&console.log("Attempting to use ProStyle Plus license for "+
...
function(){var b=e.querySelector("meta[name='viewport']")||document.createElement("meta");b.content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no";b.parentNode!==document.head&&(b.name="viewport",document.head.appendChild(b))};e.contentLoaded=function(b,a){var c=!1,d=!0,e=b.document,f=e.documentElement,h=e.addEventListener,w=h?"addEventListener":"attachEvent",m=h?"removeEventListener":"detachEvent",k=h?"":"on",n=function(d){if("readystatechange"!=d.type||"complete"==e.readyState)("load"==
d.type?b:e)[m](k+d.type,n,!1),!c&&(c=!0)&&a.call(b,d.type||d)},q=function(){try{f.doScroll("left")}catch(a){setTimeout(q,50);return}n("poll")};if("complete"==e.readyState)a.call(b,"lazy");else{if(!h&&f.doScroll){try{d=!b.frameElement}catch(r){}d&&q()}e[w](k+"DOMContentLoaded",n,!1);e[w](k+"readystatechange",n,!1);b[w](k+"load",n,!1)}};e.createChildImageElement=function(b,a,c,d,e){void 0===d&&(d=void 0);void 0===e&&(e=void 0);var f=document.createElement("img");f.setAttribute("class",a);f.setAttribute("src",
...
c=document.documentElement,d=b.left+(window.pageXOffset||c.scrollLeft||a.scrollLeft)-(c.clientLeft||a.clientLeft||0);return{top:Math.round(b.top+(window.pageYOffset||c.scrollTop||a.scrollTop)-(c.clientTop||a.clientTop||0)),left:Math.round(d)}}})(f.Util||(f.Util={}));(function(e){(function(c){var b=f.Util,a=f.Models.Properties,d=function(){function c(){}c.generateTimeline=function(b,d,f,g,h,k,n){void 0===n&&(n=void 0);var q=c.getMoveTo(g.properties,b.items),r=[];for(b=0;b<f.length;b++)r.push({force3D:!0,
...
"none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,q=b.size,r=b.camera,m=r.size,k={fontFamily:"arial"};e.fullScreen||(k.height=f.height);e.initializeProperties(d,[e.div],m,this.timeline,d.canvas.init,!1,k);k={width:q.width,height:q.height};b.initializeProperties(d,[b.div],m,this.timeline,d.frame.init,!1,k);r.flows.forEach(function(a){var e=
m.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var n=void 0;r.flows.forEach(function(a){n=a.generateStepsActions(c.timeline,n)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.reload=B;f.bootstrap=r;r()})(ProStyle||(ProStyle={}));
