...
b.prototype.playCurrentStepDelayed=function(a){var g=this;clearTimeout(this.timeout);this.timeout=setTimeout(function(){g.playCurrentStep()},a)};b.prototype.playNextStep=function(a){void 0===a&&(a=!1);if(this.isAtStepStart())this.moveTo(this.currentStep.startTime,!1,!0);else{var g=!this.isLastStep()||this.isAtStoryEnd();this.moveTo(this.currentStep.stopTime,a,g)}};b.prototype.playNextStepDelayed=function(a){var g=this;clearTimeout(this.timeout);this.timeout=setTimeout(function(){g.playNextStep()},
a)};b.prototype.backStep=function(a){void 0===a&&(a=!1);this.isAtStepEnd()&&1<this.currentSubStep?this.playSubStep(this.currentSubStep-1):this.isFirstStep()&&(0<this.currentSubStep||this.timeline.time()>this.currentStep.startTime)?this.animating||(this.moveTo(this.currentStep.startTime,!0,!1),this.playSubStep(0)):this.isAtStoryStart()?this.animating||(this.currentStep=this.steps[this.steps.length-1],this.timeline.pause(this.currentStep.stopTime),this.alignSequencedItemsToStep(this.currentStep,!1,
...
TweenMax.set(this.playDiv,{left:a-d-e-2*c,top:0,height:b,width:e});TweenMax.set(this.backDiv,{left:h,top:0,height:b,width:f});this.scrubberSize={left:g+c,width:h-g-2*c,height:b,barHeight:b/3};this.resizeScrubber();this.updateScrubberProgress()};a.prototype.resizeScrubber=function(){var a=this,g=this.scrubberSize,b=this.canvas.player,c=b.steps.length-1,d=b.getDuration(),e=g.barHeight/2,f=g.width-g.barHeight;this.divScrubber.style.left=g.left+"px";this.divScrubber.style.width=g.width+"px";this.divScrubber.style.height=
g.height+"px";this.divScrubberBar.style.width=g.width+"px";this.divScrubberBar.style.top=(g.height-g.barHeight)/2+"px";this.divScrubberBar.style.height=g.barHeight+"px";this.divScrubberBar.style.borderRadius=e+"px";b.steps.forEach(function(b,l){var h=a.divScrubberStep[c-l];h.style.left=(f*b.startTime/d).toString()+"px";h.style.width=(f*b.time/d+g.barHeight).toString()+"px";h.style.height=g.barHeight+"px";h.style.borderRadius=e+"px"});this.divScrubberHoverPoint.style.height=e+"px";this.divScrubberHoverPoint.style.width=
