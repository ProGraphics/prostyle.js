...
function(h,b,p,k,d,e,f,g){void 0===f&&(f=void 0);void 0===g&&(g=void 0);TweenMax.set(b,{clearProps:"all"});void 0!==f&&TweenMax.set(b,f);var m=[];for(f=0;f<b.length;f++){var r={force3D:!0,element:b[f],elementIndex:f};e&&(r.xPercent=-50,r.yPercent=-50);m.push(r)}var B=[];d.properties.forEach(function(a){B["prostyle_"+a.type.jsonNames[0]]=a});var t=this.bgCache;t.sizeH=100;t.sizeW=100;t.borderSize=0;var O=!1,A=void 0;d.propertyTypes.forEach(function(a){var b=B["prostyle_"+a.jsonNames[0]];void 0===b&&
...
return d}();f.Stagger=e})(g.Types||(g.Types={}));(function(f){(function(e){(function(c){var b=function(a){function b(){a.call(this,"stagger",["stagger"],void 0,"",g.Types.Stagger.DEFAULT,!1)}__extends(b,a);b.prototype.scrubValue=function(a){return g.Types.Stagger.fromJson(a)};return b}(c.VariableType);c.StaggerVariableType=b;b=function(a){function b(h,c,d,e,f,g,l,m,r){void 0===f&&(f=!0);void 0===g&&(g=void 0);void 0===l&&(l=!1);void 0===m&&(m=void 0);void 0===r&&(r=void 0);a.call(this,h,c,d,"",e,
l);this.forceLowerCase=f;this.enumValues=g;this.trueValue=m;this.falseValue=r}__extends(b,a);b.prototype.scrubValue=function(a){var b;if("boolean"===typeof a)return a?this.trueValue:this.falseValue;if("number"===typeof a)return this.defaultValue;if("string"===typeof a)b=g.Util.splitNoParens(a);else if(a instanceof Array)b=a;else return this.defaultValue;for(var h=0;h<b.length;h++)if(b[h]=(b[h]||"").toString().trim(),this.forceLowerCase&&(b[h]=b[h].toLowerCase()),this.enumValues&&0<this.enumValues.length){a=
...
r=c.sizeH/100*d.height;"border-box"===b.getVal(l,c.clip)?(m+=c.borderSize/100*2*d.height,r+=c.borderSize/100*2*d.height,v.push("border-box"),q.push("border-box")):(v.push("padding-box"),q.push("padding-box"));var B=this.getVal(l,c.layout),t=this.getVal(l,c.ar),O=this.getVal(l,c.x),A=this.getVal(l,c.y),L=this.getVal(l,c.w),n=this.getVal(l,c.h),G="cover"===B,z="contain"===B,E=m/r;G||z?G&&E<=t||z&&E>t?(n=r,L=r*t):(L=m,n=m/t):(L=L/100*m,n=n/100*r,"stretch-w"===B?n=L/t:"stretch-h"===B&&(L=n*t));g.push(L.toFixed(1)+
...
b=function(){function a(){}a.cacheProperties=function(){a._propertyTypes=[];a._linePropertyTypes=[];a._wordPropertyTypes=[];a._charPropertyTypes=[];var b=[a._propertyTypes],d=[a._linePropertyTypes],e=[a._propertyTypes,a._linePropertyTypes,a._wordPropertyTypes,a._charPropertyTypes];a.addPropertyType(b,c.Cache.ANCHOR);a.addPropertyType(e,c.Cache.ANIMATION);a.addPropertyType(e,c.Cache.BORDER);a.addPropertyType(d,c.Cache.BULLET);a.addPropertyType(e,c.Cache.CLASS);a.addPropertyType(e,c.Cache.CORNERS);
a.addPropertyType(b,c.Cache.CROP);a.addPropertyType(b,c.Cache.FONT);a.addPropertyType(e,c.Cache.OPACITY);a.addPropertyType(e,c.Cache.PADDING);a.addPropertyType(e,c.Cache.POSITION);a.addPropertyType(e,c.Cache.ROTATION);a.addPropertyType(e,c.Cache.SCALE);a.addPropertyType(e,c.Cache.SHADOW);a.addPropertyType(e,c.Cache.SKEW);a.addPropertyType(b,c.Cache.TEXT_ALIGN);a.addPropertyType(e,c.Cache.TEXT_COLOR);a.addPropertyType(e,c.Cache.TEXT_SHADOW);a.addPropertyType(e,c.Cache.TEXT_STYLE);a.addPropertyType(b,
c.Cache.TEXT_WIDTH);a.addPropertyType(e,c.Cache.TRANSFORM_ORIGIN)};a.addPropertyType=function(a,b){a.forEach(function(a){a.push(b)})};a.get=function(){void 0===a._propertyTypes&&a.cacheProperties();return a._propertyTypes};a.getForLines=function(){void 0===a._linePropertyTypes&&a.cacheProperties();return a._linePropertyTypes};a.getForWords=function(){void 0===a._wordPropertyTypes&&a.cacheProperties();return a._wordPropertyTypes};a.getForChars=function(){void 0===a._charPropertyTypes&&a.cacheProperties();
return a._charPropertyTypes};a._propertyTypes=void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(e.Text||(e.Text={}))})(f.Items||(f.Items={}));(function(e){(function(d){var c=g.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),f="";if(e instanceof Array){var p=[];e.forEach(function(a){p.push(a.toString())});f=p.join("<br>")}else f=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),k=!!c.getSetup(a,"stackedWords"),
x=!!c.getSetup(a,"stackedChars"),v=d.TextPropertyTypes.get(),q=d.TextPropertyTypes.getForLines(),l=d.TextPropertyTypes.getForWords(),m=d.TextPropertyTypes.getForChars(),r=g.Serialization.PropertyListReader.read(b.story,a.init,v,"text"),B=g.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,q),t=g.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,l),n=g.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,m),v=g.Serialization.ScriptSetReader.readJson(b,
"Text",a,[""],v),q=g.Serialization.ScriptSetReader.readJson(b,"Lines",a,["line","lines"],q),l=g.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],l),m=g.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],m);return new d.TextItemModel(b,f,e,k,x,r,v,B,q,t,l,n,m)}})(e.Text||(e.Text={}))})(f.Items||(f.Items={}));(function(e){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=
!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&(b.setup.stackedChars=!0);b.init=g.Serialization.PropertyListWriter.write(c.init);b.scripts=g.Serialization.ScriptSetWriter.write(c.scriptSet);b.lineInit=g.Serialization.PropertyListWriter.write(c.linesInit);b.lineScripts=g.Serialization.ScriptSetWriter.write(c.linesScriptSet);b.wordInit=g.Serialization.PropertyListWriter.write(c.wordsInit);b.wordScripts=g.Serialization.ScriptSetWriter.write(c.wordsScriptSet);b.charInit=g.Serialization.PropertyListWriter.write(c.charsInit);
b.charScripts=g.Serialization.ScriptSetWriter.write(c.charsScriptSet);return b}})(e.Text||(e.Text={}))})(f.Items||(f.Items={}));(function(e){(function(d){var c=function(b){function a(a,c){b.call(this,a,c);this.model=a;this.divs=[];this.div.innerText=a.unknownType+"?";this.div.classList.add("unknown")}__extends(a,b);return a}(g.Views.Items.ItemView);d.UnknownItemView=c})(e.Unknown||(e.Unknown={}))})(f.Items||(f.Items={}));(function(e){(function(d){d.serialize=function(c){return{}}})(e.Unknown||(e.Unknown=
{}))})(f.Items||(f.Items={}))})(g.Extensions||(g.Extensions={}));(function(f){(function(d){var c=function(b){function a(a,c){b.call(this,a,c);this.actions=[]}__extends(a,b);a.prototype.removeAction=function(a){a=this.actions.indexOf(a);this.actions.splice(a,1)};return a}(d.Script);d.ActionsScript=c})(f.Scripts||(f.Scripts={}));(function(d){(function(b){b[b.SetProperties=0]="SetProperties"})(d.ActionType||(d.ActionType={}));(function(b){b.fromString=function(a){a=(a||"properties").toString().trim();
if("properties"===a)return b.SetProperties;g.Util.logError("ActionType.fromString()","Unknown action type: "+a);return b.SetProperties};b.toString=function(a){return"properties"}})(d.ActionType||(d.ActionType={}));var c=function(){function b(a,b,c){this.script=a;this.actionType=b;this.delay=c;Math.max(0,c)}b.prototype.saveJson=function(){g.Util.logWarning("Action.saveJson()","Abstract method called");return{}};return b}();d.Action=c;c=function(b){function a(a,c,e){b.call(this,a,d.ActionType.SetProperties,
c);this.properties=e}__extends(a,b);return a}(d.Action);d.SetPropertiesAction=c})(f.Actions||(f.Actions={}));var e=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(f.Properties.Cache.ANIMATION);c.push(f.Properties.Cache.BACKGROUND);c.push(f.Properties.Cache.BORDER);c.push(f.Properties.Cache.CORNERS);c.push(f.Properties.Cache.CROP);c.push(f.Properties.Cache.FONT);c.push(f.Properties.Cache.OPACITY);c.push(f.Properties.Cache.SHADOW);c.push(f.Properties.Cache.TEXT_COLOR);
d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();f.CanvasPropertyTypes=e;(function(d){var c=function(b){function a(a,c,d,e,f,g){b.call(this,a,c,d,f,e);this.pageClassIfNotGiven=g}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.pageClass||this.pageClassIfNotGiven};a.prototype.getDefaultPageClassValue=function(){return{background:"#FFF",corners:{topLeft:2,bottomRight:2,bottomLeft:2,topRight:2},shadow:[0,0,1.5,"rgba(0,0,0,0.5)",.1]}};return a}(d.FlowModel);
d.PlacementFlowModel=c})(f.Flows||(f.Flows={}));e=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(f.Properties.Cache.ANIMATION);c.push(f.Properties.Cache.BACKGROUND);c.push(f.Properties.Cache.BORDER);c.push(f.Properties.Cache.CORNERS);c.push(f.Properties.Cache.CROP);c.push(f.Properties.Cache.OPACITY);c.push(f.Properties.Cache.SCALE);c.push(f.Properties.Cache.SHADOW);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();f.FramePropertyTypes=
e})(g.Models||(g.Models={}));(function(f){var e=function(){function d(c,b,a,d,e){this.current=c;this.future=b;this.futureOffset=a;this.past=d;this.pastOffset=e}d.fromJson=function(c){c=c||{};c.future=c.future||{};c.past=c.past||{};return new d(f.Placement.fromJson(c.current),f.Placement.fromJson(c.future),f.Placement.fromJson(c.future.offset),f.Placement.fromJson(c.past),f.Placement.fromJson(c.past.offset))};return d}();f.Stacks=e})(g.Types||(g.Types={}));(function(f){(function(d){var c=function(b){function a(a,
c,d,e,f,g){b.call(this,a,c,d,[f],[g]);this.sequenceOnStepIndex=e}__extends(a,b);return a}(d.ItemModel);d.SequencedItemModel=c})(f.Items||(f.Items={}));var e=function(){function d(){}d.get=function(){if(void 0===d._propertyTypes){var c=[];c.push(f.Properties.Cache.ANIMATION);c.push(f.Properties.Cache.BACKGROUND);c.push(f.Properties.Cache.BORDER);c.push(f.Properties.Cache.CORNERS);c.push(f.Properties.Cache.CROP);c.push(f.Properties.Cache.FONT);c.push(f.Properties.Cache.OPACITY);c.push(new f.Properties.FontPropertyType(!0));
c.push(f.Properties.Cache.SHADOW);c.push(f.Properties.Cache.TEXT_COLOR);c.push(f.Properties.Cache.TEXT_SHADOW);d._propertyTypes=c}return d._propertyTypes};d._propertyTypes=void 0;return d}();f.PagePropertyTypes=e;(function(d){var c=function(b){function a(a){b.call(this,a,d.ScriptType.ActionsOrphan);this.scriptSet=a;this.actions=[]}__extends(a,b);return a}(d.ActionsScript);d.ActionsOrphan=c;c=function(b){function a(a,c){b.call(this,a,c);this.properties=[]}__extends(a,b);return a}(d.Script);d.PropertiesScript=
...
a=g.Models.Properties,d=function(){function c(){}c.generateTimeline=function(d,e,h,v,q,l,m){void 0===m&&(m=void 0);var r=c.getMoveTo(v.properties,d.items),B=[];for(d=0;d<h.length;d++)B.push({force3D:!0,immediateRender:!1,delay:v.delay,element:h[d],elementIndex:d});var t=void 0,n=0,A=v.script.scriptSet.itemModelSet.flow.story;d=e.bgCache;var z=void 0,E=void 0,G=void 0,H=!1,y=void 0;v.properties.forEach(function(b){if(b.type instanceof a.AnimationPropertyType){n=b.duration.getValue()||0;t=b.stagger.getValue();
var c=b.repeat.getValue();void 0!==c&&(H=c.isNoop());0<n&&b.writeCssBuckets(A,e.model,l,B,!1)}b.type instanceof a.BackgroundPropertyType?y=b:void 0!==r&&(b.type instanceof a.MoveToPropertyType||b.type instanceof a.PositionPropertyType||b.type instanceof a.RotationPropertyType||b.type instanceof a.ScalePropertyType||b.type instanceof a.SkewPropertyType)||(b.writeCssBuckets(A,e.model,l,B,!1),b.type instanceof a.SizePropertyType?(z=b.getVariable("width").getValue(!1),E=b.getVariable("height").getValue(!1)):
b.type instanceof a.BorderPropertyType&&(G=b.getVariable("size").getValue(!1)))});f.View.postProcessCssBuckets(B,m,v.properties,l);v=q.totalDuration();var P=void 0!==z||void 0!==E||void 0!==G;if(P){var J={};a.BackgroundPropertyType.writeBackgroundBuckets(A,d,l,[J]);for(m=0;m<h.length;m++)console.log("SET-"+v,J),q.set(h[m],J,v);H||(d.sizeW=z||d.sizeW,d.sizeH=E||d.sizeH,d.borderSize=G||d.borderSize)}y&&(y.cache=d,y.sizeChanged=P,y.writeCssBuckets(A,void 0,l,B,!1));P=0;d=[];J=[d];for(m=0;m<h.length;m++)d.push(m);
if(t)if(P=t.delay,t.order===g.Types.StaggerOrder.Backward)d.reverse();else if(t.order===g.Types.StaggerOrder.Random)b.arrayShuffle(d);else if(t.order===g.Types.StaggerOrder.CenterOut||t.order===g.Types.StaggerOrder.OutCenter)J=b.arraySplit(d,2),t.order===g.Types.StaggerOrder.OutCenter?J[1].reverse():(J[0].reverse(),J[1].length<J[0].length&&J[1].unshift(J[0][0]));for(var T=0;T<J.length;T++){var N=v,Q=J[T];for(m=0;m<Q.length;m++)d=Q[m],0<n?(console.log("to-"+v,B[d]),q.to(h[d],n,B[d],N)):(console.log("set-"+
v,B[d]),q.set(h[d],B[d],N)),N+=P}return r};c.getMoveTo=function(b,c){var d=void 0;b.forEach(function(b){b.type instanceof a.MoveToPropertyType&&(d=b.getVariable("item").getValue(),void 0!==d&&(0>d||d>c.length)&&(d=void 0))});return d};c.generateMoveTo=function(a,c,d){if(c){var e=b.getGSTransform(c),f=[];(e.x||e.y||e.z)&&f.push("translate3d("+-e.x+"px,"+-e.y+"px,"+-e.z+"px)");e.rotationX&&f.push("rotateX("+-e.rotationX+"deg)");e.rotationY&&f.push("rotateY("+-e.rotationY+"deg)");e.rotation&&f.push("rotate("+
-e.rotation+"deg)");var g=Math.max(0,Math.min(0===e.scaleX?1:1/e.scaleX,10)),h=Math.max(0,Math.min(0===e.scaleY?1:1/e.scaleY,10));1!==e.scaleX&&f.push("scaleX("+g+")");1!==e.scaleY&&f.push("scaleY("+h+")");e.skewX&&f.push("skewX("+-e.skewX+"deg)");console.log(f.join(" "));console.log(c._gsTransform);c={transform:f.join(" "),xPercent:-50,yPercent:-50};d.to(a,1.2,c)}};return c}();c.SetPropertiesAction=d})(f.Actions||(f.Actions={}));(function(c){var b=function(a){function b(c,d,e){a.call(this,c,d,e);
this.model=c}__extends(b,a);return b}(c.FlowView);c.PlacementFlowView=b})(f.Flows||(f.Flows={}));var e=function(){function c(b,a,c,d,e){this.step=b;this.flowIndex=a;this.pageIndex=c;this.stepIndex=d;this.sequencedItems=e;this.playerStepIndex=this.time=0;this.label=a.toString()+"-"+c.toString()+"-"+d.toString()+"-";this.startLabel=this.label+"start";this.stopLabel=this.label+"stop";b.startLabel=this.startLabel;b.stopLabel=this.stopLabel}c.prototype.isAtStart=function(b){return.02>Math.abs(b-this.startTime)};
c.prototype.isAtEnd=function(b){return.02>Math.abs(b-this.stopTime)};c.prototype.getSubStepCount=function(){var b=0;this.sequencedItems.forEach(function(a){b=Math.max(b,a.getCountOfSubSteps())});return b};return c}();f.Step=e;var d=g.Types,e=function(){function c(b,a){this.generateTimeline(b,a)}c.prototype.generateTimeline=function(b,a){var c=this;TweenMax.defaultOverwrite="none";TweenMax.defaultEase=d.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,
onUpdate:a});this.timeline.addLabel("initialize",0);var e=b.story,f=b.canvas,g=f.size,x=b.size,v=b.camera,q=v.size,l={fontFamily:"arial"};f.fullScreen||(l.height=g.height);f.initializeProperties(e,[f.div],g,this.timeline,e.canvas.init,!1,l);l={width:x.width,height:x.height};b.initializeProperties(e,[b.div],x,this.timeline,e.frame.init,!1,l);v.flows.forEach(function(a){var d=q.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(e,[a.div],d,c.timeline,a.model.init,
!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var m=void 0;v.flows.forEach(function(a){m=a.generateStepsActions(c.timeline,m)});return this.timeline};return c}();f.Timeline=e})(g.Views||(g.Views={}));g.reload=H;g.bootstrap=z;z()})(ProStyle||(ProStyle={}));var _gsScope="undefined"!==typeof module&&module.exports&&"undefined"!==typeof global?global:this||window;
...
U=a(f.wordsClass),fa=a(f.charsClass),Y=-1!==(f.linesClass||"").indexOf("++"),f=f.linesClass,Z=-1!==r.indexOf("<"),R=!0,V=[],aa=[],ba=[],K=void 0,S=void 0,D=void 0,F=void 0,w=void 0,C=D=D=void 0,u=void 0,M=void 0,ca=F=C=void 0,da=void 0;Y&&(f=f.split("++").join(""));Z&&(r=r.split("<").join("{{LT}}"));K=r.length;F=U();for(w=0;w<K;w++)if(D=r.charAt(w),")"===D&&")eefec303079ad17405c"===r.substr(w,20))F+=(R?"</div>":"")+"<BR/>",R=!1,w!==K-20&&")eefec303079ad17405c"!==r.substr(w+20,20)&&(F+=" "+U(),R=!0),
w+=19;else if(" "===D&&" "!==r.charAt(w-1)&&w!==K-1&&")eefec303079ad17405c"!==r.substr(w-20,20)){F+=R?"</div>":"";for(R=!1;" "===r.charAt(w+1);)F+=L,w++;if(")"!==r.charAt(w+1)||")eefec303079ad17405c"!==r.substr(w+1,20))F+=L+U(),R=!0}else F+=n&&" "!==D?fa()+D+"</div>":D;d.innerHTML=F+(R?"</div>":"");Z&&I(d,"{{LT}}","<");D=d.getElementsByTagName("*");K=D.length;C=[];for(w=0;w<K;w++)C[w]=D[w];if(t||A)for(w=0;w<K;w++)if(u=C[w],(D=u.parentNode===d)||A||n&&!y)M=u.offsetTop,t&&D&&M!==W&&"BR"!==u.nodeName&&
(S=[],t.push(S),W=M),A&&(u._x=u.offsetLeft,u._y=M,u._w=u.offsetWidth,u._h=u.offsetHeight),t&&(y!==D&&n||(S.push(u),u._x-=X),D&&w&&(C[w-1]._wordEnd=!0),"BR"===u.nodeName&&u.nextSibling&&"BR"===u.nextSibling.nodeName&&t.push([]));for(w=0;w<K;w++)u=C[w],D=u.parentNode===d,"BR"===u.nodeName?t||A?(d.removeChild(u),C.splice(w--,1),K--):y||d.appendChild(u):(A&&(F=u.style,y||D||(u._x+=u.parentNode._x,u._y+=u.parentNode._y),F.left=u._x+"px",F.top=u._y+"px",F.position="absolute",F.display="block",F.width=u._w+
1+"px",F.height=u._h+"px"),y?D&&""!==u.innerHTML?aa.push(u):n&&V.push(u):D?(d.removeChild(u),C.splice(w--,1),K--):!D&&n&&(M=!t&&!A&&u.nextSibling,d.appendChild(u),M||d.appendChild(H.createTextNode(" ")),V.push(u)));if(t){A&&(C=H.createElement("div"),d.appendChild(C),ca=C.offsetWidth+"px",M=C.offsetParent===d?0:d.offsetLeft,d.removeChild(C));F=d.style.cssText;for(d.style.cssText="display:none;";d.firstChild;)d.removeChild(d.firstChild);da=!A||!y&&!n;for(w=0;w<t.length;w++){S=t[w];C=H.createElement("div");
C.style.cssText="display:block;text-align:"+G+";position:"+(A?"absolute;":"relative;");f&&(C.className=f+(Y?w+1:""));ba.push(C);K=S.length;for(D=0;D<K;D++)"BR"!==S[D].nodeName&&(u=S[D],C.appendChild(u),da&&(u._wordEnd||y)&&C.appendChild(H.createTextNode(" ")),A&&(0===D&&(C.style.top=u._y+"px",C.style.left=X+M+"px"),u.style.top="0px",M&&(u.style.left=u._x-M+"px")));0===K&&(C.innerHTML="&nbsp;");y||n||(C.innerHTML=E(C).split(String.fromCharCode(160)).join(" "));A&&(C.style.width=ca,C.style.height=u._h+
"px");d.appendChild(C)}d.style.cssText=F}A&&(N>d.clientHeight&&(d.style.height=N-J+"px",d.clientHeight<N&&(d.style.height=N+ea+"px")),Q>d.clientWidth&&(d.style.width=Q-T+"px",d.clientWidth<Q&&(d.style.width=Q+P+"px")));p(g,V);p(h,aa);p(m,ba)}this.chars.reverse();this.words.reverse();this.lines.reverse();this.isSplit=!0;return this};n.revert=function(){if(!this._originals)throw"revert() call wasn't scoped properly.";for(var a=this._originals.length;-1<--a;)this.elements[a].innerHTML=this._originals[a];
